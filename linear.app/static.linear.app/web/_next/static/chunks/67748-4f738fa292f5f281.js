! function() {
    try {
        var e = "u" > typeof window ? window : "u" > typeof global ? global : "u" > typeof globalThis ? globalThis : "u" > typeof self ? self : {},
            t = (new e.Error).stack;
        t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "00da40a6-2433-4464-9a52-05a1ecb5b4ee", e._sentryDebugIdIdentifier = "sentry-dbid-00da40a6-2433-4464-9a52-05a1ecb5b4ee")
    } catch (e) {}
                ...
                return p = function(t) {
                    ...
                    for (var r, n = {}, i = e(t).split("\n"), s = 0; s < i.length; s++) {
                        var o = i[s],
                            ...
                            c = e(o.slice(a + 1));
                        typeof n[u] > "u" ? n[u] = c : (r = n[u], "[object Array]" === Object.prototype.toString.call(r) ? n[u].push(c) : n[u] = [n[u], c])
                    }
                    return n
                }
            }()) && f.__esModule && Object.prototype.hasOwnProperty.call(f, "default") ? f.default : f;
            class v {
                onabort;
                onerror;
                onreadystatechange;
...
`
            ...
            let g = "function" == typeof XMLHttpRequest ? "xhr" : "fetch",
                ...
                b = (e, t) => {
                    ...
                    let o = new m;
                    o instanceof v && "object" == typeof n.fetch && o.setInit(n.fetch, n.useAbortSignal ? ? !0);
                    let a = n.headers,
                        u = n.timeout,
                        c = !1,
                        l = !1,
                        f = !1;
                    if (o.onerror = e => {
                            d(o instanceof v ? e instanceof Error ? e : Error(`Request error while attempting to reach is ${n.url}`, {
                                cause: e
                            }) : Error(`Request error while attempting to reach is ${n.url}${e.lengthComputable?`(${e.loaded} of ${e.total} bytes transferred)`:""}`))
                        }, o.ontimeout = e => {
                            d(Error(`Request timeout while attempting to reach ${n.url}${e.lengthComputable?`(${e.loaded} of ${e.total} bytes transferred)`:""}`))
                        }, o.onabort = () => {
                            p(!0), c = !0
                        }, o.onreadystatechange = () => {
                            u && (p(), i.socket = setTimeout(() => h("ESOCKETTIMEDOUT"), u.socket)), c || 4 !== o.readyState || 0 === o.status || function() {
                                if (!(c || l || f)) {
                                    if (0 === o.status) return d(Error("Unknown XHR error"));
                                    p(), l = !0, t(null, {
                    ...
                    return n.rawBody && (o.responseType = "arraybuffer"), e.applyMiddleware("onRequest", {
                        ...
                        request: o,
                        context: e
                    }), o.send(n.body || null), u && (i.connect = setTimeout(() => h("ETIMEDOUT"), u.connect)), {
                        abort: function() {
                            c = !0, o && o.abort()
                        }
                    };
                    ...
                    function p(e) {
                        (e || c || o.readyState >= 2 && i.connect) && clearTimeout(i.connect), i.socket && clearTimeout(i.socket)
                    }
            ...
            S || (S = 1, function(e, t) {
                ...
                t.formatArgs = function(t) {
                    ...
                    return !e && "u" > typeof C && "env" in C && (e = C.env.DEBUG), e
                ...
                }, t.colors = ["#0000CC", "#0000FF", "#0033CC", "#0033FF", "#0066CC", "#0066FF", "#0099CC", "#0099FF", "#00CC00", "#00CC33", "#00CC66", "#00CC99", "#00CCCC", "#00CCFF", "#3300CC", "#3300FF", "#3333CC", "#3333FF", "#3366CC", "#3366FF", "#3399CC", "#3399FF", "#33CC00", "#33CC33", "#33CC66", "#33CC99", "#33CCCC", "#33CCFF", "#6600CC", "#6600FF", "#6633CC", "#6633FF", "#66CC00", "#66CC33", "#9900CC", "#9900FF", "#9933CC", "#9933FF", "#99CC00", "#99CC33", "#CC0000", "#CC0033", "#CC0066", "#CC0099", "#CC00CC", "#CC00FF", "#CC3300", "#CC3333", "#CC3366", "#CC3399", "#CC33CC", "#CC33FF", "#CC6600", "#CC6633", "#CC9900", "#CC9933", "#CCCC00", "#CCCC33", "#FF0000", "#FF0033", "#FF0066", "#FF0099", "#FF00CC", "#FF00FF", "#FF3300", "#FF3333", "#FF3366", "#FF3399", "#FF33CC", "#FF33FF", "#FF6600", "#FF6633", "#FF9900", "#FF9933", "#FFCC00", "#FFCC33"], t.log = console.debug || console.log || (() => {}), e.exports = (E ? x : (E = 1, x = function(e) {
                    function t(e) {
                        let n, i, s, o = null;
                    ...
                    return t.debug = t, t.default = t, t.coerce = function(e) {
                        ...
                        for (let r of (t.save(e), t.namespaces = e, t.names = [], t.skips = [], ("string" == typeof e ? e : "").trim().replace(" ", ",").split(",").filter(Boolean))) "-" === r[0] ? t.skips.push(r.slice(1)) : t.names.push(r)
            ...
            let O = typeof T > "u" ? () => !1 : e => T.isBuffer(e);

            function A(e) {
                return "[object Object]" === Object.prototype.toString.call(e)
            }
            let k = ["boolean", "string", "number"],
                R = {};
            ...
            q.Cancel = $, q.CancelToken = P, q.isCancel = e => !(!e || !e ? .__CANCEL__);
            var U = (e, t, r) => ("GET" === r.method || "HEAD" === r.method) && (e.isNetworkError || !1);
            ...
            let N = (e = {}) => {
                ...
                return r = (t = {
                    shouldRetry: U,
                    ...e
                }).maxRetries || 5, n = t.retryDelay || M, i = t.shouldRetry, {
                    onError: (e, t) => {
                        var s;
                        let o = t.options,
                            a = o.maxRetries || r,
                        ...
                        return setTimeout(() => t.channels.request.publish(f), u(l)), null
                    }
                }
            };
            N.shouldRetry = U;
            ...
            function X(e, t) {
                ...
                return new Promise(function(n, i) {
                    ...
                    e.subscribe({
                        ...
                        error: i,
                        complete: function() {
                            o ? n(s) : r ? n(t.defaultValue) : i(new V)
                        }
                    })
                })
            }
            ...
            function K(e) {
                return (0, Q.N)(function(t, r) {
                    var n, i = null,
                        s = !1;
                    i = t.subscribe((0, G._)(r, void 0, void 0, function(o) {
                        n = (0, Y.Tg)(e(o, K(e)(t))), i ? (i.unsubscribe(), i = null, n.subscribe(r)) : s = !0
            ...
            function ee() {
                for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
                return (0, Z.U)(1)((0, z.H)(e, (0, F.lI)(e)))
            }
            var et = r(64668),
                er = new(r(51711)).q(et.R);

            function en(e, t) {
                var r = (0, D.T)(e) ? e : function() {
                        return e
                    },
                    n = function(e) {
                        return e.error(r())
                    };
                return new L.c(t ? function(e) {
            ...
            function ep() {
                for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
                var r = (0, F.ms)(e);
                return r ? (0, eh.F)(ep.apply(void 0, (0, eo.fX)([], (0, eo.zs)(e))), (0, ef.I)(r)) : (0, Q.N)(function(t, r) {
                    var n, i;
                    (n = (0, eo.fX)([t], (0, eo.zs)(1 === e.length && el(e[0]) ? e[0] : e)), void 0 === i && (i = ea.D), function(e) {
                        ec(void 0, function() {
                            for (var t = n.length, r = Array(t), s = t, o = t, a = function(t) {
                                    ec(void 0, function() {
                                        var a = (0, z.H)(n[t], void 0),
                                            u = !1;
                                        a.subscribe((0, G._)(e, function(n) {
            ...
            function em(e) {
                ...
                let s, o = e.body,
                    a = {
                        ...
                        responseBody: (t = o, -1 !== (e.headers["content-type"] || "").toLowerCase().indexOf("application/json") ? JSON.stringify(t, null, 2) : t),
                        message: "",
                        details: void 0
                    };
                if (o.error && o.message) return a.message = `${o.error} - ${o.message}`, a;
                if (eb(r = o) && eb(r.error) && "mutationError" === r.error.type && "string" == typeof r.error.description || eb(n = o) && eb(n.error) && "actionError" === n.error.type && "string" == typeof n.error.description) {
                    let e = o.error.items || [],
...
- `)}` : "";
                    return e.length > 5 && (r += `
...and ${e.length-5} more`), a.message = `${o.error.description}${r}`, a.details = o.error, a
                }
                return o.error && o.error.description ? (a.message = o.error.description, a.details = o.error) : a.message = o.error || o.message || (s = (i = e).statusMessage ? ` ${i.statusMessage}` : "", `${i.method}-request to ${i.url} resulted in HTTP ${i.statusCode}${s}`), a
            }
            ...
            let e_ = {
                onResponse: e => {
                    if (e.statusCode >= 500) throw new eg(e);
                    if (e.statusCode >= 400) throw new ev(e);
                    return e
                }
            };
            ...
            function ex(e) {
                ...
                return ((e = [], t = b) => (function e(t, r) {
                    ...
                    onResponse: e => {
                        ...
                        for (let e of Array.isArray(r) ? r : [r]) !e || t[e] || (t[e] = !0, console.warn(e));
                        return e
                    }
                }), {
                    processOptions: e => {
                        let t = e.body;
                        return !t || "function" == typeof t.pipe || O(t) || -1 === k.indexOf(typeof t) && !Array.isArray(t) && ! function(e) {
                            if (!1 === A(e)) return !1;
                            let t = e.constructor;
                            if (void 0 === t) return !0;
                            let r = t.prototype;
                            return !1 !== A(r) && !1 !== r.hasOwnProperty("isPrototypeOf")
                        }(t) ? e : Object.assign({}, e, {
            ...
            function eE(e, t, r) {
                ...
                return (!!n || !!i) && !!s || N.shouldRetry(e, t, r)
            }
            ...
            let eC = ["image", "file"],
                ...
                e$ = eq(["Because you set `withCredentials` to true, we will override your `useCdn`", "setting to be false since (cookie-based) credentials are never set on the CDN"]),
                eP = eq(["Since you haven't set a value for `useCdn`, we will deliver content using our", "global, edge-cached API-CDN. If you wish to have content delivered faster, set", "`useCdn: false` to use the Live API. Note: You may incur higher costs using the live API."]),
                eU = eq(["The Sanity client is configured with the `perspective` set to `previewDrafts`, which doesn't support the API-CDN.", "The Live API will be used instead. Set `useCdn: false` in your configuration to hide this warning."]),
                eM = eq(["You have configured Sanity client to use a token in the browser. This may cause unintentional security issues.", `See ${eS("js-client-browser-token")} for more information and how to hide this warning.`]),
                eN = eq(["Using the Sanity client without specifying an API version is deprecated.", `See ${eS("js-client-api-version")}`]),
                eL = (eq(["The default export of @sanity/client has been deprecated. Use the named export `createClient` instead."]), {
                ...
                eB = ["localhost", "127.0.0.1", "0.0.0.0"];

            function eD(e) {
                if (Array.isArray(e)) {
                    for (let t of e)
                        if ("published" !== t && "drafts" !== t && !("string" == typeof t && t.startsWith("r") && "raw" !== t)) throw TypeError("Invalid API perspective value, expected `published`, `drafts` or a valid release identifier string");
                    return
                }
                switch (e) {
                    case "previewDrafts":
            ...
            let eF = (e, t) => {
                ...
                if ("u" > typeof i.perspective && eD(i.perspective), "encodeSourceMap" in i) throw Error("It looks like you're using options meant for '@sanity/preview-kit/client'. 'encodeSourceMap' is not supported in '@sanity/client'. Did you mean 'stega.enabled'?");
                ...
                let o = "u" > typeof window && window.location && window.location.hostname,
                    a = o && (r = window.location.hostname, -1 !== eB.indexOf(r));
                o && a && i.token && !0 !== i.ignoreBrowserTokenWarning ? eM() : typeof i.useCdn > "u" && eP(), s && (e => {
                        if (!/^[-a-z0-9]+$/i.test(e)) throw Error("`projectId` can only contain only a-z, 0-9 and dashes")
                    })(i.projectId), i.dataset && eI(i.dataset), "requestTagPrefix" in i && (i.requestTagPrefix = i.requestTagPrefix ? ej(i.requestTagPrefix).replace(/\.+$/, "") : void 0), i.apiVersion = `${i.apiVersion}`.replace(/^v/, ""), i.isDefaultApi = i.apiHost === eL.apiHost, !0 === i.useCdn && i.withCredentials && e$(), i.useCdn = !1 !== i.useCdn && !i.withCredentials,
                    function(e) {
                        if ("1" === e || "X" === e) return;
                        let t = new Date(e);
                ...
                let u = i.apiHost.split("://", 2),
                    c = u[0],
                    l = u[1],
                    f = i.isDefaultApi ? "apicdn.sanity.io" : l;
                return i.useProjectHostname ? (i.url = `${c}://${i.projectId}.${l}/v${i.apiVersion}`, i.cdnUrl = `${c}://${i.projectId}.${f}/v${i.apiVersion}`) : (i.url = `${i.apiHost}/v${i.apiVersion}`, i.cdnUrl = i.url), i
            };
            ...
            let eW = ["channelError", "disconnect"];

            function eY(e, t) {
                return (0, B.v)(() => {
                    let t = e();
                    return t && (t instanceof L.c || (0, D.T)(t.lift) && (0, D.T)(t.subscribe)) ? t : H(t)
                }).pipe((0, J.Z)(e => {
                    var r, n;
                    return r = e, n = t, new L.c(e => {
                        ...
                        function s(t) {
                            if ("data" in t) {
                                let [r, n] = eG(t);
                                e.error(r ? new eX("Unable to parse EventSource error message", {
                                    cause: n
                                }) : new eV((n ? .data).message, n));
                                return
                            }
                            r.readyState === r.CLOSED ? e.error(new ez("EventSource connection failed")) : i && e.next({
                                type: "reconnect"
                            })
                        }
                        ...
                        function a(t) {
                            var r;
                            let [n, i] = eG(t);
                            n ? e.error(new eX("Unable to parse EventSource message", {
                                cause: n
                            })) : "channelError" === t.type ? e.error(new eJ((r = i ? .data).error ? r.error.description ? r.error.description : "string" == typeof r.error ? r.error : JSON.stringify(r.error, null, 2) : r.message || "Unknown listener error", i.data)) : "disconnect" === t.type ? e.error(new eH(`Server disconnected client: ${i.data?.reason||"unknown error"}`)) : e.next({
                                type: t.type,
                                id: t.lastEventId,
                                ...i.data ? {
                                    data: i.data
                        ...
                        let u = [...new Set([...eW, ...n])].filter(e => "error" !== e && "open" !== e && "reconnect" !== e);
...
${t}`)
            ...
            class eK {
                ...
                diffMatchPatch(e) {
                    return eO("diffMatchPatch", e), this._assign("diffMatchPatch", e)
                }
                unset(e) {
                ...
                _assign(e, t, r = !0) {
                    return eO(e, t), this.operations = Object.assign({}, this.operations, {
            ...
            class eZ extends eK {#
                ...
                clone() {
                    return new eZ(this.selection, { ...this.operations
                    }, this.#a)
                }
                commit(e) {
            ...
            class e0 extends eK {#
                ...
                clone() {
                    return new e0(this.selection, { ...this.operations
                    }, this.#a)
                }
                commit(e) {
                    if (!this.#a) throw Error("No `client` passed to patch, either provide one or pass the patch to a clients `mutate()` method");
            ...
            class e2 {
                ...
                create(e) {
                    return eO("create", e), this._add({
                        create: e
                    })
                }
                createIfNotExists(e) {
                    let t = "createIfNotExists";
                    return eO(t, e), ek(t, e), this._add({
                        [t]: e
                    })
                }
                createOrReplace(e) {
            ...
            class e3 extends e2 {#
                ...
                clone() {
                    return new e3([...this.operations], this.#a, this.trxId)
                }
                commit(e) {
                ...
                patch(e, t) {
                    let r = "function" == typeof t,
                        n = "string" != typeof e && e instanceof e0,
                        i = "object" == typeof e && ("query" in e || "id" in e);
                    if (n) return this._add({
                        patch: e.serialize()
                    });
                    if (r) {
                        let r = t(new e0(e, {}, this.#a));
                        if (!(r instanceof e0)) throw Error("function passed to `patch()` must return the patch");
                        return this._add({
                            patch: r.serialize()
                        })
                    }
                    if (i) {
                        let r = new e0(e, t || {}, this.#a);
                        return this._add({
                            patch: r.serialize()
                        })
                    }
            ...
            class e6 extends e2 {#
                ...
                clone() {
                    return new e6([...this.operations], this.#a, this.trxId)
                }
                commit(e) {
                    if (!this.#a) throw Error("No `client` passed to transaction, either provide one or pass the transaction to a clients `mutate()` method");
                    return this.#a.mutate(this.serialize(), Object.assign({
                ...
                patch(e, t) {
                    let r = "function" == typeof t;
                    if ("string" != typeof e && e instanceof eZ) return this._add({
                        patch: e.serialize()
                    });
                    if (r) {
                        let r = t(new eZ(e, {}, this.#a));
                        if (!(r instanceof eZ)) throw Error("function passed to `patch()` must return the patch");
                        return this._add({
                            patch: r.serialize()
                        })
                    }
            ...
            let e8 = ({
                    ...
                    for (let [r, s] of (i && n.append("tag", i), n.append("query", e), Object.entries(t))) n.append(`$${r}`, JSON.stringify(s));
            ...
            function e7(e, t, n, i, s = {}, o = {}) {
                ...
                return a.enabled ? p.pipe(function() {
                    for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
                    return ep.apply(void 0, (0, eo.fX)([], (0, eo.zs)(e)))
                }((0, z.H)(r.e(60826).then(r.bind(r, 60826)).then(function(e) {
            ...
            function e9(e, t, r, n = {}) {
                ...
                return tu(e, t, i).pipe((0, ey.p)(e4), (0, ed.T)(e => e.body.documents && e.body.documents[0]))
            }
            ...
            function te(e, t, r, n = {}) {
                ...
                return tu(e, t, i).pipe((0, ey.p)(e4), (0, ed.T)(e => {
            ...
            function tt(e, t, r, n) {
                return ek("createIfNotExists", r), ta(e, t, r, "createIfNotExists", n)
            }

            function tr(e, t, r, n) {
                return ek("createOrReplace", r), ta(e, t, r, "createOrReplace", n)
            }
            ...
            function ti(e, t, r, n) {
                let i;
                return to(e, t, "mutate", {
                    mutations: Array.isArray(i = r instanceof e0 || r instanceof eZ ? {
                        patch: r.serialize()
                    } : r instanceof e3 || r instanceof e6 ? r.serialize() : r) ? i : [i],
            ...
            function to(e, t, r, n, i = {}) {
                let s = "mutate" === r,
                    ...
                    m = {
                        ...
                        lastLiveEventId: Array.isArray(v) ? v[0] : v,
                        cacheMode: g,
                        canUseCdn: "query" === r,
                        signal: i.signal,
                        fetch: i.fetch,
                ...
                return tu(e, t, m).pipe((0, ey.p)(e4), (0, ed.T)(e5), (0, ed.T)(e => {
                    if (!s) return e;
                    let t = e.results || [];
            ...
            function tu(e, t, r) {
                ...
                let i = r.url || r.uri,
                    s = e.config(),
                    o = typeof r.canUseCdn > "u" ? ["GET", "HEAD"].indexOf(r.method || "GET") >= 0 && 0 === i.indexOf("/data/") : r.canUseCdn,
                ...
                if (u && null !== r.tag && (r.query = {
                        tag: ej(u),
                        ...r.query
                    }), ["GET", "HEAD", "POST"].indexOf(r.method || "GET") >= 0 && 0 === i.indexOf("/data/query/")) {
                    ...
                    "u" > typeof t && (eD(t), r.query = {
                        perspective: Array.isArray(t) ? t.join(",") : t,
                        ...r.query
                    }, "previewDrafts" === t && a && (a = !1, eU())), r.lastLiveEventId && (r.query = { ...r.query,
                ...
                let c = function(e, t = {}) {
                    ...
                    l = new L.c(e => t(c, s.requester).subscribe(e));
                return r.signal ? l.pipe((n = r.signal, e => new L.c(t => {
                    let r = () => t.error(function(e) {
                        if (th) return new DOMException(e ? .reason ? ? "The operation was aborted.", "AbortError");
            ...
            function tc(e, t, r) {
                return tu(e, t, r).pipe((0, ey.p)(e => "response" === e.type), (0, ed.T)(e => e.body))
            }
            ...
            let th = !!globalThis.DOMException;
            class tp {#
                a;#
                u;
                constructor(e, t) {
            ...
            class td {#
                ...
                upload(e, t, r) {
                    return X(ty(this.#a, this.#u, e, t, r).pipe((0, ey.p)(e => "response" === e.type), (0, ed.T)(e => e.body.document)))
                }
            }

            function ty(e, t, r, n, i = {}) {
                var s, o;
                if (-1 === eC.indexOf(r)) throw Error(`Invalid asset type: ${r}. Must be one of ${eC.join(", ")}`);
                let a = i.extract || void 0;
                a && !a.length && (a = ["none"]);
                let u = eR(e.config()),
                    c = "image" === r ? "images" : "files",
                    l = (s = i, o = n, !(typeof File > "u") && o instanceof File ? Object.assign({
                ...
                return g && (m.sourceId = g.id, m.sourceName = g.name, m.sourceUrl = g.url), tu(e, t, {
                    tag: f,
                    method: "POST",
                    timeout: l.timeout || 0,
                    uri: `/assets/${c}/${u}`,
            ...
            let tv = (0, B.v)(() => r.e(62777).then(r.t.bind(r, 62777, 19))).pipe((0, ed.T)(({
                default: e
            }) => e), (0, W.t)(1));
            ...
            function tg() {
                return function(e) {
                    return e.pipe(K((e, t) => {
                        var r;
                        return e instanceof ez ? ee(H({
                            type: "reconnect"
                        }), (void 0 === r && (r = er), new L.c(function(e) {
                            var t = 1e3;
                            t < 0 && (t = 0);
                            var n = 0;
            ...
            let tm = ["includePreviousRevision", "includeResult", "includeMutations", "visibility", "effectFormat", "tag"],
                tb = {
                    includeResult: !0
                };
            ...
            function tw(e, t, r = {}) {
                let {
                    ...
                    withCredentials: s,
                    requestTagPrefix: o
                } = this.config(), a = r.tag && o ? [o, r.tag].join(".") : r.tag, u = { ...Object.keys(tb).concat(Object.keys(r)).reduce((e, t) => (e[t] = typeof r[t] > "u" ? tb[t] : r[t], e), {}),
                    tag: a
                }, c = e8({
                    query: e,
                    params: t,
                    options: {
                        tag: a,
                        ...tm.reduce((e, t) => (typeof u[t] > "u" || (e[t] = u[t]), e), {})
                    }
                }), l = `${n}${tl(this,"listen",c)}`;
                if (l.length > 14800) return en(() => Error("Query too large for listener"));
                let f = u.events ? u.events : ["mutation"],
                    h = {};
                return (i || s) && (h.withCredentials = !0), i && (h.headers = {
                    Authorization: `Bearer ${i}`
                }), eY(() => (typeof EventSource > "u" || h.headers ? tv : H(EventSource)).pipe((0, ed.T)(e => new e(l, h))), f).pipe(tg(), (0, ey.p)(e => f.includes(e.type)), (0, ed.T)(e => ({
                    type: e.type,
                    ..."data" in e ? e.data : {}
                })))
            }
            ...
            class tx {#
                ...
                events({
                    ...
                    let {
                        ...
                        withCredentials: a,
                        requestTagPrefix: u
                    } = this.#a.config(), c = s.replace(/^v/, "");
                    if ("X" !== c && c < t_) throw Error(`The live events API requires API version ${t_} or later. The current API version is ${c}. Please update your API version to use this feature.`);
                    if (e && !o && !a) throw Error("The live events API requires a token or withCredentials when 'includeDrafts: true'. Please update your client configuration. The token should have the lowest possible access role.");
                    let l = tl(this.#a, "live/events"),
                        f = new URL(this.#a.getUrl(l, !1)),
                        h = t && u ? [u, t].join(".") : t;
                    h && f.searchParams.set("tag", h), e && f.searchParams.set("includeDrafts", "true");
                    let p = {};
                    e && o && (p.headers = {
                        Authorization: `Bearer ${o}`
                    }), e && a && (p.withCredentials = !0);
                    let d = eY(() => (typeof EventSource > "u" || p.headers ? tv : H(EventSource)).pipe((0, ed.T)(e => new e(f.href, p))), ["message", "restart", "welcome", "reconnect"]).pipe(tg(), (0, ed.T)(e => {
                        if ("message" === e.type) {
                            let {
                                data: t,
                                ...r
            ...
            class tE {#
                ...
                create(e, t) {
                    return tC(this.#a, this.#u, "PUT", e, t)
                }
                edit(e, t) {
                    return tC(this.#a, this.#u, "PATCH", e, t)
                }
                delete(e) {
                    return tC(this.#a, this.#u, "DELETE", e)
                }
                list() {
                    return tc(this.#a, this.#u, {
                        uri: "/datasets",
                        tag: null
                    })
                }
            ...
            class tS {#
                ...
                create(e, t) {
                    return X(tC(this.#a, this.#u, "PUT", e, t))
                }
                edit(e, t) {
                    return X(tC(this.#a, this.#u, "PATCH", e, t))
                }
                delete(e) {
                    return X(tC(this.#a, this.#u, "DELETE", e))
                }
                list() {
                    return X(tc(this.#a, this.#u, {
                        uri: "/datasets",
                        tag: null
                    }))
                }
            ...
            class tk {
                ...
                listen = tw;
                constructor(e, t = eL) {
                    this.config(t), this.#u = e, this.assets = new tp(this, this.#u), this.datasets = new tE(this, this.#u), this.live = new tx(this), this.projects = new tT(this, this.#u), this.users = new tO(this, this.#u)
                }
                clone() {
                    return new tk(this.#u, this.config())
                }
                config(e) {
                    ...
                    return this.#c = eF(e, this.#c || {}), this
                }
                withConfig(e) {
                    let t = this.config();
                    return new tk(this.#u, { ...t,
                        ...e,
                        stega: { ...t.stega || {},
                            ..."boolean" == typeof e ? .stega ? {
                                enabled: e.stega
                ...
                fetch(e, t, r) {
                    return e7(this, this.#u, this.#c.stega, e, t, r)
                }
                getDocument(e, t) {
                    return e9(this, this.#u, e, t)
                }
                getDocuments(e, t) {
                ...
                delete(e, t) {
                    return tn(this, this.#u, e, t)
                }
                mutate(e, t) {
                    return ti(this, this.#u, e, t)
                }
                patch(e, t) {
                    return new eZ(e, t, this)
                }
                transaction(e) {
                    return new e6(e, this)
                }
                action(e, t) {
                    return ts(this, this.#u, e, t)
                }
                request(e) {
                    return tc(this, this.#u, e)
                }
                getUrl(e, t) {
                    return tf(this, e, t)
                }
            ...
            class tR {
                ...
                listen = tw;
                constructor(e, t = eL) {
                    this.config(t), this.#u = e, this.assets = new td(this, this.#u), this.datasets = new tS(this, this.#u), this.live = new tx(this), this.projects = new tI(this, this.#u), this.users = new tA(this, this.#u), this.observable = new tk(e, t)
                }
                clone() {
                    return new tR(this.#u, this.config())
                }
                config(e) {
                    if (void 0 === e) return { ...this.#c
                    };
                    if (this.#c && !1 === this.#c.allowReconfigure) throw Error("Existing client instance cannot be reconfigured - use `withConfig(newConfig)` to return a new client");
                    return this.observable && this.observable.config(e), this.#c = eF(e, this.#c || {}), this
                }
                withConfig(e) {
                    let t = this.config();
                    return new tR(this.#u, { ...t,
                        ...e,
                        stega: { ...t.stega || {},
                            ..."boolean" == typeof e ? .stega ? {
                                enabled: e.stega
                ...
                fetch(e, t, r) {
                    return X(e7(this, this.#u, this.#c.stega, e, t, r))
                }
                getDocument(e, t) {
                    return X(e9(this, this.#u, e, t))
                }
                getDocuments(e, t) {
                    return X(te(this, this.#u, e, t))
                }
                create(e, t) {
                    return X(ta(this, this.#u, e, "create", t))
                }
                createIfNotExists(e, t) {
                    return X(tt(this, this.#u, e, t))
                }
                createOrReplace(e, t) {
                    return X(tr(this, this.#u, e, t))
                }
                delete(e, t) {
                    return X(tn(this, this.#u, e, t))
                }
                mutate(e, t) {
                    return X(ti(this, this.#u, e, t))
                }
                patch(e, t) {
                    return new e0(e, t, this)
                }
                transaction(e) {
                    return new e3(e, this)
                }
                action(e, t) {
                    return X(ts(this, this.#u, e, t))
                }
                request(e) {
                    return X(tc(this, this.#u, e))
                }
                dataRequest(e, t, r) {
                    return X(to(this, this.#u, e, t, r))
                }
                getUrl(e, t) {
                    return tf(this, e, t)
                }
            ...
            let tj = {
                ...
                tq = (tj.requester, tj.createClient)
        },
        6187: (e, t, r) => {
            "use strict";
            r.d(t, {
        ...
        11792: (e, t, r) => {
            ...
            var n = {
                ...
                s = [, , , , ].fill(String.fromCodePoint(i[0])).join("");

            function o(e, t, r = "auto") {
                let n;
                return !0 === r || "auto" === r && (!(!Number.isNaN(Number(e)) || /[a-z]/i.test(e) && !/\d+(?:[-:\/]\d+){2}(?:T\d+(?:[-:\/]\d+){1,2}(\.\d+)?Z?)?/.test(e)) && Date.parse(e) || function(e) {
                    ...
                    return !0
                }(e)) ? e : `${e}${n=JSON.stringify(t),`${s}${Array.from(n).map(e=>{let t=e.charCodeAt(0);if(t>255)throw Error(`Only ASCII edit info can be encoded. Error attempting to encode ${n} on character ${e} (${t})`);return Array.from(t.toString(4).padStart(4,"0")).map(e=>String.fromCodePoint(i[e])).join("")}).join("")}`}`
            }
            Object.fromEntries(Object.entries(i).map(e => e.reverse())), Object.fromEntries(Object.entries(n).map(e => e.reverse()));
            var a = `${Object.values(n).map(e=>`\\u{${e.toString(16)}}`).join("")}`,
                u = RegExp(`[${a}]{4,}`, "gu");
                        ...
                        if (!this.closed) {
                            ...
                            if (u)
                                if (this._parentage = null, Array.isArray(u)) try {
                                    for (var c = (0, n.Ju)(u), f = c.next(); !f.done; f = c.next()) f.value.remove(this)
                                } catch (t) {
                                    e = {
                                        error: t
                                    }
                            ...
                            if (p) {
                                ...
                                try {
                                    for (var d = (0, n.Ju)(p), y = d.next(); !y.done; y = d.next()) {
                                        var v = y.value;
                                        try {
                                            l(v)
                                        } catch (e) {
        ...
        15033: (e, t, r) => {
            ...
            let n = (0, r(80087).createAsyncLocalStorage)()
        },
        16296: (e, t, r) => {
            "use strict";
            r.d(t, {
            ...
            let a = {},
                u = e => "string" == typeof e ? {
                    type: e
                } : "function" == typeof e ? "resolve" in e ? {
                    type: e.type
                } : {
                    type: e.name
                } : e;
            class c {
                constructor(e, t) {
                    if (this.config = e, this.key = void 0, this.id = void 0, this.type = void 0, this.path = void 0, this.states = void 0, this.history = void 0, this.entry = void 0, this.exit = void 0, this.parent = void 0, this.machine = void 0, this.meta = void 0, this.output = void 0, this.order = -1, this.description = void 0, this.tags = [], this.transitions = void 0, this.always = void 0, this.parent = t._parent, this.key = t._key, this.machine = t._machine, this.path = this.parent ? this.parent.path.concat(this.key) : [], this.id = this.config.id || [this.machine.id, ...this.path].join(n.S), this.type = this.config.type || (this.config.states && Object.keys(this.config.states).length ? "compound" : this.config.history ? "history" : "atomic"), this.description = this.config.description, this.order = this.machine.idMap.size, this.machine.idMap.set(this.id, this), this.states = this.config.states ? (0, n.q)(this.config.states, (e, t) => new c(e, {
                        ...
                        })) : a, "compound" === this.type && !this.config.initial) throw Error(`No initial state specified for compound state node "#${this.id}". Try adding { initial: "${Object.keys(this.states)[0]}" } to the state config.`);
                    this.history = !0 === this.config.history ? "shallow" : this.config.history || !1, this.entry = (0, n.t)(this.config.entry).slice(), this.exit = (0, n.t)(this.config.exit).slice(), this.meta = this.config.meta, this.output = "final" !== this.type && this.parent ? void 0 : this.config.output, this.tags = (0, n.t)(e.tags).slice()
                }
                _initialize() {
                    this.transitions = (0, n.u)(this), this.config.always && (this.always = (0, n.v)(this.config.always).map(e => (0, n.w)(this, n.N, e))), Object.keys(this.states).forEach(e => {
                ...
                get definition() {
                    return {
                        ...
                        states: (0, n.q)(this.states, e => e.definition),
                        on: this.on,
                        transitions: [...this.transitions.values()].flat().map(e => ({ ...e,
                            actions: e.actions.map(u)
                        })),
                ...
                get invoke() {
                    return o(this, "invoke", () => (0, n.t)(this.config.invoke).map((e, t) => {
                        let {
                            src: r,
                            systemId: i
                        } = e, s = e.id ? ? (0, n.y)(this.id, t), o = "string" == typeof r ? r : `xstate.invoke.${(0,n.y)(this.id,t)}`;
                        return { ...e,
                            src: o,
                            id: s,
                            systemId: i,
                ...
                get on() {
                    return o(this, "on", () => [...this.transitions].flatMap(([e, t]) => t.map(t => [e, t])).reduce((e, [t, r]) => (e[t] = e[t] || [], e[t].push(r), e), {}))
                }
                get after() {
                    return o(this, "delayedTransitions", () => (0, n.z)(this))
                }
                get initial() {
                    return o(this, "initial", () => (0, n.B)(this, this.config.initial))
                }
                next(e, t) {
                    let r, i = t.type,
                        s = [];
                    for (let a of o(this, `candidates-${i}`, () => (0, n.C)(this, i))) {
                        let {
                            guard: o
                        } = a, u = e.context, c = !1;
                        try {
                            ...
                            let e = "string" == typeof o ? o : "object" == typeof o ? o.type : void 0;
                            throw Error(`Unable to evaluate guard ${e?`'${e}' `:""}in transition for event '${i}' in state node '${this.id}':
${t.message}`)
                        }
                        if (c) {
                            s.push(...a.actions), r = a;
                            break
                        }
                    }
                    return r ? [r] : void 0
                    ...
                    return o(this, "events", () => {
                        ...
                        if (e)
                            for (let r of Object.keys(e)) {
                                let n = e[r];
                                if (n.states)
                                    for (let e of n.events) t.add(`${e}`)
                            }
                        return Array.from(t)
                    })
                }
                get ownEvents() {
                    return Array.from(new Set(Object.keys(Object.fromEntries(this.transitions)).filter(e => this.transitions.get(e).some(e => !(!e.target && !e.actions.length && !e.reenter)))))
                }
            }
            class l {
                constructor(e, t) {
                ...
                resolveState(e) {
                    let t = (0, n.D)(this.root, e.value),
                        r = (0, n.E)((0, n.g)(this.root, t));
                    return (0, n.F)({
                        _nodes: [...r],
                        context: e.context || {},
                        children: {},
                        status: (0, n.G)(r, this.root) ? "done" : e.status || "active",
                        output: e.output,
                        error: e.error,
                ...
                transition(e, t, r) {
                    return (0, n.H)(e, t, r, []).snapshot
                }
                microstep(e, t, r) {
                    return (0, n.H)(e, t, r, []).microstates
                }
                getTransitionData(e, t) {
                    return (0, n.I)(this.root, e.value, e, t) || []
                }
                getPreInitialState(e, t, r) {
                    ...
                    return "function" == typeof s ? (0, n.J)(o, t, e, [(0, i.a)(({
                        spawn: e,
                        event: t,
                        self: r
                    }) => s({
                ...
                getInitialSnapshot(e, t) {
                    let r = (0, n.K)(t),
                        i = [],
                        s = this.getPreInitialState(e, r, i),
                        o = (0, n.L)([{
                            target: [...(0, n.M)(this.root)],
                            source: this.root,
                            reenter: !0,
                            actions: [],
                            eventType: null,
                ...
                getStateNodeById(e) {
                    let t = (0, n.O)(e),
                        r = t.slice(1),
                        i = (0, n.P)(t[0]) ? t[0].slice(1) : t[0],
                        s = this.idMap.get(i);
                    if (!s) throw Error(`Child state node '#${i}' does not exist on machine '${this.id}'`);
                    return (0, n.Q)(s, r)
                }
                get definition() {
                ...
                restoreSnapshot(e, t) {
                    ...
                    Object.keys(i).forEach(e => {
                        let s = i[e],
                            o = s.snapshot,
                            a = s.src,
                            u = "string" == typeof a ? (0, n.T)(this, a) : a;
                        if (!u) return;
                        let c = (0, n.c)(u, {
                            id: e,
                            parent: t.self,
                    ...
                    let s = function(e, t) {
                        ...
                        o = (0, n.F)({ ...e,
                            children: r,
                            _nodes: Array.from((0, n.E)((0, n.g)(this.root, e.value))),
                            historyValue: s
                        }, this),
                        a = new Set;
                        ...
                        if (!a.has(t))
                            for (let i in a.add(t), t) {
                                ...
                                if (s && "object" == typeof s) {
                                    if ("xstate$$type" in s && s.xstate$$type === n.$) {
                                        t[i] = r[s.id];
                                        continue
                                    }
                                    e(s, r)
            ...
            function h(e, t) {
                let r = (0, n.t)(t);
                if (!r.some(t => (0, n.m)(e.type, t))) {
                    let t = 1 === r.length ? `type matching "${r[0]}"` : `one of types matching "${r.join('", "')}"`;
        ...
        28457: (e, t, r) => {
            ...
            function a(e) {
                return {
                    ...
                    start: (t, r) => {
                        ...
                        o.set(n, a), a.dispose = e({
                            input: t.input,
                            system: i,
                            self: n,
                            sendBack: e => {
                                "stopped" !== n.getSnapshot().status && n._parent && i._relay(n, n._parent, e)
                            },
                            receive: e => {
                    ...
                    transition: (e, t, r) => {
                        let n = o.get(r.self);
                        return t.type === s.X ? (e = { ...e,
                            status: "stopped",
                            error: void 0
                        }, n.dispose ? .()) : n.receivers ? .forEach(e => e(t)), e
                    },
                    getInitialSnapshot: (e, t) => ({
                        status: "active",
                        output: void 0,
                ...
                return {
                    ...
                    transition: (e, t) => {
                        ...
                        switch (t.type) {
                            ...
                            case s.X:
                                return e._subscription.unsubscribe(), { ...e,
                                    status: "stopped",
                                    input: void 0,
                                    _subscription: void 0
                                };
                    ...
                    start: (t, {
                        ...
                        "done" !== t.status && (t._subscription = e({
                            input: t.input,
                            system: n,
                            self: r,
                            emit: i
                            ...
                            next: e => {
                                r._parent && n._relay(r, r._parent, e)
                            },
                            error: e => {
                                n._relay(r, r, {
                                    type: u,
                ...
                return {
                    ...
                    start: (t, {
                        ...
                        p.set(r, s), Promise.resolve(e({
                            ...
                            "active" === r.getSnapshot().status && (p.delete(r), n._relay(r, r, {
                                type: f,
                                data: e
                            }))
                        }, e => {
            ...
            let y = (i = void 0, {
                config: n = e => void 0,
                transition: (e, t, r) => ({ ...e,
                    context: n(e.context, t, r)
                }),
                getInitialSnapshot: (e, t) => ({
                    status: "active",
                    output: void 0,
                    error: void 0,
                    context: "function" == typeof i ? i({
                        input: t
                    }) : i
                }),
                getPersistedSnapshot: e => e,
                ...
                u = function(e) {
                    ...
                    function c(e) {
                        let o = u ? (0, n.jsx)(u, {
                            ...
                            a = !t.ssr || !!t.loading,
                            c = a ? i.Suspense : i.Fragment,
                            l = t.ssr ? (0, n.jsxs)(n.Fragment, {
        ...
        34997: (e, t, r) => {
            ...
            function o(e, t, r, n, {
                ...
                return [t, {
                    event: "function" == typeof i ? i(r, n) : i
                }, void 0]
            }
            ...
            function u(e) {
                function t(e, t) {}
                return t.type = "xstate.emit", t.event = e, t.resolve = o, t.execute = a, t
            }
            let c = ((n = {}).Parent = "#_parent", n.Internal = "#_internal", n);
            ...
            function l(e, t, r, n, {
                ...
                let f, h, p = t.machine.implementations.delays;
                if ("string" == typeof s) throw Error(`Only event objects may be used with sendTo; use sendTo({ type: "${s}" }) instead`);
                let d = "function" == typeof s ? s(r, n) : s;
                if ("string" == typeof a) {
                    let e = p && p[a];
                    f = "function" == typeof e ? e(r, n) : e
                } else f = "function" == typeof a ? a(r, n) : a;
                let y = "function" == typeof i ? i(r, n) : i;
                if ("string" == typeof y) {
                    if (!(h = y === c.Parent ? e.self._parent : y === c.Internal ? e.self : y.startsWith("#_") ? t.children[y.slice(2)] : u.deferredActorIds ? .includes(y) ? y : t.children[y])) throw Error(`Unable to send event to actor '${y}' from machine '${t.machine.id}'.`)
                } else h = y || e.self;
                return [t, {
                    to: h,
                    targetId: "string" == typeof y ? y : void 0,
                    event: d,
                    id: o,
                    delay: f
                }, void 0]
            ...
            function f(e, t, r) {
                "string" == typeof r.to && (r.to = t.children[r.to])
            }
            ...
            function h(e, t) {
                e.defer(() => {
                    ...
                    "number" == typeof s ? e.system.scheduler.schedule(e.self, r, n, s, o) : e.system._relay(e.self, r, n.type === i.U ? (0, i.V)(e.self.id, n.data) : n)
                })
            }

            function p(e, t, r) {
                function n(e, t) {}
                return n.type = "xstate.sendTo", n.to = e, n.event = t, n.id = r ? .id, n.delay = r ? .delay, n.resolve = l, n.retryResolve = f, n.execute = h, n
            }

            function d(e, t) {
                return p(c.Parent, e, t)
            }
            ...
            function y(e, t, r, n, {
                ...
                return c.assign = (...e) => {
                    ...
                    event: r.event,
                    enqueue: c,
                    check: e => (0, i.x)(e, t.context, r.event, t),
                    self: e.self,
                    system: e.system
                }, n), [t, void 0, a]
            }
            ...
            function v(e) {
                function t(e, t) {}
                return t.type = "xstate.enqueueActions", t.collect = e, t.resolve = y, t
            }
            ...
            function g(e, t, r, n, {
                ...
                return [t, {
                    value: "function" == typeof i ? i(r, n) : i,
                    label: s
                }, void 0]
            }
            ...
            function b(e = ({
                ...
                function r(e, t) {}
                return r.type = "xstate.log", r.value = e, r.label = t, r.resolve = g, r.execute = m, r
            }
        },
        37740: (e, t, r) => {
            "use strict";
            ...
            function p(e, t, r) {
                ...
                function a(e, t) {
                    try {
                        var r;
                        (r = i[e](t)).value instanceof h ? Promise.resolve(r.value.v).then(u, c) : l(s[0][2], r)
                    } catch (e) {
                        l(s[0][3], e)
                    }
                }
        ...
        38131: (e, t, r) => {
            ...
            function u(e, t, r) {
                ...
                if (A(e, ArrayBuffer) || e && A(e.buffer, ArrayBuffer) || "u" > typeof SharedArrayBuffer && (A(e, SharedArrayBuffer) || e && A(e.buffer, SharedArrayBuffer))) return h(e, t, r);
                if ("number" == typeof e) throw TypeError('The "value" argument must not be of type number. Received type number');
                var v = e.valueOf && e.valueOf();
                if (null != v && v !== e) return a.from(v, t, r);
                var g = function(e) {
                    if (a.isBuffer(e)) {
                        var t = 0 | p(e.length),
                            r = o(t);
                ...
                for (var n = [], i = t; i < r;) {
                    ...
                    if (i + f <= r) switch (f) {
                        case 1:
                            ...
                            break;
                        case 2:
                            (192 & (s = e[i + 1])) == 128 && (u = (31 & c) << 6 | 63 & s) > 127 && (l = u);
                            break;
                        case 3:
                            s = e[i + 1], o = e[i + 2], (192 & s) == 128 && (192 & o) == 128 && (u = (15 & c) << 12 | (63 & s) << 6 | 63 & o) > 2047 && (u < 55296 || u > 57343) && (l = u);
                            break;
                        case 4:
                            s = e[i + 1], o = e[i + 2], a = e[i + 3], (192 & s) == 128 && (192 & o) == 128 && (192 & a) == 128 && (u = (15 & c) << 18 | (63 & s) << 12 | (63 & o) << 6 | 63 & a) > 65535 && u < 1114112 && (l = u)
                    }
            ...
            function E(e, t, r, n, s) {
                return t *= 1, r >>>= 0, s || x(e, t, r, 4, 34028234663852886e22, -34028234663852886e22), i.write(e, t, r, n, 23, 4), r + 4
            }

            function S(e, t, r, n, s) {
                return t *= 1, r >>>= 0, s || x(e, t, r, 8, 17976931348623157e292, -17976931348623157e292), i.write(e, t, r, n, 52, 8), r + 8
            }
            t.hp = a, t.IS = 50, a.TYPED_ARRAY_SUPPORT = function() {
                ...
                for (r = 0; r < e.length; ++r) {
                    var s = e[r];
                    if (A(s, Uint8Array)) i + s.length > n.length ? a.from(s).copy(n, i) : Uint8Array.prototype.set.call(n, s, i);
                ...
                for (var s = i - n, o = r - t, u = Math.min(s, o), c = this.slice(n, i), l = e.slice(t, r), f = 0; f < u; ++f)
                    if (c[f] !== l[f]) {
                        s = c[f], o = l[f];
                        break
                    }
                ...
                var i, s, o, a, u, c, l, f, h = this.length - t;
                ...
                for (var p = !1;;) switch (n) {
                    case "hex":
                        return function(e, t, r, n) {
                            ...
                            n > s / 2 && (n = s / 2);
                            for (var o = 0; o < n; ++o) {
                                var a, u = parseInt(t.substr(2 * o, 2), 16);
                                if ((a = u) != a) break;
                                e[r + o] = u
                            }
                            return o
                    ...
                    case "utf8":
                    case "utf-8":
                        return i = t, s = r, O(T(e, this.length - i), this, i, s);
                    case "ascii":
                    case "latin1":
                    case "binary":
                    ...
                    case "base64":
                        return u = t, c = r, O(I(e), this, u, c);
                    case "ucs2":
                    case "ucs-2":
                    case "utf16le":
                    case "utf-16le":
                        return l = t, f = r, O(function(e, t) {
        ...
        40152: (e, t, r) => {
            ...
            var n = r(91702);
            let i = (0, r(17855).default)(() => r.e(14207).then(r.bind(r, 14207)), {
                loadableGenerated: {
                    webpack: () => [require.resolveWeak("../_chunks-es/SanityLiveStream.js")]
                },
                ssr: !1
            });
        ...
        51144: (e, t, r) => {
            ...
            function i(e) {
                ...
                return (0, n.useInsertionEffect)(() => {
                    t.current = e
                }, [e]), (0, n.useCallback)((...e) => (0, t.current)(...e), [])
            }
        },
        51711: (e, t, r) => {
            "use strict";
        ...
        58119: (e, t, r) => {
            ...
            let i = {
                ...
                o = e => {
                    ...
                    return t && "object" == typeof t && "domain" in t && "type" in t && "from" in t && "to" in t && ("sanity/channels" === t.domain && (t.domain = n.V2), "overlays" === t.to && (t.to = "visual-editing"), "overlays" === t.from && (t.from = "visual-editing"), t.channelId = t.connectionId, delete t.connectionId, t.type = i[t.type] ? ? t.type), e
                },
                a = ({
                    context: e
                }, t) => {
                    let {
                        ...
                        return i.domain === n.V2 && (i.domain = "sanity/channels"), "visual-editing" === i.to && (i.to = "overlays"), "visual-editing" === i.from && (i.from = "overlays"), i.type = s[i.type] ? ? i.type, "channel/response" === i.type && i.responseTo && !i.data && (i.data = {
                            responseTo: i.responseTo
                        }), ("handshake/syn" === i.type || "handshake/syn-ack" === i.type || "handshake/ack" === i.type) && (i.data = {
                            id: i.connectionId
                        }), i
                    })(t.message);
                    r.forEach(e => {
        ...
        65171: (e, t, r) => {
                ...
                let a = {},
                    u = {
                        ...
                        spawn: function(e, {
                            ...
                            return (o, a) => {
                                let u = ((o, a) => {
                                    if ("string" != typeof o) return (0, n.c)(o, {
                                        id: a ? .id,
                                        parent: e.self,
                                        ...
                                        let u = (0, n.T)(t, o);
                                        if (!u) throw Error(`Actor logic '${o}' not implemented in machine '${t.id}'`);
                                        let c = (0, n.c)(u, {
                                            id: a ? .id,
                                            parent: e.self,
                                            syncSnapshot: a ? .syncSnapshot,
                                            input: "function" == typeof a ? .input ? a.input({
                                                context: r,
                                                event: i,
                                                self: e.self
                                            }) : a ? .input,
                                ...
                                return s[u.id] = u, e.defer(() => {
                                    u._processingStatus !== n.W.Stopped && u.start()
                                }), u
                            }
                        }(e, t, r.event, a),
                        self: e.self,
                    ...
                    c = {};
                if ("function" == typeof o) c = o(u, s);
                else
                    for (let e of Object.keys(o)) {
                        let t = o[e];
                        c[e] = "function" == typeof t ? t(u, s) : t
                    }
                let l = Object.assign({}, t.context, c);
                return [(0, n.Y)(t, {
                    context: l,
                    children: Object.keys(a).length ? { ...t.children,
                        ...a
                    } : t.children
                }), void 0, void 0]
            }
            ...
            function s(e) {
                function t(e, t) {}
                return t.type = "xstate.assign", t.assignment = e, t.resolve = i, t
            }
        },
        67721: (e, t, r) => {
            "use strict";
            r.d(t, {
                Z: () => function e(t, r, u) {
                    return (void 0 === u && (u = 1 / 0), (0, a.T)(r)) ? e(function(e, s) {
                        ...
                        var n, s, a, c, l, f, h, p;
                        return n = u, s = [], a = 0, c = 0, l = !1, f = function() {
                                !l || s.length || a || r.complete()
                            }, h = function(e) {
                                return a < n ? p(e) : s.push(e)
                            }, p = function(e) {
                                a++;
                                var u = !1;
                                (0, i.Tg)(t(e, c++)).subscribe((0, o._)(r, function(e) {
                                    r.next(e)
                                }, function() {
                                    u = !0
                                }, void 0, function() {
                                    if (u) try {
                                        for (a--; s.length && a < n;) ! function() {
                                            var e = s.shift();
                                            p(e)
                                        }();
                                        f()
                            ...
                            }, e.subscribe((0, o._)(r, h, function() {
                                l = !0, f()
                            })),
                            function() {}
                    }))
        ...
        69832: (e, t, r) => {
            ...
            function y(e) {
                ...
                if (null != e) {
                    ...
                    if ((0, u.T)(e)) return v(e);
                    if ((0, l.x)(e)) {
                        return g = e, new o.c(function(e) {
                            var t, r;
                            try {
                                for (var i = (0, n.Ju)(g), s = i.next(); !s.done; s = i.next()) {
                                    var o = s.value;
            ...
            function u(e) {
                ...
                return function(e) {
                    ...
                    return (0, a.N)(function(e, a) {
                        ...
                        a.add(function() {
                            0 != --l || d || h || (n = c(g, p))
                        }), m.subscribe(a), !t && l > 0 && (t = new o.Ms({
                            next: function(e) {
                                return m.next(e)
                            },
                            error: function(e) {
                                d = !0, y(), n = c(v, u, e), m.error(e)
                            },
                            complete: function() {
                                h = !0, y(), n = c(v, f), m.complete()
                            }
                        }), (0, i.Tg)(e).subscribe(t))
                    })(e)
                }
        ...
        72900: (e, t, r) => {
            ...
            r.d(t, {
                ...
                I: () => function e(t, r, n, i) {
                    if ("string" == typeof r) {
                        let e;
                        return (e = eu(t, r).next(n, i)) && e.length ? e : t.next(n, i)
                    }
                    if (1 === Object.keys(r).length) {
                        let s, o;
                        return (o = e(eu(t, (s = Object.keys(r))[0]), r[s[0]], n, i)) && o.length ? o : t.next(n, i)
                    }
                    let s = [];
                    for (let o of Object.keys(r)) {
                        let a = r[o];
                        if (!a) continue;
                        let u = e(eu(t, o), a, n, i);
                        u && s.push(...u)
                    }
                    return s.length ? s : t.next(n, i)
                },
                J: () => eb,
                K: () => h,
                L: () => ev,
            ...
            let d = "function" == typeof Symbol && Symbol.observable || "@@observable";
            ...
            function v(e) {
                var t;
                return (t = e) && "object" == typeof t && "machine" in t && "value" in t ? e.value : "string" != typeof e ? e : function(e) {
                    if (1 === e.length) return e[0];
                    let t = {},
                        r = t;
                    for (let t = 0; t < e.length - 1; t++)
                        if (t === e.length - 2) r[e[t]] = e[t + 1];
                        else {
                            let n = r;
                            r = {}, n[e[t]] = r
                        }
            ...
            function _(e) {
                var t;
                return (w(t = e) ? t : [t]).map(e => void 0 === e || "string" == typeof e ? {
                    target: e
                } : e)
            }

            function x(e) {
                if (void 0 !== e && "" !== e) return m(e)
            }
            ...
            function C(e, t) {
                let r = t.match(/^xstate\.invoke\.(\d+)\.(.*)/);
                if (!r) return e.implementations.actors[t];
                let [, n, i] = r, s = e.getStateNodeById(i).config.invoke;
                return (Array.isArray(s) ? s[n] : s).src
            }
            ...
            let O = 0,
                A = !1,
                k = 1,
                R = ((n = {})[n.NotStarted = 0] = "NotStarted", n[n.Running = 1] = "Running", n[n.Stopped = 2] = "Stopped", n),
                j = {
                    clock: {
            ...
            class q {
                constructor(e, t) {
                    ...
                    this.system = o ? o.system : function(e, t) {
                        let r = new Map,
                            n = new Map,
                            i = new WeakMap,
                            s = new Set,
                            ...
                            c = {
                                schedule: (e, t, r, n, i = Math.random().toString(36).slice(2)) => {
                                    let s = {
                                            source: e,
                                            target: t,
                                            event: r,
                                    ...
                                    let c = a.setTimeout(() => {
                                        delete o[u], delete l._snapshot._scheduledEvents[u], l._relay(e, t, r)
                                    }, n);
                                    o[u] = c
                                },
                                cancel: (e, t) => {
                                    let r = I(e, t),
                                        n = o[r];
                                    delete o[r], delete l._snapshot._scheduledEvents[r], void 0 !== n && a.clearTimeout(n)
                                },
                                cancelAll: e => {
                                    for (let t in l._snapshot._scheduledEvents) {
                                        let r = l._snapshot._scheduledEvents[t];
                                        r.source === e && c.cancel(e, r.id)
                                    }
                                }
                            },
                            l = {
                                ...
                                _bookId: () => `x:${O++}`,
                                _register: (e, t) => (r.set(e, t), e),
                                _unregister: e => {
                                    r.delete(e.sessionId);
                                    let t = i.get(e);
                                    void 0 !== t && (n.delete(t), i.delete(e))
                                },
                                get: e => n.get(e),
                                getAll: () => Object.fromEntries(n.entries()),
                                _set: (e, t) => {
                                    let r = n.get(e);
                                    if (r && r !== t) throw Error(`Actor with system ID '${e}' already exists.`);
                                    n.set(e, t), i.set(t, e)
                                },
                                inspect: e => {
                                    let t = E(e);
                        ...
                        clock: n,
                        logger: s
                    }), l && !o && this.system.inspect(E(l)), this.sessionId = this.system._bookId(), this.id = u ? ? this.sessionId, this.logger = t ? .logger ? ? this.system._logger, this.clock = t ? .clock ? ? this.system._clock, this._parent = o, this._syncSnapshot = a, this.options = r, this.src = r.src ? ? e, this.ref = this, this._actorScope = {
                        self: this,
                        id: this.id,
                        ...
                        emit: e => {
                            let t = this.eventListeners.get(e.type),
                                r = this.eventListeners.get("*");
                            if (t || r)
                                for (let n of [...t ? t.values() : [], ...r ? r.values() : []]) try {
                                    n(e)
                                } catch (e) {
                                    p(e)
                                }
                        ...
                        actionExecutor: e => {
                            let t = () => {
                                ...
                                let t = A;
                                try {
                                    A = !0, e.exec(e.info, e.params)
                                } finally {
                                    A = t
                                }
                            };
                            this._processingStatus === R.Running ? t() : this._deferred.push(t)
                        }
                    }, this.send = this.send.bind(this), this.system._sendInspectionEvent({
                        type: "@xstate.actor",
                        actorRef: this
                    }), c && (this.systemId = c, this.system._set(c, this)), this._initState(t ? .snapshot ? ? t ? .state), c && "active" !== this._snapshot.status && this.system._unregister(this)
                }
                _initState(e) {
                    try {
                ...
                update(e, t) {
                    let r;
                    for (this._snapshot = e; r = this._deferred.shift();) try {
                        r()
                    } catch (t) {
                        this._deferred.length = 0, this._snapshot = { ...e,
                            status: "error",
                            error: t
                        }
                    }
                    switch (this._snapshot.status) {
                        ...
                        case "done":
                            ...
                            this._stopProcedure(), this._complete(), this._doneEvent = (n = this.id, {
                ...
                start() {
                    ...
                    this._syncSnapshot && this.subscribe({
                        next: e => {
                            "active" === e.status && this.system._relay(this, this._parent, {
                                type: `xstate.snapshot.${this.id}`,
                                snapshot: e
                            })
                        },
                        error: () => {}
                    }), this.system._register(this.sessionId, this), this.systemId && this.system._set(this.systemId, this), this._processingStatus = R.Running;
                ...
                _process(e) {
                    ...
                    this.update(t, e), e.type === c && (this._stopProcedure(), this._complete())
                }
                _stop() {
                    return this._processingStatus === R.Stopped || ((this.mailbox.clear(), this._processingStatus === R.NotStarted) ? this._processingStatus = R.Stopped : this.mailbox.enqueue({
                        type: c
                    })), this
                }
                stop() {
                ...
                _reportError(e) {
                    ...
                    this.observers.clear(), t && p(e)
                }
                _error(e) {
                    this._stopProcedure(), this._reportError(e), this._parent && this.system._relay(this, this._parent, f(this.id, e))
                }
                _stopProcedure() {
                    return this._processingStatus !== R.Running || (this.system.scheduler.cancelAll(this), this.mailbox.clear(), this.mailbox = new i(this._process.bind(this)), this._processingStatus = R.Stopped, this.system._unregister(this)), this
                }
                _send(e) {
                ...
                attachDevTools() {
                    ...
                    e && ("function" == typeof e ? e : e => {
                        ...
                        let t = function() {
                            let e = "u" > typeof globalThis ? globalThis : "u" > typeof self ? self : "u" > typeof window ? window : void 0 !== r.g ? r.g : void 0;
            ...
            function P(e, t, r, n, {
                ...
                return [t, {
                    sendId: "function" == typeof i ? i(r, n) : i
                }, void 0]
            }
            ...
            function M(e) {
                function t(e, t) {}
                return t.type = "xstate.cancel", t.sendId = e, t.resolve = P, t.execute = U, t
            }
            ...
            function N(e, t, r, n, {
                ...
                let c, l, f = "string" == typeof o ? C(t.machine, o) : o,
                    h = "function" == typeof i ? i(r) : i;
                return f && (l = "function" == typeof a ? a({
                    context: t.context,
                    event: r.event,
                    self: e.self
                }) : a, c = $(f, {
            ...
            function B(...[e, {
                ...
                function s(e, t) {}
                return s.type = "xstate.spawnChild", s.id = t, s.systemId = r, s.src = e, s.input = n, s.syncSnapshot = i, s.resolve = N, s.execute = L, s
            }

            function D(e, t, r, n, {
                actorRef: i
            }) {
                let s = "function" == typeof i ? i(r, n) : i,
                    o = "string" == typeof s ? t.children[s] : s,
                    a = t.children;
                return o && (a = { ...a
                }, delete a[o.id]), [ek(t, {
                    children: a
            ...
            function F(e, t) {
                if (t) {
                    if (e.system._unregister(t), t._processingStatus !== R.Running) return void e.stopChild(t);
                    e.defer(() => {
                        e.stopChild(t)
                    })
                }
            ...
            function z(e) {
                function t(e, t) {}
                return t.type = "xstate.stopChild", t.actorRef = e, t.resolve = D, t.execute = F, t
            }

            function H(e, t, r, n) {
                let {
                    machine: i
                } = n, s = "function" == typeof e, o = s ? e : i.implementations.guards["string" == typeof e ? e : e.type];
                if (!s && !o) throw Error(`Guard '${"string"==typeof e?e:e.type}' is not implemented.'.`);
                if ("function" != typeof o) return H(o, t, r, n);
                let a = {
                        context: t,
                        event: r
                    },
                    u = s || "string" == typeof e ? void 0 : "params" in e ? "function" == typeof e.params ? e.params({
                        context: t,
                        event: r
                    }) : e.params : void 0;
                return "check" in o ? o.check(n, a, o) : o(a, u)
            }
            let J = e => "atomic" === e.type || "final" === e.type;
            ...
            function W(e) {
                let t = new Set(e),
                    r = Y(t);
                for (let e of t)
                    if ("compound" !== e.type || r.get(e) && r.get(e).length) {
                        if ("parallel" === e.type) {
                            for (let r of V(e))
                                if ("history" !== r.type && !t.has(r))
                                    for (let e of eo(r)) t.add(e)
                        }
            ...
            function Y(e) {
                let t = new Map;
                for (let r of e) t.has(r) || t.set(r, []), r.parent && (t.has(r.parent) || t.set(r.parent, []), t.get(r.parent).push(r));
                return t
            }
            ...
            function G(e, t) {
                return function e(t, r) {
                    ...
                    let i = {};
                    for (let t of n) i[t.key] = e(t, r);
                    return i
                }(e, Y(W(t)))
            }

            function Q(e, t) {
                return "compound" === t.type ? V(t).some(t => "final" === t.type && e.has(t)) : "parallel" === t.type ? V(t).every(t => Q(e, t)) : "final" === t.type
            }
            let K = e => "#" === e[0];

            function Z(e, t) {
                return e.transitions.get(t) || [...e.transitions.keys()].filter(e => T(t, e)).sort((e, t) => t.length - e.length).flatMap(t => e.transitions.get(t))
            }

            function ee(e) {
                let t = e.config.after;
                return t ? Object.keys(t).flatMap(r => {
                    var n;
                    let i, s, o = t[r],
                        a = Number.isNaN(+r) ? r : +r,
                        u = (n = e.id, s = (i = {
                            type: `xstate.after.${a}.${n}`
                        }).type, e.entry.push(e$(i, {
                            id: s,
                            delay: a
                        })), e.exit.push(M(s)), s);
                    return m("string" == typeof o ? {
                        target: o
                    } : o).map(e => ({ ...e,
                        event: u,
                        delay: a
            ...
            function et(e, t, r) {
                let n = x(r.target),
                    i = r.reenter ? ? !1,
                    o = function(e, t) {
                        if (void 0 !== t) return t.map(t => {
                            if ("string" != typeof t) return t;
                            if (K(t)) return e.machine.getStateNodeById(t);
                            let r = t[0] === s;
                            if (r && !e.parent) return ec(e, t.slice(1));
                            let n = r ? e.key + t : t;
                            if (e.parent) try {
...
${t.message}`)
            ...
            function er(e) {
                let t = new Map;
                if (e.config.on)
                    for (let r of Object.keys(e.config.on)) {
                        if (r === o) throw Error('Null events ("") cannot be specified as a transition key. Use `always: { ... }` instead.');
                        let n = e.config.on[r];
                        t.set(r, _(n).map(t => et(e, r, t)))
                    }
                if (e.config.onDone) {
                    let r = `xstate.done.state.${e.id}`;
                    t.set(r, _(e.config.onDone).map(t => et(e, r, t)))
                }
                for (let r of e.invoke) {
                    if (r.onDone) {
                        let n = `xstate.done.actor.${r.id}`;
                        t.set(n, _(r.onDone).map(t => et(e, n, t)))
                    }
                    if (r.onError) {
                        let n = `xstate.error.actor.${r.id}`;
                        t.set(n, _(r.onError).map(t => et(e, n, t)))
                    }
                    if (r.onSnapshot) {
                        let n = `xstate.snapshot.${r.id}`;
                        t.set(n, _(r.onSnapshot).map(t => et(e, n, t)))
                    }
                }
                for (let r of e.after) {
                    let e = t.get(r.eventType);
                    e || (e = [], t.set(r.eventType, e)), e.push(r)
                }
                return t
            }

            function en(e, t) {
                let r = "string" == typeof t ? e.states[t] : t ? e.states[t.target] : void 0;
                if (!r && t) throw Error(`Initial state node "${t}" not found on parent state node #${e.id}`);
                let n = {
                    source: e,
                    actions: t && "string" != typeof t ? m(t.actions) : [],
                    eventType: null,
                    reenter: !1,
                    target: r ? [r] : [],
                    toJSON: () => ({ ...n,
            ...
            function ei(e) {
                let t = x(e.config.target);
                return t ? {
                    target: t.map(t => "string" == typeof t ? ec(e.parent, t) : t)
                } : e.parent.initial
            }
            ...
            function ea(e) {
                ...
                return ! function e(r) {
                    if (!t.has(r)) {
                        if (t.add(r), "compound" === r.type) e(r.initial.target[0]);
                        else if ("parallel" === r.type)
                            for (let t of V(r)) e(t)
                    }
                }(e), t
            }
            ...
            function eu(e, t) {
                ...
                let r = e.states[t];
                if (!r) throw Error(`Child state '${t}' does not exist on '${e.id}'`);
                return r
            }

            function ec(e, t) {
                if ("string" == typeof t && K(t)) try {
            ...
            function el(e, t) {
                if ("string" == typeof t) {
                    let r = e.states[t];
                    if (!r) throw Error(`State '${t}' does not exist on '${e.id}'`);
                    return [e, r]
                }
                let r = Object.keys(t),
                    n = r.map(t => eu(e, t)).filter(Boolean);
                return [e.machine.root, e].concat(n, r.reduce((r, n) => {
                    let i = eu(e, n);
                    if (!i) return r;
                    let s = el(i, t[n]);
                    return r.concat(s)
            ...
            function ef(e, t) {
                let r = e;
                for (; r.parent && r.parent !== t;) r = r.parent;
                return r.parent === t
            }
                ...
                for (let i of e) {
                    ...
                    for (let o of n)
                        if (function(e, t) {
                            ...
                            if (ef(i.source, o.source)) s.add(o);
                            else {
                                e = !0;
                                break
                            }
                    if (!e) {
                        for (let e of s) n.delete(e);
                        n.add(i)
                    }
                }
                return Array.from(n)
            ...
            function ep(e, t) {
                ...
                for (let n of e.target)
                    if (es(n))
                        if (t[n.id])
                            for (let e of t[n.id]) r.add(e);
                        else
                            for (let e of ep(ei(n), t)) r.add(e);
                else r.add(n);
                return [...r]
            }
            ...
            function ed(e, t) {
                let r = ep(e, t);
                if (!r) return;
                if (!e.reenter && r.every(t => t === e.source || ef(t, e.source))) return e.source;
                let n = function(e) {
                    let [t, ...r] = e;
                    for (let e of X(t, void 0))
                        if (r.every(t => ef(t, e))) return e
                }(r.concat(e.source));
            ...
            function ey(e, t, r) {
                ...
                for (let i of e)
                    if (i.target ? .length) {
                        let e = ed(i, r);
                        for (let r of (i.reenter && i.source === e && n.add(e), t)) ef(r, e) && n.add(r)
                    }
                return [...n]
            }
            ...
            function ev(e, t, r, n, i, s) {
                ...
                let o = new Set(t._nodes),
                    ...
                    u = eh(e, o, a),
                    c = t;
                i || ([c, a] = function(e, t, r, n, i, s, o, a) {
                    let u, c = e,
                        l = ey(n, i, s);
                    for (let e of (l.sort((e, t) => t.order - e.order), l))
                        for (let t of function(e) {
                                return Object.keys(e.states).map(t => e.states[t]).filter(e => "history" === e.type)
                            }(e)) {
                            let r;
                            r = "deep" === t.history ? t => J(t) && ef(t, e) : t => t.parent === e, (u ? ? = { ...s
                            })[t.id] = Array.from(i).filter(r)
                        }
                    for (let e of l) c = eb(c, t, r, [...e.exit, ...e.invoke.map(e => z(e.id))], o, void 0), i.delete(e);
                    return [c, u || s]
                }(c, n, r, u, o, a, s, r.actionExecutor)), c = function(e, t, r, n, i, s, o, a) {
                    let u = e,
                        c = new Set,
                        f = new Set;
                    (function(e, t, r, n) {
                        for (let i of e) {
                            let e = ed(i, t);
                            for (let s of i.target || []) !es(s) && (i.source !== s || i.source !== e || i.reenter) && (n.add(s), r.add(s)), eg(s, t, r, n);
                            for (let s of ep(i, t)) {
                                let o = X(s, e);
                                e ? .type === "parallel" && o.push(e), em(n, t, r, o, !i.source.parent && i.reenter ? void 0 : e)
                            }
                        }
                    })(n, o, f, c), a && f.add(e.machine.root);
                    let h = new Set;
                    for (let e of [...c].sort((e, t) => e.order - t.order)) {
                        i.add(e);
                        let n = [];
                        for (let t of (n.push(...e.entry), e.invoke)) n.push(B(t.src, { ...t,
                        ...
                        if (u = eb(u, t, r, n, s, e.invoke.map(e => e.id)), "final" === e.type) {
                            let n = e.parent,
                                o = n ? .type === "parallel" ? n : n ? .parent,
                                a = o || e;
                            for (n ? .type === "compound" && s.push(l(n.id, void 0 !== e.output ? b(e.output, u.context, t, r.self) : void 0)); o ? .type === "parallel" && !h.has(o) && Q(i, o);) h.add(o), s.push(l(o.id)), a = o, o = o.parent;
                            if (o) continue;
                            u = ek(u, {
                                status: "done",
                                output: function(e, t, r, n, i) {
                                    if (void 0 === n.output) return;
                                    let s = l(i.id, void 0 !== i.output && i.parent ? b(i.output, e.context, t, r.self) : void 0);
                                    return b(n.output, e.context, s, r.self)
                                }(u, t, r, u.machine.root, a)
                            })
                        }
                    }
                    return u
                }(c = eb(c, n, r, u.flatMap(e => e.actions), s, void 0), n, r, u, o, s, a, i);
                let f = [...o];
                "done" === c.status && (c = eb(c, n, r, f.sort((e, t) => t.order - e.order).flatMap(e => e.exit), s, void 0));
                try {
                    if (a === t.historyValue && function(e, t) {
            ...
            function eg(e, t, r, n) {
                ...
                if (es(e))
                    if (t[e.id]) {
                        let o = t[e.id];
                        for (let e of o) n.add(e), eg(e, t, r, n);
                        for (let a of o) {
                            i = a, s = e.parent, em(n, t, r, X(i, s))
                        }
                    } else {
                        let i = ei(e);
                        for (let s of i.target) n.add(s), i === e.parent ? .initial && r.add(e.parent), eg(s, t, r, n);
                        for (let s of i.target) {
                            o = s, a = e.parent, em(n, t, r, X(o, a))
                        }
                    }
                else if ("compound" === e.type) {
                    let [i] = e.initial.target;
                    es(i) || (n.add(i), r.add(i)), eg(i, t, r, n), em(n, t, r, X(i, e))
                } else if ("parallel" === e.type)
                    for (let i of V(e).filter(e => !es(e)))[...n].some(e => ef(e, i)) || (es(i) || (n.add(i), r.add(i)), eg(i, t, r, n))
            }

            function em(e, t, r, n, i) {
                for (let s of n)
                    if ((!i || ef(s, i)) && e.add(s), "parallel" === s.type)
                        for (let n of V(s).filter(e => !es(e)))[...e].some(e => ef(e, n)) || (e.add(n), eg(n, t, r, e))
            }
                    ...
                    a = function e(t, r, n, i, s, o) {
                        ...
                        for (let t of i) {
                            ...
                            let i = "function" == typeof t,
                                l = i ? t : (c = "string" == typeof t ? t : t.type, a.implementations.actions[c]),
                                f = {
                                    context: u.context,
                                    event: r,
                                    self: n.self,
                                ...
                                h = i || "string" == typeof t ? void 0 : "params" in t ? "function" == typeof t.params ? t.params({
                                    context: u.context,
                                    event: r
                                }) : t.params : void 0;
                            if (!l || !("resolve" in l)) {
                            ...
                            let [p, d, y] = l.resolve(n, u, f, h, l, s);
                            u = p, "retryResolve" in l && o ? .push([l, d]), "execute" in l && n.actionExecutor({
                                type: l.type,
                                info: f,
                                params: d,
                                exec: l.execute.bind(null, n, d)
                            }), y && (u = e(u, r, n, y, s, o))
                        }
                        return u
                    }(e, t, r, n, {
            ...
            function ew(e, t, r, n) {
                ...
                if (t.type === c) return o(i = ek(e_(i, t, r), {
                    status: "stopped"
                }), t, []), {
                    snapshot: i,
                    microstates: s
                ...
                if (u.type !== a) {
                    ...
                    o(i = ev(c, e, r, u, !1, n), t, c)
                }
                let l = !0;
                for (;
                    "active" === i.status;) {
                    let e = l ? function(e, t) {
                            let r = new Set;
                            for (let n of e._nodes.filter(J)) e: for (let i of [n].concat(X(n, void 0)))
                                if (i.always) {
                                    for (let n of i.always)
                                        if (void 0 === n.guard || H(n.guard, e.context, t, e)) {
                                            r.add(n);
                                            break e
                                        }
                                }
                            return eh(Array.from(r), new Set(e._nodes), e.historyValue)
                        }(i, u) : [],
                        t = e.length ? i : void 0;
                    if (!e.length) {
                        if (!n.length) break;
                    ...
                    l = (i = ev(e, i, r, u, !1, n)) !== t, o(i, u, e)
                }
                return "active" !== i.status && e_(i, u, r), {
                    snapshot: i,
                    microstates: s
                }
            }
            ...
            function e_(e, t, r) {
                return eb(e, t, r, Object.values(e.children).map(e => z(e)), [], void 0)
            }
            ...
            let eS = function(e) {
                    return function e(t, r) {
                        let n = v(t),
                            i = v(r);
                        return "string" == typeof i ? "string" == typeof n && i === n : "string" == typeof n ? n in i : Object.keys(n).every(t => t in i && e(n[t], i[t]))
                    }(e, this.value)
                },
                eC = function(e) {
            ...
            function eR(e, t) {
                ...
                for (let e in s) {
                    let r = s[e];
                    p[e] = {
                        snapshot: r.getPersistedSnapshot(t),
                        src: r.src,
                        systemId: r.systemId,
                    ...
                    context: function e(t) {
                        ...
                        for (let n in t) {
                            ...
                            if (i && "object" == typeof i)
                                if ("sessionId" in i && "send" in i && "ref" in i)(r ? ? = Array.isArray(t) ? t.slice() : { ...t
                                })[n] = {
                                    xstate$$type: k,
                                    id: i.id
                                };
                                    ...
                                    let s = e(i);
                                    s !== i && ((r ? ? = Array.isArray(t) ? t.slice() : { ...t
                                    })[n] = s)
                                }
                        }
                        return r ? ? t
            ...
            function ej(e, t, r, n, {
                ...
                let u, c = t.machine.implementations.delays;
                if ("string" == typeof i) throw Error(`Only event objects may be used with raise; use raise({ type: "${i}" }) instead`);
                let l = "function" == typeof i ? i(r, n) : i;
                if ("string" == typeof o) {
                    let e = c && c[o];
                    u = "function" == typeof e ? e(r, n) : e
                } else u = "function" == typeof o ? o(r, n) : o;
                return "number" != typeof u && a.push(l), [t, {
                    event: l,
                    id: s,
                    delay: u
                }, void 0]
            ...
            function eq(e, t) {
                ...
                if ("number" == typeof n) return void e.defer(() => {
                    let t = e.self;
                    e.system.scheduler.schedule(t, t, r, n, i)
                })
            }

            function e$(e, t) {
                function r(e, t) {}
                return r.type = "xstate.raise", r.event = e, r.id = t ? .id, r.delay = t ? .delay, r.resolve = ej, r.execute = eq, r
            }
        },
        73560: (e, t, r) => {
            "use strict";
            ...
            var f = r(54342),
                ...
                p = function(e) {
                    ...
                    return (0, n.C6)(t, e), t.create = function(e, t, r) {
                        ...
                        this.isStopped ? b(l("E", void 0, e), this) : (this.isStopped = !0, this._error(e))
                    }, t.prototype.complete = function() {
                        this.isStopped ? b(c, this) : (this.isStopped = !0, this._complete())
                    }, t.prototype.unsubscribe = function() {
            ...
            var v = function() {
                ...
                g = function(e) {
                    function t(t, r, n) {
                        ...
                        }) : s = t, u.destination = new v(s), u
                    }
                    return (0, n.C6)(t, e), t
                }(p);

            function m(e) {
                o.$.useDeprecatedSynchronousErrorHandling ? (0, h.l)(e) : (0, a.m)(e)
            }

            function b(e, t) {
                var r = o.$.onStoppedNotification;
                r && f.f.setTimeout(function() {
                    return r(e, t)
                })
            }
            var w = {
        ...
        80087: (e, t) => {
            ...
            function a() {
                return o ? new o : new s
            }

            function u(e) {
                return o ? o.bind(e) : s.bind(e)
            }
        ...
        80213: (e, t, r) => {
            ...
            function b(e, t) {
                return t ? function(e, t) {
                    if (null != e) {
                        if ((0, h.l)(e)) return (0, n.Tg)(e).pipe(o(t), (0, i.Q)(t));
                        if ((0, d.X)(e)) return new a.c(function(r) {
                            var n = 0;
        ...
        82276: (e, t, r) => {
            ...
            var n = r(91702),
                ...
                l = r(51144),
                f = r(7542);
            let h = (0, a.default)(() => r.e(85963).then(r.bind(r, 85963)), {
                    loadableGenerated: {
                        webpack: () => [require.resolveWeak("../_chunks-es/PresentationComlink.js")]
                    },
                    ssr: !1
                }),
                p = (0, a.default)(() => r.e(2136).then(r.bind(r, 2136)), {
                    loadableGenerated: {
                        webpack: () => [require.resolveWeak("../_chunks-es/RefreshOnMount.js")]
                    },
                    ssr: !1
                }),
                d = (0, a.default)(() => r.e(59157).then(r.bind(r, 59157)), {
                    loadableGenerated: {
                        webpack: () => [require.resolveWeak("../_chunks-es/RefreshOnFocus.js")]
                    },
                    ssr: !1
                }),
                y = (0, a.default)(() => r.e(7796).then(r.bind(r, 7796)), {
                    loadableGenerated: {
                        webpack: () => [require.resolveWeak("../_chunks-es/RefreshOnReconnect.js")]
                    },
                    ssr: !1
                }),
                v = e => {
                    e instanceof i.u_ ? console.warn(`Sanity Live is unable to connect to the Sanity API as the current origin - ${window.origin} - is not in the list of allowed CORS origins for this Sanity Project.`, e.addOriginUrl && "Add it here:", e.addOriginUrl ? .toString()) : console.error(e)
                };
            ...
            function g(e) {
                let {
                    ...
                    apiHost: a,
                    apiVersion: g,
                    useProjectHostname: m,
                    token: b,
                    requestTagPrefix: w,
                    draftModeEnabled: _,
                    draftModePerspective: x,
                    refreshOnMount: E = !1,
                    refreshOnFocus: S = !_ && (typeof window > "u" || window.self === window.top),
                    refreshOnReconnect: C = !0,
                    tag: T,
                    onError: I = v
                } = e, O = (0, c.useMemo)(() => (0, i.UU)({
                    projectId: t,
                    dataset: r,
                    apiHost: a,
                    apiVersion: g,
                    ...
                    useCdn: !1,
                    requestTagPrefix: w
                }), [a, g, r, t, w, b, m]), A = (0, u.useRouter)(), k = (0, l.J)(e => {
                    "message" === e.type ? (0, s.Q)(e.tags) : "restart" === e.type && A.refresh()
                });
                (0, c.useEffect)(() => {
                    let e = O.live.events({
                        includeDrafts: !!b,
                        ...
                        next: e => {
                            ("message" === e.type || "restart" === e.type || "welcome" === e.type) && k(e)
                        },
                        error: e => {
                            I(e)
                        }
                ...
                }, [O.live, k, I, T, b]), (0, c.useEffect)(() => {
                    _ && x ? (0, f.NL)(x) : (0, f.NL)("unknown")
                }, [_, x]);
                let [R, j] = (0, c.useState)(!1);
                (0, c.useEffect)(() => {
                    if (!(0, o.vY)()) {
                        if (_ && b) return void(0, f.kN)("live");
                        if (_) return void(0, f.kN)("static");
                        (0, f.kN)("unknown")
                    }
                }, [_, b]), (0, c.useEffect)(() => {
                    if (!(0, o.vY)()) return;
                    let e = new AbortController,
                        t = setTimeout(() => (0, f.kN)("live"), 3e3);
                    return window.addEventListener("message", ({
                        data: r
                    }) => {
                        r && "object" == typeof r && "domain" in r && "sanity/channels" === r.domain && "from" in r && "presentation" === r.from && (clearTimeout(t), (0, f.kN)((0, o.v$)() ? "presentation-window" : "presentation-iframe"), j(!0), e.abort())
                    }, {
                        signal: e.signal
                    }), () => {
                ...
                let q = (0, c.useRef)(void 0);
                return (0, c.useEffect)(() => {
                    if (_) return clearTimeout(q.current), () => {
                        q.current = setTimeout(() => {
                            console.warn("Sanity Live: Draft mode was enabled, but is now being disabled")
                        })
                    }
                }, [_]), (0, n.jsxs)(n.Fragment, {
                    children: [_ && R && (0, n.jsx)(h, {
                        draftModeEnabled: _,
                        draftModePerspective: x
                    }), !_ && E && (0, n.jsx)(p, {}), !_ && S && (0, n.jsx)(d, {}), !_ && C && (0, n.jsx)(y, {})]
                })
            }
            g.displayName = "SanityLive"
        },
        83142: (e, t, r) => {
            "use strict";
            r.d(t, {
        ...
        84887: (e, t, r) => {
            ...
            }).prototype = Object.create(Error.prototype), i.prototype.constructor = i, i);
            ...
            var v = function() {
                ...
                return t.prototype.unsubscribe = function() {
                    if (!this.closed) {
                        this.closed = !0;
                        var e, t, r, n, i, s = this._parentage;
                        if (s)
                            if (this._parentage = null, Array.isArray(s)) try {
                                for (var o = (0, h.Ju)(s), a = o.next(); !a.done; a = o.next()) a.value.remove(this)
                            } catch (t) {
                                e = {
                                    error: t
                                }
                        ...
                        if (p(u)) try {
                            ...
                            i = e instanceof d ? e.errors : [e]
                        }
                        var c = this._finalizers;
                        if (c) {
                            this._finalizers = null;
                            try {
                                for (var l = (0, h.Ju)(c), f = l.next(); !f.done; f = l.next()) {
                                    var y = f.value;
                                    try {
                                        m(y)
                                    } catch (e) {
                                        i = null != i ? i : [], e instanceof d ? i = (0, h.fX)((0, h.fX)([], (0, h.zs)(i)), (0, h.zs)(e.errors)) : i.push(e)
                                    }
                                }
                            } catch (e) {
                                r = {
                    ...
                    var t = this._parentage;
                    t === e ? this._parentage = null : Array.isArray(t) && y(t, e)
                }, t.prototype.remove = function(e) {
                    var r = this._finalizers;
                    r && y(r, e), e instanceof t && e._removeParent(this)
                }, (e = new t).closed = !0, t.EMPTY = e, t
            }();

            function g(e) {
                return e instanceof v || e && "closed" in e && p(e.remove) && p(e.add) && p(e.unsubscribe)
            }
            ...
            var b = void 0,
                w = {
                    setTimeout: function(e, t) {
                        ...
                        var i = w.delegate;
                        return (null == i ? void 0 : i.setTimeout) ? i.setTimeout.apply(i, (0, h.fX)([e, t], (0, h.zs)(r))) : setTimeout.apply(void 0, (0, h.fX)([e, t], (0, h.zs)(r)))
                    },
                    clearTimeout: function(e) {
                        var t = w.delegate;
                        return ((null == t ? void 0 : t.clearTimeout) || clearTimeout)(e)
            ...
            var C = null,
                T = function(e) {
                    function t(t) {
                        var r = e.call(this) || this;
                        return r.isStopped = !1, t ? (r.destination = t, g(t) && t.add(r)) : r.destination = q, r
                    }
                    return (0, h.C6)(t, e), t.create = function(e, t, r) {
                        return new k(e, t, r)
                    }, t.prototype.next = function(e) {
                        this.isStopped ? j(S("N", e, void 0), this) : this._next(e)
                    }, t.prototype.error = function(e) {
                        this.isStopped ? j(S("E", void 0, e), this) : (this.isStopped = !0, this._error(e))
                    }, t.prototype.complete = function() {
            ...
            var A = function() {
                ...
                k = function(e) {
                    function t(t, r, n) {
                        var i, s, o = e.call(this) || this;
                        return p(t) || !t ? i = {
                            next: null != t ? t : void 0,
                            error: null != r ? r : void 0,
                            complete: null != n ? n : void 0
                        } : i = t, o.destination = new A(i), o
                    }
                    return (0, h.C6)(t, e), t
                }(T);
            ...
            function M(e) {
                return 0 === e.length ? P : 1 === e.length ? e[0] : function(t) {
                    return e.reduce(function(e, t) {
                        return t(e)
                    }, t)
                }
            ...
            var N = function() {
                ...
                return e.prototype.lift = function(t) {
                    ...
                    var n = this,
                        i = ! function(e) {
                            return e && e instanceof T || e && p(e.next) && p(e.error) && p(e.complete) && g(e)
                        }(e) ? new k(e, t, r) : e;
                    return ! function(e) {
                        var t, r, n, i;
                        1;
                        ...
                        var e = n.operator,
                            t = n.source;
                        i.add(e ? e.call(i, t) : t ? n._subscribe(i) : n._trySubscribe(i))
                    }), i
                }, e.prototype._trySubscribe = function(e) {
                    try {
                        return this._subscribe(e)
            ...
            function L(e) {
                var t;
                return null != (t = null != e ? e : b) ? t : Promise
            }
            var B = function(e) {
                    return e && "number" == typeof e.length && "function" != typeof e
                },
            ...
            function F(e) {
                ...
                if (null != e) {
                    ...
                    if (B(e)) {
                        return r = e, new N(function(e) {
                            for (var t = 0; t < r.length && !e.closed; t++) e.next(r[t]);
                            e.complete()
                        })
                    }
                    if (p(null == e ? void 0 : e.then)) {
                        return n = e, new N(function(e) {
                            n.then(function(t) {
                                e.closed || (e.next(t), e.complete())
                            }, function(t) {
                                return e.error(t)
                    ...
                    if (Symbol.asyncIterator && p(null == e ? void 0 : e[Symbol.asyncIterator])) return z(e);
                    if (p(null == e ? void 0 : e[D])) {
                        return i = e, new N(function(e) {
                            var t, r;
                            try {
                                for (var n = (0, h.Ju)(i), s = n.next(); !s.done; s = n.next()) {
                                    var o = s.value;
                                    if (e.next(o), e.closed) return
                                }
                            } catch (e) {
                    ...
                    if (p(null == e ? void 0 : e.getReader)) return z(function(e) {
                        return (0, h.AQ)(this, arguments, function() {
                            var t, r, n;
                            return (0, h.YH)(this, function(i) {
                                switch (i.label) {
                                    case 0:
                                    ...
                                    case 2:
                                        return [4, (0, h.N3)(t.read())];
                                    case 3:
                                        if (n = (r = i.sent()).value, !r.done) return [3, 5];
                                        return [4, (0, h.N3)(void 0)];
                                    case 4:
                                        return [2, i.sent()];
                                    case 5:
                                        return [4, (0, h.N3)(n)];
                ...
                throw TypeError("You provided " + (null !== e && "object" == typeof e ? "an invalid object" : "'" + e + "'") + " where a stream was expected. You can provide an Observable, Promise, ReadableStream, Array, AsyncIterable, or Iterable.")
            }
                ...
                return new N(function(t) {
                    (function(e, t) {
                        ...
                        return (0, h.sH)(this, void 0, void 0, function() {
                            var o;
                            return (0, h.YH)(this, function(a) {
                                switch (a.label) {
                                    case 0:
                                        a.trys.push([0, 5, 6, 11]), r = (0, h.xN)(e), a.label = 1;
                                    case 1:
                                        return [4, r.next()];
                                    case 2:
                                    ...
                                    case 6:
                                        if (a.trys.push([6, , 9, 10]), !(n && !n.done && (s = r.return))) return [3, 8];
                                        return [4, s.call(r)];
                                    case 7:
                                        a.sent(), a.label = 8;
                                    case 8:
            ...
            function H(e) {
                return function(t) {
                    if (p(null == t ? void 0 : t.lift)) return t.lift(function(t) {
                        try {
                            return e(t, this)
                        } catch (e) {
                            this.error(e)
            ...
            var V = function(e) {
                ...
                return (0, h.C6)(t, e), t.prototype.unsubscribe = function() {
                    var t;
                    if (!this.shouldUnsubscribe || this.shouldUnsubscribe()) {
                        var r = this.closed;
                        e.prototype.unsubscribe.call(this), r || null == (t = this.onFinalize) || t.call(this)
            ...
            function W(e, t, r) {
                return (void 0 === r && (r = 1 / 0), p(t)) ? W(function(r, n) {
                    return X(function(e, i) {
                        return t(r, e, n, i)
                    })(F(e(r, n)))
                }, r) : ("number" == typeof t && (r = t), H(function(t, n) {
                    var i, s, o, a, u, c, l, f;
                    return i = r, s = [], o = 0, a = 0, u = !1, c = function() {
                            !u || s.length || o || n.complete()
                        }, l = function(e) {
                            return o < i ? f(e) : s.push(e)
                        }, f = function(t) {
                            o++;
                            var r = !1;
                            F(e(t, a++)).subscribe(J(n, function(e) {
                                n.next(e)
                            }, function() {
                                r = !0
                            }, void 0, function() {
                                if (r) try {
                                    for (o--; s.length && o < i;) ! function() {
                                        var e = s.shift();
                                        f(e)
                                    }();
                                    c()
            ...
            var Y = Array.isArray,
                G = ["addListener", "removeListener"],
                Q = ["addEventListener", "removeEventListener"],
                K = ["on", "off"];

            function Z(e, t, r, n) {
                if (p(r) && (n = r, r = void 0), n) {
                    return Z(e, t, r).pipe((i = n, X(function(e) {
                        return Y(e) ? i.apply(void 0, (0, h.fX)([], (0, h.zs)(e))) : i(e)
                    })))
                }
                var i, s, o, a, u = (0, h.zs)(p((s = e).addEventListener) && p(s.removeEventListener) ? Q.map(function(n) {
                        return function(i) {
                            return e[n](t, i, r)
                        }
                    }) : p((o = e).addListener) && p(o.removeListener) ? G.map(ee(e, t)) : p((a = e).on) && p(a.off) ? K.map(ee(e, t)) : [], 2),
                    c = u[0],
                    l = u[1];
                if (!c && B(e)) return W(function(e) {
                    return Z(e, t, r)
                })(F(e));
            ...
            let ei = e => ({
                ...
                es = (s = () => Z(window, "message"), new N(function(e) {
                    F(s()).subscribe(e)
                })),
                eo = e => (0, a.OX)(({
                    input: t
                    ...
                    var r, n, i;
                    let s;
                    return es.pipe(e ? X(e) : U(), et(e => {
                        let {
                            data: r
                        } = e;
                        return (!t.include.length || t.include.includes(r.type)) && (!t.exclude.length || !t.exclude.includes(r.type)) && r.domain === t.domain && r.from === t.from && r.to === t.to && (!t.target || e.source === t.target)
                    }), X((s = t.responseType, e => ({
                        type: s,
                        message: e
                    }))), t.count ? U((r = t.count, void 0 === n && (n = null), n = null != n ? n : r, H(function(e, t) {
                        var i = [],
                            s = 0;
                        e.subscribe(J(t, function(e) {
                            ...
                            s++ % n == 0 && i.push([]);
                            try {
                                for (var f = (0, h.Ju)(i), p = f.next(); !p.done; p = f.next()) {
                                    var d = p.value;
                                    d.push(e), r <= d.length && (l = null != l ? l : []).push(d)
                                }
                            } catch (e) {
                                o = {
                                    error: e
                            ...
                            if (l) try {
                                for (var v = (0, h.Ju)(l), g = v.next(); !g.done; g = v.next()) {
                                    var d = g.value;
                                    y(i, d), t.next(d)
                                }
                            } catch (e) {
                    ...
                    })), (i = e => e, p(void 0) ? W(i, void 0, 1) : W(i, 1)), en(t.count)) : U())
                }),
                ea = "sanity/comlink",
                eu = "comlink/response",
                ec = "comlink/heartbeat",
                el = "comlink/disconnect",
                ef = "comlink/handshake/syn",
                eh = "comlink/handshake/syn-ack",
                ep = "comlink/handshake/ack",
                ed = () => (0, u.mj)({
                    types: {},
                    actors: {
                        listen: (0, a.OX)(({
                            ...
                            let t, r = e.signal ? Z(e.signal, "abort").pipe((t = `Request ${e.requestId} aborted`, e => e.pipe(en(1), X(() => {
                                throw Error(t)
                            })))) : er;
                            return Z(window, "message").pipe(et(t => t.data ? .type === eu && t.data ? .responseTo === e.requestId && !!t.source && e.sources.has(t.source)), en(e.sources.size), H(function(e, t) {
                                F(r).subscribe(J(t, function() {
                                    return t.complete()
                    ...
                    actions: {
                        ...
                        "on fail": (0, c.s)(({
                            ...
                            context: e,
                            self: t
                        }) => (e.suppressWarnings || console.warn(`[@sanity/comlink] Received no response to message '${e.type}' on client '${e.from}' (ID: '${e.id}').`), e.resolvable ? .reject(Error("No response received")), {
                            type: "request.failed",
                            requestId: t.id
                        })),
                        "on abort": (0, c.s)(({
            ...
            let ey = () => (0, u.mj)({
                    ...
                    actions: {
                        "buffer handshake": (0, l.a)({
                            handshakeBuffer: ({
                                event: e,
                                context: t
                            }) => ((0, u.DT)(e, "message.received"), [...t.handshakeBuffer, e])
                        }),
                        ...
                        "create request": (0, l.a)({
                            requests: ({
                                ...
                                (0, u.DT)(t, "request");
                                let i = (Array.isArray(t.data) ? t.data : [t.data]).map(t => n("requestMachine", {
                                    id: `req-${(0,o.A)()}`,
                                    input: {
                                        channelId: e.channelId,
                                        data: t.data,
                        ...
                        "emit heartbeat": (0, c.a)(() => ({
                            type: "heartbeat"
                        })),
                        "emit received message": (0, c.e)(({
                            enqueue: e
                        }) => {
                            e.emit(({
                                event: e
                            }) => ((0, u.DT)(e, "message.received"), {
                                type: "message",
                                message: e.message.data
                            }))
                        }),
                        "emit status": (0, c.a)((e, t) => ({
                            type: "status",
                            status: t.status
                        })),
                        "post message": (0, f.r)(({
                        ...
                        "process pending handshakes": (0, c.e)(({
                            context: e,
                            enqueue: t
                        }) => {
                            e.handshakeBuffer.forEach(e => t.raise(e)), t.assign({
                                handshakeBuffer: []
                            })
                        }),
                        "remove request": (0, c.e)(({
                            context: e,
                            enqueue: t,
                            event: r
                        }) => {
                            (0, u.DT)(r, ["request.success", "request.failed", "request.aborted"]), (0, f.s)(r.requestId), t.assign({
                        ...
                        "send response": (0, f.r)(({
                            event: e
                        }) => ((0, u.DT)(e, ["message.received", "heartbeat.received"]), {
                            type: "request",
                            data: {
                                type: eu,
                        ...
                        "send handshake syn ack": (0, f.r)({
                            type: "request",
                            data: {
                                type: eh
                            }
                        }),
                        "send pending messages": (0, c.e)(({
                            enqueue: e
                        }) => {
                            e.raise(({
                                context: e
                        ...
                        "set connection config": (0, l.a)({
                            channelId: ({
                                event: e
                            }) => ((0, u.DT)(e, "handshake.syn"), e.message.data.channelId),
                            target: ({
                                event: e
                            }) => ((0, u.DT)(e, "handshake.syn"), e.message.source || void 0),
                            targetOrigin: ({
                                event: e
                            }) => ((0, u.DT)(e, "handshake.syn"), e.message.origin)
                        })
                    },
                    guards: {
                        hasSource: ({
                    ...
                    states: {
                        ...
                        connected: {
                            entry: ["process pending handshakes", "send pending messages", {
                                type: "emit status",
                                params: {
                                    status: "connected"
                                }
                ...
                ev = (e, t = ey()) => {
                    ...
                    n.on("message", ({
                        ...
                        let r = s.get(e.type);
                        r ? r.add(e) : s.set(e.type, new Set([e]))
                    });
                    let o = () => {
                        n.stop()
                    };
                    return {
                        ...
                        fetch: (e, t, r) => {
                            let i, s, {
                                ...
                                c = "function" == typeof Promise.withResolvers ? Promise.withResolvers() : {
                        ...
                        on: (e, t, r) => {
                            ...
                            i.has(e) || i.set(e, n), n.add(t);
                            let o = s.get(e);
                            if (o) {
                                let n = r ? .replay ? ? 1;
                                Array.from(o).slice(-n).forEach(({
                                    data: e
                                }) => t(e)), s.delete(e)
                            }
                            return () => {
        ...
        93950: (e, t, r) => {
            ...
            }), r(91702), r(59875), r(77733), r(2108), r(50320)
        },
        97704: (e, t) => {
            t.read = function(e, t, r, n, i) {
                var s, o, a = 8 * i - n - 1,
                    ...
                    h = r ? -1 : 1,
                    p = e[t + f];
                for (f += h, s = p & (1 << -l) - 1, p >>= -l, l += a; l > 0; s = 256 * s + e[t + f], f += h, l -= 8);
                ...
                var o, a, u, c = 8 * s - i - 1,
                    ...
                    d = n ? 1 : -1,
                    y = +(t < 0 || 0 === t && 1 / t < 0);
                for (isNaN(t = Math.abs(t)) || t === 1 / 0 ? (a = +!!isNaN(t), o = l) : (o = Math.floor(Math.log(t) / Math.LN2), t * (u = Math.pow(2, -o)) < 1 && (o--, u *= 2), o + f >= 1 ? t += h / u : t += h * Math.pow(2, 1 - f), t * u >= 2 && (o++, u /= 2), o + f >= l ? (a = 0, o = l) : o + f >= 1 ? (a = (t * u - 1) * Math.pow(2, i), o += f) : (a = t * Math.pow(2, f - 1) * Math.pow(2, i), o = 0)); i >= 8; e[r + p] = 255 & a, p += d, a /= 256, i -= 8);
