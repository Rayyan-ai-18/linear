! function() {
    try {
        var e = "u" > typeof window ? window : "u" > typeof global ? global : "u" > typeof globalThis ? globalThis : "u" > typeof self ? self : {},
            t = (new e.Error).stack;
        t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "ca99420f-87d8-4b10-916e-04b2bc1b34be", e._sentryDebugIdIdentifier = "sentry-dbid-ca99420f-87d8-4b10-916e-04b2bc1b34be")
    } catch (e) {}
    ...
    [52013], {
        524: (e, t, r) => {
            ...
            var n, i = r(37829),
                ...
                D = {
                    ...
                    "%isFinite%": isFinite,
                    "%isNaN%": isNaN,
                    "%IteratorPrototype%": w && x ? x(x([][Symbol.iterator]())) : n,
                    "%JSON%": "object" == typeof JSON ? JSON : n,
                    "%Map%": "u" < typeof Map ? n : Map,
                    "%MapIteratorPrototype%": "u" > typeof Map && w && x ? x(new Map()[Symbol.iterator]()) : n,
                    "%Math%": Math,
                    "%Number%": Number,
                    "%Object%": i,
                    ...
                    "%SetIteratorPrototype%": "u" > typeof Set && w && x ? x(new Set()[Symbol.iterator]()) : n,
                    "%SharedArrayBuffer%": "u" < typeof SharedArrayBuffer ? n : SharedArrayBuffer,
                    "%String%": String,
                    "%StringIteratorPrototype%": w && x ? x("" [Symbol.iterator]()) : n,
                    "%Symbol%": w ? Symbol : n,
                    "%SyntaxError%": u,
                    "%ThrowTypeError%": P,
                    "%TypedArray%": T,
            ...
            var N = function e(t) {
                ...
                H = r(91612),
                q = r(58334),
                U = H.call(A, Array.prototype.concat),
                Q = H.call(F, Array.prototype.splice),
                W = H.call(A, String.prototype.replace),
                L = H.call(A, String.prototype.slice),
                M = H.call(A, RegExp.prototype.exec),
                $ = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g,
                B = /\\(\\)?/g,
                V = function(e) {
                    var t = L(e, 0, 1),
                    ...
                    var n = [];
                    return W(e, $, function(e, t, r, i) {
                        n[n.length] = r ? W(i, B, "$1") : t || e
                    }), n
                },
                G = function(e, t) {
                    var r, n = e;
                    if (q(C, n) && (n = "%" + (r = C[n])[0] + "%"), q(D, n)) {
                        var i = D[n];
                        if (i === I && (i = N(n)), void 0 === i && !t) throw new l("intrinsic " + e + " exists, but is not available. Please file an issue!");
                        return {
                            alias: r,
                            name: n,
                            value: i
            ...
            e.exports = function(e, t) {
                ...
                for (var f = 1, h = !0; f < r.length; f += 1) {
                    var p = r[f],
                        d = L(p, 0, 1),
                        m = L(p, -1);
                    if (('"' === d || "'" === d || "`" === d || '"' === m || "'" === m || "`" === m) && d !== m) throw new u("property names with quotes must have matching quotes");
                    if ("constructor" !== p && h || (s = !0), n += "." + p, q(D, a = "%" + n + "%")) o = D[a];
                    else if (null != o) {
                        if (!(p in o)) {
                        ...
                        if (O && f + 1 >= r.length) {
                            var y = O(o, p);
                            o = (h = !!y) && "get" in y && !("originalValue" in y.get) ? y.get : o[p]
                        } else h = q(o, p), o = o[p];
                        h && !s && (D[a] = o)
                    }
                }
            ...
            e.exports = function() {
                ...
                function v(e, r, n, a) {
                    var o, s, c, u = [],
                        ...
                        f = (o = t(t({}, e.headers), a.headers), s = {}, Object.keys(o).forEach(function(e) {
                            var t = o[e];
                            s[e.toLowerCase()] = t
                        }), s),
                        h = n.method,
                        p = "GET" !== n.method ? {} : t(t({}, n.data), a.data),
                        y = t(t(t({
                            "x-algolia-agent": e.userAgent.value
                        }, e.queryParameters), p), a.queryParameters),
                        g = 0,
                        v = function t(r, i) {
                            var o, s, c, p, m = r.pop();
                            if (void 0 === m) throw {
                            ...
                            var v = {
                                    ...
                                    headers: f,
                                    method: h,
                                    url: (o = m, s = n.path, c = S(y), p = "".concat(o.protocol, "://").concat(o.url, "/").concat("/" === s.charAt(0) ? s.substr(1) : s), c.length && (p += "?".concat(c)), p),
                                    connectTimeout: i(g, e.timeouts.connect),
                                    responseTimeout: i(g, a.timeout)
                                },
                                b = function(e) {
                                    var t = {
                                        request: v,
                                ...
                                R = {
                                    ...
                                    onRetry: function(n) {
                                        var a = b(n);
                                        return n.isTimedOut && g++, Promise.all([e.logger.info("Retryable failure", j(a)), e.hostsCache.set(m, d(m, n.isTimedOut ? 3 : 2))]).then(function() {
                                            return t(r, i)
                                        })
                                    },
                                    onFail: function(e) {
                            ...
                            return e.requester.send(v).then(function(e) {
                                var t, r, n;
                                return (t = e.status, e.isTimedOut || (r = e.isTimedOut, n = e.status, !r && 0 == ~~n) || 2 != ~~(t / 100) && 4 != ~~(t / 100)) ? R.onRetry(e) : 2 == ~~(e.status / 100) ? R.onSuccess(e) : R.onFail(e)
                            })
                        };
                        ...
                        f = {
                            ...
                            read: function(e, t) {
                                var r = h(t, f.timeouts.read),
                                    i = function() {
                                        return v(f, f.hosts.filter(function(e) {
                                ...
                                return f.responsesCache.get(a, function() {
                                    return f.requestsCache.get(a, function() {
                                        return f.requestsCache.set(a, i()).then(function(e) {
                ...
                function S(e) {
                    return Object.keys(e).map(function(t) {
                        var r;
                        return l("%s=%s", t, (r = e[t], "[object Object]" === Object.prototype.toString.call(r) || "[object Array]" === Object.prototype.toString.call(r) ? JSON.stringify(e[t]) : e[t]))
                    }).join("&")
                }
                ...
                var I = function(e) {
                    ...
                    k = function(e) {
                        return function(t, r) {
                            return c(e.transporter.write({
                                method: g,
                                path: l("/1/dictionaries/%s/batch", t),
                                data: {
                    ...
                    N = function(e) {
                        return function(t, r, n) {
                            return c(e.transporter.write({
                                method: g,
                                path: l("1/indexes/%s/operation", t),
                                data: {
                                    operation: "copy",
                                    destination: r
                                }
                    ...
                    Q = function(e) {
                        return function(t, r) {
                            return c(e.transporter.write({
                                ...
                                return s(function(r) {
                                    return L(e)(t, n).then(r).catch(function(e) {
                                        if (404 !== e.status) throw e
                                    })
                                })
                            })
                    ...
                    ei = function(e) {
                        return function(n, i) {
                            return Promise.all(n.map(function(n) {
                                ...
                                return K(e)(n.indexName, {
                                    methods: {
                                        searchForFacetValues: eK
                                    }
                    ...
                    eu = function(e) {
                        return function(t, r, n) {
                            return e.transporter.read({
                                method: g,
                                path: l("/1/dictionaries/%s/search", t),
                                data: {
                                    query: r
                                },
                                cacheable: !0
                    ...
                    eh = function(e) {
                        return function(t, n) {
                            var i = Object.assign({}, n),
                                ...
                                o = a.queryParameters,
                                u = r(a, ["queryParameters"]),
                                f = ["acl", "indexes", "referers", "restrictSources", "queryParameters", "description", "maxQueriesPerIPPerHour", "maxHitsPerQuery"];
                            return c(e.transporter.write({
                                method: "PUT",
                                path: l("1/keys/%s", t),
                                data: o ? {
                    ...
                    ep = function(e) {
                        return function(t, r) {
                            return s(function(n) {
                                return M(e)(t, r).then(function(e) {
                    ...
                    ed = function(e) {
                        return function(t, r) {
                            return c(e.transporter.write({
                                method: g,
                                path: l("1/indexes/%s/batch", e.indexName),
                                data: {
                                    requests: t
                                }
                            }, r), function(t, r) {
                        ...
                        return function(r) {
                            return A(t(t({
                                ...
                                request: function(t) {
                                    return e.transporter.read({
                                        method: g,
                                        path: l("1/indexes/%s/browse", e.indexName),
                                        data: t
                                    }, r)
                                }
                            }))
                    ...
                    ey = function(e) {
                        return function(r) {
                            ...
                            return A(t(t({
                                ...
                                request: function(r) {
                                    return ez(e)("", t(t({}, n), r)).then(function(e) {
                                        return t(t({}, e), {}, {
                    ...
                    ev = function(e) {
                        return function(t, n, i) {
                            ...
                            return c(function r() {
                                ...
                                return 0 === c.length ? Promise.resolve(u) : ed(e)(c.map(function(e) {
                                    return {
                                        action: n,
                                        body: e
                                    }
                    ...
                    eb = function(e) {
                        return function(t) {
                            return c(e.transporter.write({
                                method: g,
                                path: l("1/indexes/%s/clear", e.indexName)
                            }, t), function(t, r) {
                                return eY(e)(t.taskID, r)
                            })
                        }
                    ...
                    eS = function(e) {
                        return function(t) {
                            ...
                            return i && (a.queryParameters.forwardToReplicas = 1), c(e.transporter.write({
                                method: g,
                                path: l("1/indexes/%s/rules/clear", e.indexName)
                            }, a), function(t, r) {
                                return eY(e)(t.taskID, r)
                            })
                        }
                    ...
                    eO = function(e) {
                        return function(t) {
                            ...
                            return i && (a.queryParameters.forwardToReplicas = 1), c(e.transporter.write({
                                method: g,
                                path: l("1/indexes/%s/synonyms/clear", e.indexName)
                            }, a), function(t, r) {
                                return eY(e)(t.taskID, r)
                            })
                        }
                    ...
                    ej = function(e) {
                        return function(t, r) {
                            return c(e.transporter.write({
                                method: g,
                                path: l("1/indexes/%s/deleteByQuery", e.indexName),
                                data: t
                            }, r), function(t, r) {
                                return eY(e)(t.taskID, r)
                            })
                    ...
                    eR = function(e) {
                        return function(t) {
                            return c(e.transporter.write({
                                method: y,
                                path: l("1/indexes/%s", e.indexName)
                            }, t), function(t, r) {
                                return eY(e)(t.taskID, r)
                            })
                        }
                    ...
                    ex = function(e) {
                        return function(t, n) {
                            ...
                            return a && (o.queryParameters.forwardToReplicas = 1), c(e.transporter.write({
                                method: y,
                                path: l("1/indexes/%s/rules/%s", e.indexName, t)
                            }, o), function(t, r) {
                                return eY(e)(t.taskID, r)
                            })
                        }
                    ...
                    eE = function(e) {
                        return function(t, n) {
                            ...
                            return a && (o.queryParameters.forwardToReplicas = 1), c(e.transporter.write({
                                method: y,
                                path: l("1/indexes/%s/synonyms/%s", e.indexName, t)
                            }, o), function(t, r) {
                                return eY(e)(t.taskID, r)
                            })
                        }
                    ...
                    eI = function(e) {
                        return function(t, r) {
                            return e.transporter.read({
                                method: "GET",
                                path: l("1/indexes/%s/%s", e.indexName, t)
                            }, r)
                        }
                    },
                    eT = function() {
                    ...
                    eN = function(e) {
                        return function(t) {
                            return e.transporter.read({
                                method: "GET",
                                path: l("1/indexes/%s/settings", e.indexName),
                                data: {
                                    getVersion: 2
                                }
                            }, t)
                    ...
                    eU = function(e) {
                        return function(a, o) {
                            var s = o || {},
                                u = s.safe,
                                f = s.autoGenerateObjectIDIfNotExist,
                                h = s.batchSize,
                                ...
                                b = [],
                                S = d(e.indexName, y, "copy", t(t({}, p), {}, {
                                    scope: ["settings", "synonyms", "rules"]
                                }));
                            return b.push(S), c((u ? S.wait(p) : S).then(function() {
                                var e = v(a, t(t({}, p), {}, {
                                    autoGenerateObjectIDIfNotExist: f,
                                    batchSize: h
                                }));
                                return b.push(e), u ? e.wait(p) : e
                            }).then(function() {
                                var t = d(y, e.indexName, "move", p);
                                return b.push(t), u ? t.wait(p) : t
                            }).then(function() {
                    ...
                    eL = function(e) {
                        return function(t, r) {
                            return c(eM(e)([t], r).then(function(e) {
                                return {
                                    objectID: e.objectIDs[0],
                                    taskID: e.taskIDs[0]
                                }
                        ...
                        return function(t, n) {
                            ...
                            if (s === e0.UpdateObject) {
                                var u = !0,
                                    ...
                                    f = void 0;
                                try {
                                    for (var h, p = t[Symbol.iterator](); !(u = (h = p.next()).done); u = !0)
                    ...
                    eB = function(e) {
                        return function(t, n) {
                            ...
                            return a && (s.queryParameters.forwardToReplicas = 1), o && (s.queryParameters.clearExistingRules = 1), c(e.transporter.write({
                                method: g,
                                path: l("1/indexes/%s/rules/batch", e.indexName),
                                data: t
                            }, s), function(t, r) {
                                return eY(e)(t.taskID, r)
                            })
                    ...
                    eG = function(e) {
                        return function(t, n) {
                            ...
                            return a && (u.queryParameters.forwardToReplicas = 1), (s || o) && (u.queryParameters.replaceExistingSynonyms = 1), c(e.transporter.write({
                                method: g,
                                path: l("1/indexes/%s/synonyms/batch", e.indexName),
                                data: t
                            }, u), function(t, r) {
                                return eY(e)(t.taskID, r)
                            })
                    ...
                    ez = function(e) {
                        return function(t, r) {
                            return e.transporter.read({
                                method: g,
                                path: l("1/indexes/%s/rules/search", e.indexName),
                                data: {
                                    query: t
                                }
                            }, r)
                    ...
                    eX = function(e) {
                        return function(t, r) {
                            return e.transporter.read({
                                method: g,
                                path: l("1/indexes/%s/synonyms/search", e.indexName),
                                data: {
                                    query: t
                                }
                            }, r)
                        ...
                        return function(t, r) {
                            return s(function(n) {
                                return (function(t, r) {
                                    return e.transporter.read({
                                        method: "GET",
                                        path: l("1/indexes/%s/task/%s", e.indexName, t.toString())
                                    }, r)
                                })(t, r).then(function(e) {
                                    return "published" !== e.status ? n() : void 0
                                })
                ...
                function te(e, s, c) {
                    var h, d, m, y, v, S, O, j, A, ev, e1, te, tt, tr = {
                            appId: e,
                            apiKey: s,
                            timeouts: {
                                connect: 1,
                            ...
                            hostsCache: function e(t) {
                                ...
                                caches: [(v = {
                                    key: "".concat("4.25.3", "-").concat(e)
                                }, O = "algoliasearch-client-js-".concat(v.key), j = function() {
                                    return void 0 === S && (S = v.localStorage || window.localStorage), S
                                }, A = function() {
                                    return JSON.parse(j().getItem(O) || "{}")
                                }, ev = function(e) {
                                    j().setItem(O, JSON.stringify(e))
                                }, e1 = function() {
                                    var e = v.timeToLive ? 1e3 * v.timeToLive : null,
                                        t = Object.fromEntries(Object.entries(A()).filter(function(e) {
                                            return void 0 !== n(e, 2)[1].timestamp
                                        }));
                                    ev(t), e && ev(Object.fromEntries(Object.entries(t).filter(function(t) {
                                        var r = n(t, 2)[1],
                                            i = (new Date).getTime();
                                    ...
                                    set: function(e, t) {
                                        return Promise.resolve().then(function() {
                                            ...
                                            return r[JSON.stringify(e)] = {
                                                ...
                                                value: t
                                            }, j().setItem(O, JSON.stringify(r)), t
                                        })
                                    },
                                    delete: function(e) {
                                        return Promise.resolve().then(function() {
                                            var t = A();
                                            delete t[JSON.stringify(e)], j().setItem(O, JSON.stringify(t))
                                        })
                                    },
                                    clear: function() {
                                        return Promise.resolve().then(function() {
                            ...
                            userAgent: (te = {
                                value: "Algolia for JavaScript (".concat("4.25.3", ")"),
                                add: function(e) {
                                    var t = "; ".concat(e.segment).concat(void 0 !== e.version ? " (".concat(e.version, ")") : "");
                                    return -1 === te.value.indexOf(t) && (te.value = "".concat(te.value).concat(t)), te
                                }
                            }).add({
                                segment: "Browser"
                            })
                        ...
                        ti = function() {
                            return function(e) {
                                var r, n, i, a;
                                return n = (r = t(t(t({}, tr), e), {}, {
                                    methods: {
                                        getPersonalizationStrategy: _,
                                        setPersonalizationStrategy: F
                                    }
                                })).region || "us", i = o(f.WithinHeaders, r.appId, r.apiKey), a = b(t(t({
                                    hosts: [{
                    ...
                    if (c && c.transformation) {
                        if (!c.transformation.region) throw e5("`region` must be provided when leveraging the transformation pipeline");
                        tt = function(e) {
                            if (!e || !e.transformation || !e.transformation.region) throw e5("`region` must be provided when leveraging the transformation pipeline");
                            if ("eu" !== e.transformation.region && "us" !== e.transformation.region) throw e5("`region` is required and must be one of the following: eu, us");
                            var r = e.appId,
                                n = o(f.WithinHeaders, r, e.apiKey),
                                i = b(t(t({
                                    hosts: [{
                                        url: "data.".concat(e.transformation.region, ".algolia.com"),
                                        accept: p.ReadWrite,
                                        protocol: "https"
                                    }]
                                }, e), {}, {
                                    headers: t(t(t({}, n.headers()), {
                                        "content-type": "text/plain"
                                    }), e.headers),
                                    queryParameters: t(t({}, n.queryParameters()), e.queryParameters)
                                }));
                            return {
                                transporter: i,
                                appId: r,
                                addAlgoliaAgent: function(e, t) {
                                    i.userAgent.add({
                                        ...
                                        segment: "Ingestion via Algoliasearch"
                                    })
                                },
                                clearCache: function() {
                                ...
                                push: function(e, r) {
                                    var n = e.indexName,
                                        a = e.pushTaskPayload,
                                        o = e.watch;
                                    if (!n) throw e5("Parameter `indexName` is required when calling `push`.");
                                    if (!a) throw e5("Parameter `pushTaskPayload` is required when calling `push`.");
                                    if (!a.action) throw e5("Parameter `pushTaskPayload.action` is required when calling `push`.");
                                    if (!a.records) throw e5("Parameter `pushTaskPayload.records` is required when calling `push`.");
                                    var s = r || {
                                        queryParameters: {}
                                    };
                                    return i.write({
                                        ...
                                        queryParameters: t(t({}, s.queryParameters), {}, {
                                            watch: void 0 !== o
                                        })
                                    }))
                                }
                    ...
                    return d = (h = t(t({}, tn), {}, {
                        methods: {
                            ...
                            initIndex: function(e) {
                                return function(n) {
                                    ...
                                    return t(t({}, K(e)(n, {
                                        ...
                                        saveObjectsWithTransformation: (i = tt, function(e, t) {
                                            if (!i) throw e5("`options.transformation.region` must be provided at client instantiation before calling this method.");
                                            var a = t || {},
                                                o = a.autoGenerateObjectIDIfNotExist,
                                                s = a.watch,
                                                c = r(a, ["autoGenerateObjectIDIfNotExist", "watch"]),
                                                u = o ? e0.AddObject : e0.UpdateObject;
                                            return i.push({
                                                indexName: n,
                                                pushTaskPayload: {
                                                    action: u,
                                        ...
                                        partialUpdateObjectsWithTransformation: (a = tt, function(e, t) {
                                            if (!a) throw e5("`options.transformation.region` must be provided at client instantiation before calling this method.");
                                            var i = t || {},
                                                o = i.createIfNotExists,
                                                s = i.watch,
                                                c = r(i, ["createIfNotExists", "watch"]),
                                                u = o ? e0.PartialUpdateObject : e0.PartialUpdateObjectNoCreate;
                                            return a.push({
                                                indexName: n,
                                                pushTaskPayload: {
                                                    action: u,
                            ...
                            initPersonalization: ti,
                            initRecommendation: function() {
                                return function(e) {
                                    return tn.logger.info("The `initRecommendation` method is deprecated. Use `initPersonalization` instead."), ti()(e)
                                }
                            },
                    ...
                    })).appId, m = o(void 0 !== h.authMode ? h.authMode : f.WithinHeaders, d, h.apiKey), u({
                        transporter: y = b(t(t({
                            hosts: [{
                            ...
                            headers: t(t(t({}, m.headers()), {
                                "content-type": "application/x-www-form-urlencoded"
                            }), h.headers),
                            queryParameters: t(t({}, m.queryParameters()), h.queryParameters)
                        })),
                        appId: d,
                        addAlgoliaAgent: function(e, t) {
                            y.userAgent.add({
                        ...
                        clearCache: function() {
                            return Promise.all([y.requestsCache.clear(), y.responsesCache.clear()]).then(function() {})
                        }
                    }, h.methods)
                }
                return te.version = "4.25.3", te
            }()
        },
        3605: e => {
            "use strict";
        ...
        18154: (e, t, r) => {
            ...
            function u(e, t, r) {
                ...
                }(t, "string"), (t = "symbol" == a(n) ? n : n + "") in e) ? Object.defineProperty(e, t, {
                    value: r,
                    enumerable: !0,
                    configurable: !0,
                    writable: !0
            ...
            function h(e) {
                var t;
                return (0, i.Q)(e) && "string" != typeof e.value ? Object.keys(e).reduce(function(t, r) {
                    return c(c({}, t), {}, u({}, r, h(e[r])))
                }, {}) : Array.isArray(e) ? e.map(h) : c(c({}, e), {}, {
                    value: (t = e.value, (0, n.i)(t).replace(RegExp(l.highlightPreTag, "g"), f.highlightPreTag).replace(RegExp(l.highlightPostTag, "g"), f.highlightPostTag))
                })
            }
        ...
        22362: (e, t, r) => {
            ...
            var o = !!n && a && a(Object.prototype, "__proto__"),
                s = Object,
                c = s.getPrototypeOf;
            e.exports = o && "function" == typeof o.get ? i([o.get]) : "function" == typeof c && function(e) {
        ...
        23906: (e, t, r) => {
            ...
            c.version = r(14167), c.AlgoliaSearchHelper = n, c.SearchParameters = o, c.RecommendParameters = i, c.SearchResults = s, c.RecommendResults = a, e.exports = c
        },
        24616: e => {
            "use strict";
            e.exports = {
        ...
        25821: (e, t, r) => {
            ...
            function f(e, t, r) {
                ...
                return (n = function(e, t) {
                    ...
                    return ("string" === t ? String : Number)(e)
                }(t, "string"), (t = "symbol" == c(n) ? n : n + "") in e) ? Object.defineProperty(e, t, {
                    value: r,
                    enumerable: !0,
                    configurable: !0,
                    writable: !0
            ...
            let d = function() {
                ...
                return function(r) {
                    if (!r || !(0, o.Q)(r.searchParameters)) throw Error(h("The `searchParameters` option expects an object."));
                    var i = {};
                    return {
                        $$type: "ais.configure",
                        init: function(t) {
                            ...
                            return l(l({}, e), {}, {
                                configure: l(l({}, i), {}, {
                                    widgetParams: l(l({}, i.widgetParams), {}, {
                                        searchParameters: (0, s.p)(new n.SearchParameters(null == (r = e.configure) ? void 0 : r.widgetParams.searchParameters), new n.SearchParameters(i.widgetParams.searchParameters)).getQueryParams()
                                    })
                                })
                            })
                        },
            ...
            var s = function(e, t) {
                ...
                u = function() {
                    ...
                    return t.reduce(function(e, t) {
                        var r, n, i, a, u, l, f, h;
                        return s((h = c((r = e.setQueryParameters({
        ...
        32722: e => {
            ...
            t.prototype = {
                ...
                _buildQueries: function(e, t) {
                    return this.params.filter(function(e) {
        ...
        40678: (e, t, r) => {
            ...
            function g(e, t, r, n) {
                "function" == typeof e.addAlgoliaAgent && e.addAlgoliaAgent("JS Helper (" + y + ")"), this.setClient(e);
                var i = r || {};
                i.index = t, this.state = p.make(i), this.recommendState = new l({
            ...
            o(g, n), g.prototype.search = function() {
                return this._search({
                ...
                var r = e ? this.state.setQueryParameters(e) : this.state,
                    ...
                    i = this;
                return (this._currentNbQueries++, this.emit("searchOnce", {
                    state: r
                }), t) ? void this.client.search(n).then(function(e) {
                ...
                var n = r.getModifiedState(t),
                    i = s({
                        ...
                        params: u(h._getHitsSearchParams(n), ["attributesToSnippet", "hitsPerPage", "restrictSearchableAttributes", "snippetEllipsisText"])
                    }),
                ...
                var i, o = "function" == typeof this.client.searchForFacetValues && "function" != typeof this.client.searchForFacets,
                ...
                var f = this;
                o ? i = this.client.searchForFacetValues([{
                    indexName: c.index,
                    params: l
                }]) : s ? i = this.client.initIndex(c.index).searchForFacetValues(l) : (delete l.facetName, i = this.client.search([{
                    type: "facet",
                    facet: e,
                    indexName: c.index,
                    params: l
                ...
                var p = this.lastResults && this.lastResults.index === c.index && this.lastResults.renderingContent && this.lastResults.renderingContent.facetOrdering && this.lastResults.renderingContent.facetOrdering.values && this.lastResults.renderingContent.facetOrdering.values[e] && this.lastResults.renderingContent.facetOrdering.values[e].hide || [];
                return i.then(function(t) {
                    return f._currentNbQueries--, 0 === f._currentNbQueries && f.emit("searchQueueEmpty"), (t = Array.isArray(t) ? t[0] : t).facetHits = t.facetHits.reduce(function(t, r) {
                        return p.indexOf(r.value) > -1 || (r.escapedValue = a(r.value), r.isRefined = u ? c.isDisjunctiveFacetRefined(e, r.escapedValue) : c.isFacetRefined(e, r.escapedValue), t.push(r)), t
                    }, []), t
                }, function(e) {
                ...
                var i, o = this.state.setQueryParameters(n || {}),
                    s = o.isDisjunctiveFacet(e);
                this._currentNbQueries++;
                var c = this;
                return i = this.client.searchForFacetValues({
                    ...
                    return c._currentNbQueries--, 0 === c._currentNbQueries && c.emit("searchQueueEmpty"), (t = t.results[0]).facetHits.forEach(function(t) {
                        t.escapedValue = a(t.value), t.isRefined = s ? o.isDisjunctiveFacetRefined(e, t.escapedValue) : o.isFacetRefined(e, t.escapedValue)
                    }), t
                }, function(e) {
                ...
                var e = this.state.page || 0;
                return this.setPage(e - 1)
            }, g.prototype.setCurrentPage = v, g.prototype.setPage = v, g.prototype.setIndex = function(e) {
                return this._change({
            ...
            }, g.prototype.getCurrentPage = b, g.prototype.getPage = b, g.prototype.getTags = function() {
                ...
                var t = this.state,
                    r = [],
                    n = [];
                e.onlyWithDerivedHelpers || (n = h._getQueries(t.index, t), r.push({
                    state: t,
                ...
                var e = this.state,
                    ...
                    i = this._queryId++;
                if (this._currentNbQueries++, !n.length) return Promise.resolve({
                    results: []
                ...
                var a = n[0];
                try {
                    this.client.search(a).then(this._dispatchAlgoliaResponse.bind(this, t, i)).catch(this._dispatchAlgoliaError.bind(this, i))
                } catch (e) {
                    this.emit("error", {
                        error: e
                    })
                ...
                var a = this._recommendCache,
                    o = this.derivedHelpers.map(function(t) {
                        ...
                        return n.push({
                            ...
                            index: r,
                            helper: t
                        }), i = Array.prototype.concat.apply(i, o.params.map(function(e) {
                            return e.$$id
                        })), t.emit("fetch", {
                            recommend: {
                                state: o,
                ...
                if (0 !== s.length) {
                    if (s.length > 0 && void 0 === this.client.getRecommendations) return void console.warn("Please update algoliasearch/lite to the latest version in order to use recommend widgets.");
                ...
                if (!(t < this._lastQueryIdReceived)) {
                    ...
                    Object.keys(a).length <= 0 && (a = void 0), e.forEach(function(e) {
                        var t = e.state,
                            r = e.queriesCount,
                            o = e.helper,
                            s = i.splice(0, r);
                        t.index ? (o.lastResults = new d(t, s, n._searchResultsOptions), void 0 !== a && (o.lastResults._rawContent = a), o.emit("result", {
                ...
                if (!(e < this._lastRecommendQueryIdReceived)) {
                    ...
                    r.forEach(function(e) {
                        ...
                        var t = e.state,
                            r = e.helper;
                        e.index ? (r.lastRecommendResults = new f(t, o), r.emit("recommend:result", {
                            recommend: {
                ...
                return this.client === e || ("function" == typeof e.addAlgoliaAgent && e.addAlgoliaAgent("JS Helper (" + y + ")"), this.client = e), this
        ...
        40998: (e, t, r) => {
            ...
            function y(e, t, r) {
                ...
                Object.keys(b).forEach(function(t) {
                    var r = b[t],
                        n = (l = e.hierarchicalFacets, o(l, function(e) {
                    ...
                    if (n) {
                        ...
                        var l, f, h = -1 !== e.disjunctiveFacets.indexOf(t),
                            p = -1 !== e.facets.indexOf(t);
                        h && (f = g[t], c.disjunctiveFacets[f] = {
                            name: t,
                            data: r,
                            exhaustive: a.exhaustiveFacetsCount
                        }, m(c.disjunctiveFacets[f], a.facets_stats, t)), p && (f = y[t], c.facets[f] = {
                            name: t,
                            data: r,
                            exhaustive: a.exhaustiveFacetsCount
                    ...
                    Object.keys(o).forEach(function(t) {
                        ...
                        if (l) {
                            ...
                            if (-1 === p) return;
                            c.hierarchicalFacets[r][p].data = c.persistHierarchicalRootCount ? u(c.hierarchicalFacets[r][p].data, f) : i(f, c.hierarchicalFacets[r][p].data)
                        } else {
                            r = g[t];
                ...
                }), this.hierarchicalFacets = this.hierarchicalFacets.map(p(e)), this.facets = n(this.facets), this.disjunctiveFacets = n(this.disjunctiveFacets), this._state = e
            }
            ...
            y.prototype.getFacetByName = function(e) {
                ...
                if (n) {
                    ...
                    return r = Array.isArray(n) ? [e] : s._state.getHierarchicalFacetByName(n.name).attributes,
                        function e(t, r, n, a) {
                            ...
                            var r, n, i, o, u, f, h, p = s.renderingContent && s.renderingContent.facetOrdering && s.renderingContent.facetOrdering.values && s.renderingContent.facetOrdering.values[t];
                            if (a.facetOrdering && p) return n = [], i = [], o = p.hide || [], u = (p.order || []).reduce(function(e, t, r) {
                                return e[t] = r, e
                            }, {}), e.forEach(function(e) {
                                var t = e.path || e.name,
                                    r = o.indexOf(t) > -1;
                                r || void 0 === u[t] ? r || i.push(e) : n[u[t]] = e
                            }), n = n.filter(function(e) {
                                return e
                            }), "hidden" === (f = p.sortRemainingBy) ? n : (r = "alpha" === f ? [
                                ["path", "name"],
                                ["asc", "asc"]
                            ] : [
                                ["count"],
                                ["desc"]
                            ], n.concat(l(i, r[0], r[1])));
                            if (Array.isArray(a.sortBy)) {
                                var d = c(a.sortBy, y.DEFAULT_SORT),
                                    m = l(e, d[0], d[1]),
                                    g = p && p.hide ? p.hide : [];
                                if (g.length > 0) {
                                    var v = [];
                                    return m.forEach(function(e) {
                                        var t = e.path || e.name; - 1 === g.indexOf(t) && v.push(e)
                                    }), v
                                }
                                return m
                            }
                            if ("function" == typeof a.sortBy) return h = a.sortBy, e.sort(h);
                ...
                return Object.keys(e.facetsRefinements).forEach(function(n) {
                    ...
                    e.hierarchicalFacetsRefinements[n].forEach(function(i) {
                        var a, s, c, u, l, f, h, p, d, m, y;
                        r.push((a = e, s = n, c = i, u = t.hierarchicalFacets, l = a.getHierarchicalFacetByName(s), f = a._getHierarchicalFacetSeparator(l), h = c.split(f), p = o(u, function(e) {
                            return e.name === s
                        }), m = (d = h.reduce(function(e, t) {
                            var r = e && o(e.data, function(e) {
                                return e.name === t
                            });
                            return void 0 !== r ? r : e
                        }, p)) && d.count || 0, y = d && d.exhaustive || !1, {
                            type: "hierarchical",
                            attributeName: s,
                            name: d && d.path || "",
                            count: m,
            ...
            var a = {
                        ...
                        if (o.length > 0 && o[0].split(s).length > 1) {
                            ...
                            c.forEach(function(n, o) {
                                ...
                                var l = (s.facetFilters || []).reduce(function(e, t) {
                                    ...
                                    f = c[o - 1];
                                o > 0 ? s.facetFilters = l.concat(f.attribute + ":" + f.value) : l.length > 0 ? s.facetFilters = l : delete s.facetFilters, r.push({
                                    indexName: e,
                                    params: s
                                })
                            })
                ...
                _getCompositionQueries: function(e) {
                    return [{
                        ...
                        requestBody: {
                            params: a._getCompositionHitsSearchParams(e)
                        }
                    }]
                },
                _getHitsSearchParams: function(e) {
                    var t = e.facets.concat(e.disjunctiveFacets).concat(a._getHitsHierarchicalFacetsAttributes(e)).sort(),
                        ...
                        c = {};
                    return t.length > 0 && (c.facets = t.indexOf("*") > -1 ? ["*"] : t), s.length > 0 && (c.tagFilters = s), r.length > 0 && (c.facetFilters = r), o.length > 0 && (c.numericFilters = o), i(n({}, e.getQueryParams(), c))
                },
                _getCompositionHitsSearchParams: function(e) {
                    var t = e.facets.concat(e.disjunctiveFacets.map(function(t) {
                            return e.disjunctiveFacetsRefinements && e.disjunctiveFacetsRefinements[t] && e.disjunctiveFacetsRefinements[t].length > 0 ? "disjunctive(" + t + ")" : t
                        })).concat(a._getHitsHierarchicalFacetsAttributes(e)).sort(),
                        r = a._getFacetFilters(e),
                        o = a._getNumericFilters(e),
                        s = a._getTagFilters(e),
                        c = {};
                    t.length > 0 && (c.facets = t.indexOf("*") > -1 ? ["*"] : t), s.length > 0 && (c.tagFilters = s), r.length > 0 && (c.facetFilters = r), o.length > 0 && (c.numericFilters = o);
                ...
                _getDisjunctiveFacetSearchParams: function(e, t, r) {
                    ...
                    return l ? u.facets = a._getDisjunctiveHierarchicalFacetAttribute(e, l, r) : u.facets = t, s.length > 0 && (u.numericFilters = s), o.length > 0 && (u.facetFilters = o), i(n({}, e.getQueryParams(), u))
                },
                ...
                _getFacetFilters: function(e, t, r) {
                    ...
                    return Object.keys(s).sort().forEach(function(i) {
                        ...
                        if (void 0 !== c) {
                            ...
                            if (t === i) {
                                if (-1 === c.indexOf(l) || !f && !0 === r || f && f.split(l).length === c.split(l).length) return;
                                f ? (o = f.split(l).length - 1, c = f) : (o = c.split(l).length - 2, c = c.slice(0, c.lastIndexOf(l))), a = u.attributes[o]
            ...
            e.exports = function(e, t) {
                ...
                return t.forEach(function(t) {
                    t.forEach(function(t, r) {
                        e.includes(t.objectID) || (o[t.objectID] ? o[t.objectID] = {
                            indexSum: o[t.objectID].indexSum + r,
                            count: o[t.objectID].count + 1
                        } : o[t.objectID] = {
                            indexSum: r,
                            count: 1
                        })
                    })
                }), (r = t.length, a = [], Object.keys(o).forEach(function(e) {
                    o[e].count < 2 && (o[e].indexSum += 100), a.push({
                        objectID: e,
                        avgOfIndices: o[e].indexSum / r
                    })
                }), a.sort(function(e, t) {
                    return e.avgOfIndices > t.avgOfIndices ? 1 : -1
                })).reduce(function(e, r) {
                    var a = n(i(t), function(e) {
        ...
        56450: e => {
            ...
            e.exports = function(e) {
                ...
                for (var c = i(arguments, 1), u = r(0, s.length - c.length), l = [], f = 0; f < u; f++) l[f] = "$" + f;
                if (o = Function("binder", "return function (" + a(l, ",") + "){ return binder.apply(this,arguments); }")(function() {
                        if (this instanceof o) {
                            var t = s.apply(this, n(c, arguments));
                            return Object(t) === t ? t : this
                        }
                        return s.apply(e, n(c, arguments))
                    }), s.prototype) {
                    var h = function() {};
                    h.prototype = s.prototype, o.prototype = new h, h.prototype = null
                }
                return o
            }
        },
        56924: (e, t, r) => {
            ...
            e.exports = function(e) {
                return function(t, r) {
                    var n, u, l, f, h, p = e.hierarchicalFacets[r],
                        d = e.hierarchicalFacetsRefinements[p.name] && e.hierarchicalFacetsRefinements[p.name][0] || "",
                        m = e._getHierarchicalFacetSeparator(p),
                        y = e._getHierarchicalRootPath(p),
                        g = e._getHierarchicalShowParentLevel(p),
                        v = a(e._getHierarchicalFacetSortBy(p)),
                        b = t.every(function(e) {
                            return e.exhaustive
                        }),
                        S = (n = v, u = m, l = y, f = g, h = d, function(e, t, r) {
                            var a = e;
                            if (r > 0) {
                                var p = 0;
                                for (a = e; p < r;) a = i(a && Array.isArray(a.data) ? a.data : [], function(e) {
                                    return e.isRefined
                                }), p++
                            }
                            if (a) {
                                var d = Object.keys(t.data).map(function(e) {
                                    ...
                                    var t, r, n, i, o, s;
                                    return t = e[0], r = a.path || l, n = h, i = u, o = l, s = f, (!o || 0 === t.indexOf(o) && o !== t) && (!o && -1 === t.indexOf(i) || o && t.split(i).length - o.split(i).length == 1 || -1 === t.indexOf(i) && -1 === n.indexOf(i) || 0 === n.indexOf(t) || 0 === t.indexOf(r + i) && (s || 0 === t.indexOf(n)))
                                });
                                a.data = o(d.map(function(e) {
                                    var r, n, i, a, o, l, f = e[0];
                                    return r = e[1], n = f, i = u, a = c(h), o = t.exhaustive, {
                        ...
                        O = t;
                    return y && (O = t.slice(y.split(m).length)), O.reduce(S, {
        ...
        63269: (e, t, r) => {
            ...
            var n = r(46294),
                ...
                d = {},
                m = function e(t, r, a, o, s, u, f, h, m, y, g, v, b, S, O, j, R, P) {
                    for (var w, x, E = t, _ = P, F = 0, A = !1; void 0 !== (_ = _.get(d)) && !A;) {
                        var I = _.get(t);
                        if (F += 1, void 0 !== I)
                            if (I === F) throw RangeError("Cyclic object value");
                            else A = !0;
                        void 0 === _.get(d) && (F = 0)
                    }
                    if ("function" == typeof y ? E = y(r, E) : E instanceof Date ? E = b(E) : "comma" === a && c(E) && (E = i.maybeMap(E, function(e) {
                            return e instanceof Date ? b(e) : e
                        })), null === E) {
                        if (u) return m && !j ? m(r, p.encoder, R, "key", S) : r;
                        E = ""
                    }
                    if ("string" == typeof(w = E) || "number" == typeof w || "boolean" == typeof w || "symbol" == typeof w || "bigint" == typeof w || i.isBuffer(E)) return m ? [O(j ? r : m(r, p.encoder, R, "key", S)) + "=" + O(m(E, p.encoder, R, "value", S))] : [O(r) + "=" + O(String(E))];
                    var T = [];
                    if (void 0 === E) return T;
                    if ("comma" === a && c(E)) j && m && (E = i.maybeMap(E, m)), x = [{
                    ...
                    var k = h ? String(r).replace(/\./g, "%2E") : String(r),
                        N = o && c(E) && 1 === E.length ? k + "[]" : k;
                    if (s && c(E) && 0 === E.length) return N + "[]";
                    for (var C = 0; C < x.length; ++C) {
                        var H = x[C],
                            q = "object" == typeof H && H && void 0 !== H.value ? H.value : E[H];
                        if (!f || null !== q) {
                            var U = v && h ? String(H).replace(/\./g, "%2E") : String(H),
                                Q = c(E) ? "function" == typeof a ? a(N, U) : N : N + (v ? "." + U : "[" + U + "]");
                            P.set(t, F);
                            var W = n();
                            W.set(d, P), l(T, e(q, Q, a, o, s, u, f, h, "comma" === a && j && c(E) ? null : m, y, g, v, b, S, O, j, R, W))
                        }
                    }
                    return T
                },
                y = function(e) {
                    ...
                    var i = a.formatters[n],
                        u = p.filter;
                    if (("function" == typeof e.filter || c(e.filter)) && (u = e.filter), t = e.arrayFormat in s ? e.arrayFormat : "indices" in e ? e.indices ? "indices" : "repeat" : p.arrayFormat, "commaRoundTrip" in e && "boolean" != typeof e.commaRoundTrip) throw TypeError("`commaRoundTrip` must be a boolean, or absent");
            ...
            e.exports = function(e, t) {
                var r, i = e,
                    a = y(t);
                "function" == typeof a.filter ? i = (0, a.filter)("", i) : c(a.filter) && (r = a.filter);
                var o = [];
                if ("object" != typeof i || null === i) return "";
                var u = s[a.arrayFormat],
                    f = "comma" === u && a.commaRoundTrip;
                r || (r = Object.keys(i)), a.sort && r.sort(a.sort);
                for (var h = n(), p = 0; p < r.length; ++p) {
                    var d = r[p],
                        g = i[d];
                    a.skipNulls && null === g || l(o, m(g, d, u, f, a.allowEmptyArrays, a.strictNullHandling, a.skipNulls, a.encodeDotInKeys, a.encode ? a.encoder : null, a.filter, a.sort, a.allowDots, a.serializeDate, a.format, a.formatter, a.encodeValuesOnly, a.charset, h))
                }
                var v = o.join(a.delimiter),
                    b = !0 === a.addQueryPrefix ? "?" : "";
                return a.charsetSentinel && ("iso-8859-1" === a.charset ? b += "utf8=%26%2310003%3B&" : b += "utf8=%E2%9C%93&"), v.length > 0 ? b + v : ""
            }
        },
        66238: e => {
            "use strict";
        ...
        67390: (e, t, r) => {
            ...
            var n = (0, r(49430).createContext)(null)
        },
        68078: e => {
            "use strict";
            e.exports = EvalError
        ...
        68473: (e, t, r) => {
            ...
            e.exports = {
                ...
                combine: function(e, t, r, n) {
                    if (u(e)) {
                        var i = l(e) + 1;
                        return e[i] = t, f(e, i), e
                    }
                    var a = [].concat(e, t);
                    return a.length > r ? c(d(a, {
                        plainObjects: n
                    }), a.length - 1) : a
                },
                compact: function(e) {
                ...
                encode: function(e, t, r, i, a) {
                    ...
                    for (var s = "", c = 0; c < o.length; c += 1024) {
                        for (var u = o.length >= 1024 ? o.slice(c, c + 1024) : o, l = [], f = 0; f < u.length; ++f) {
                            var p = u.charCodeAt(f);
                            if (45 === p || 46 === p || 95 === p || 126 === p || p >= 48 && p <= 57 || p >= 65 && p <= 90 || p >= 97 && p <= 122 || a === n.RFC1738 && (40 === p || 41 === p)) {
                            ...
                            if (p < 2048) {
                                l[l.length] = h[192 | p >> 6] + h[128 | 63 & p];
                                continue
                            }
                            if (p < 55296 || p >= 57344) {
                                l[l.length] = h[224 | p >> 12] + h[128 | p >> 6 & 63] + h[128 | 63 & p];
                                continue
                            }
                            f += 1, p = 65536 + ((1023 & p) << 10 | 1023 & u.charCodeAt(f)), l[l.length] = h[240 | p >> 18] + h[128 | p >> 12 & 63] + h[128 | p >> 6 & 63] + h[128 | 63 & p]
                        }
                        s += l.join("")
                    }
                    return s
                ...
                merge: function e(t, r, n) {
                    ...
                    if ("object" != typeof r && "function" != typeof r) {
                        if (o(t)) t.push(r);
                            ...
                            var i = l(t) + 1;
                            t[i] = r, f(t, i)
                        } else(n && (n.plainObjects || n.allowPrototypes) || !a.call(Object.prototype, r)) && (t[r] = !0);
                        return t
                    }
                    if (!t || "object" != typeof t) {
                        if (u(r)) {
                            for (var s = Object.keys(r), h = n && n.plainObjects ? {
                                    __proto__: null,
                                    0: t
                                } : {
                                    0: t
                                }, p = 0; p < s.length; p++) h[parseInt(s[p], 10) + 1] = r[s[p]];
                            return c(h, l(r) + 1)
                        }
                        return [t].concat(r)
                    }
                    var m = t;
                    return (o(t) && !o(r) && (m = d(t, n)), o(t) && o(r)) ? (r.forEach(function(r, i) {
                        if (a.call(t, i)) {
                            var o = t[i];
        ...
        70969: (e, t, r) => {
            ...
            r(42451)(i, n), i.prototype.detach = function() {
        ...
        72092: (e, t, r) => {
            "use strict";
            e.exports = r(37829).getPrototypeOf || null
        },
        72160: e => {
            "use strict";
            e.exports = function(e) {
        ...
        79237: (e, t, r) => {
            var n = "function" == typeof Map && Map.prototype,
                ...
                I = "function" == typeof Symbol && Symbol.toStringTag && (typeof Symbol.toStringTag === A ? "object" : "symbol") ? Symbol.toStringTag : null,
            ...
            function L(e) {
                return "[object Array]" === G(e) && W(e)
            }

            function M(e) {
                return "[object RegExp]" === G(e) && W(e)
            }
            ...
            e.exports = function e(t, n, i, s) {
                var c, m, S, j, x, _ = n || {};
                if (V(_, "quoteStyle") && !V(q, _.quoteStyle)) throw TypeError('option "quoteStyle" must be "single" or "double"');
                if (V(_, "maxStringLength") && ("number" == typeof _.maxStringLength ? _.maxStringLength < 0 && _.maxStringLength !== 1 / 0 : null !== _.maxStringLength)) throw TypeError('option "maxStringLength", if provided, must be a positive integer, Infinity, or `null`');
                var C = !V(_, "customInspect") || _.customInspect;
                if ("boolean" != typeof C && "symbol" !== C) throw TypeError("option \"customInspect\", if provided, must be `true`, `false`, or `'symbol'`");
                if (V(_, "indent") && null !== _.indent && "	" !== _.indent && !(parseInt(_.indent, 10) === _.indent && _.indent > 0)) throw TypeError('option "indent" must be "\\t", an integer > 0, or `null`');
                if (V(_, "numericSeparator") && "boolean" != typeof _.numericSeparator) throw TypeError('option "numericSeparator", if provided, must be `true` or `false`');
                var B = _.numericSeparator;
                ...
                if ("string" == typeof t) return function e(t, r) {
                    ...
                    var i = U[r.quoteStyle || "single"];
                    return i.lastIndex = 0, Q(b.call(b.call(t, i, "\\$1"), /[\x00-\x1f]/g, K), "single", r)
                }(t, _);
                if ("number" == typeof t) {
                ...
                var en = void 0 === _.depth ? 5 : _.depth;
                if (void 0 === i && (i = 0), i >= en && en > 0 && "object" == typeof t) return L(t) ? "[Array]" : "[Object]";
                var ei = function(e, t) {
                    var r;
                    if ("	" === e.indent) r = "	";
                    else {
                ...
                function ea(t, r, n) {
                    if (r && (s = w.call(s)).push(r), n) {
                        var a = {
                            depth: _.depth
                        };
                        return V(_, "quoteStyle") && (a.quoteStyle = _.quoteStyle), e(t, a, i + 1, s)
                    }
                    return e(t, _, i + 1, s)
                }
                if ("function" == typeof t && !M(t)) {
                    var eo = function(e) {
                        ...
                        es = ee(t, ea);
                    return "[Function" + (eo ? ": " + eo : " (anonymous)") + "]" + (es.length > 0 ? " { " + P.call(es, ", ") + " }" : "")
                }
                if ($(t)) {
                    var ec = A ? b.call(String(t), /^(Symbol\(.*\))_[^)]*$/, "$1") : F.call(t);
                    return "object" != typeof t || A ? ec : z(ec)
                }
                if ((eu = t) && "object" == typeof eu && ("u" > typeof HTMLElement && eu instanceof HTMLElement || "string" == typeof eu.nodeName && "function" == typeof eu.getAttribute)) {
                    for (var eu, el, ef = "<" + O.call(String(t.nodeName)), eh = t.attributes || [], ep = 0; ep < eh.length; ep++) {
                        ef += " " + eh[ep].name + "=" + Q((el = eh[ep].value, b.call(String(el), /"/g, "&quot;")), "double", _)
                    }
                    return ef += ">", t.childNodes && t.childNodes.length && (ef += "..."), ef += "</" + O.call(String(t.nodeName)) + ">"
                }
                if (L(t)) {
                    ...
                    return ei && ! function(e) {
                        for (var t = 0; t < e.length; t++)
                            if (J(e[t], "\n") >= 0) return !1;
                        return !0
                    }(ed) ? "[" + Y(ed, ei) + "]" : "[ " + P.call(ed, ", ") + " ]"
                }
                if ("[object Error]" === G(c = t) && W(c)) {
                    var em = ee(t, ea);
                    return "cause" in Error.prototype || !("cause" in t) || T.call(t, "cause") ? 0 === em.length ? "[" + String(t) + "]" : "{ [" + String(t) + "] " + P.call(em, ", ") + " }" : "{ [" + String(t) + "] " + P.call(R.call("[cause]: " + ea(t.cause), em), ", ") + " }"
                }
                if ("object" == typeof t && C) {
                    if (H && "function" == typeof t[H] && N) return N(t, {
                        depth: en - i
                    });
                ...
                if ("[object Number]" === G(m = t) && W(m)) return z(ea(Number(t)));
                if (function(e) {
                        ...
                        return !1
                    }(t)) return z(ea(E.call(t)));
                if ("[object Boolean]" === G(S = t) && W(S)) return z(d.call(t));
                if ("[object String]" === G(j = t) && W(j)) return z(ea(String(t)));
                ...
                if (!("[object Date]" === G(x = t) && W(x)) && !M(t)) {
                    var ev = ee(t, ea),
                        eb = D ? D(t) === Object.prototype : t instanceof Object || t.constructor === Object,
                        eS = t instanceof Object ? "" : "null prototype",
                        eO = !eb && I && Object(t) === t && I in t ? v.call(G(t), 8, -1) : eS ? "Object" : "",
                        ej = (eb || "function" != typeof t.constructor ? "" : t.constructor.name ? t.constructor.name + " " : "") + (eO || eS ? "[" + P.call(R.call([], eO || [], eS || []), ": ") + "] " : "");
                    return 0 === ev.length ? ej + "{}" : ei ? ej + "{" + Y(ev, ei) + "}" : ej + "{ " + P.call(ev, ", ") + " }"
                }
                return String(t)
            };
            ...
            function ee(e, t) {
                ...
                if (n) {
                    i.length = e.length;
                    for (var a = 0; a < e.length; a++) i[a] = V(e, a) ? t(e[a], e) : ""
                }
                var o = "function" == typeof _ ? _(e) : [];
                if (A) {
                    r = {};
                    for (var s = 0; s < o.length; s++) r["$" + o[s]] = o[s]
                }
                for (var c in e)
                    if (V(e, c) && (!n || String(Number(c)) !== c || !(c < e.length)))
                        if (A && r["$" + c] instanceof Symbol) continue;
                        else j.call(/[^\w$]/, c) ? i.push(t(c, e) + ": " + t(e[c], e)) : i.push(c + ": " + t(e[c], e));
                if ("function" == typeof _)
                    for (var u = 0; u < o.length; u++) T.call(e, o[u]) && i.push("[" + t(o[u]) + "]: " + t(e[o[u]], e));
                return i
            }
        },
        81197: e => {
        ...
        81529: (e, t, r) => {
            ...
            function p(e, t, r) {
                ...
                return (n = function(e, t) {
                    ...
                    return ("string" === t ? String : Number)(e)
                }(t, "string"), (t = "symbol" == l(n) ? n : n + "") in e) ? Object.defineProperty(e, t, {
                    value: r,
                    enumerable: !0,
                    configurable: !0,
                    writable: !0
            ...
            let m = function(e) {
                ...
                return function(r) {
                    ...
                    return {
                        ...
                        init: function(t) {
                            var r = t.instantSearchInstance;
                            e(h(h({}, this.getWidgetRenderState(t)), {}, {
                                instantSearchInstance: r
                            }), !0)
                        },
                        render: function(t) {
                        ...
                        getWidgetRenderState: function(e) {
                            ...
                            o.refine || (o.refine = function(e) {
                                n.setQuery(e).search()
                            });
                            var p = f.map(function(e) {
                                e.results && (e.results.hits = i ? (0, a.S8)(e.results.hits) : e.results.hits);
                                var r, n, o, l, f, p, d, m, y = (n = (r = {
                                    instantSearchInstance: h,
                                    helper: e.helper,
                                    widgetType: t.$$type
                                }).instantSearchInstance, o = r.helper, l = r.widgetType, f = {}, p = void 0, function() {
                                    for (var e = arguments.length, t = Array(e), r = 0; r < e; r++) t[r] = arguments[r];
                                    (function(e) {
                                        var t, r = e.helper,
                                            n = e.widgetType,
                                        ...
                                        if (1 === i.length && "object" === u(i[0])) return [i[0]];
                                        var o = function(e) {
                                                if (Array.isArray(e)) return e
                                            }(t = i[0].split(":")) || function(e) {
                                                ...
                                                if (null != t) {
                                                    ...
                                                    try {
                                                        i = (t = t.call(e)).next, !1;
                                                        for (; !(s = (r = i.call(t)).done) && (o.push(r.value), 2 !== o.length); s = !0);
                                                    } catch (e) {
                                                        c = !0, n = e
                                                    } finally {
                                                        try {
                                            ...
                                            p = i[2],
                                            d = i[3] || {};
                                        if (!h || ("click" === l || "conversion" === l) && !p) return [];
                                        ...
                                        return "view" === l ? "idle" !== a.status ? [] : g.map(function(e, t) {
                                            var i;
                                            return {
                                                ...
                                                eventType: l,
                                                payload: s({
                                                    eventName: p || "Hits Viewed",
                                                    index: (null == (i = r.lastResults) ? void 0 : i.index) || r.state.index,
                                                    objectIDs: v[t]
                                                }, d),
                                                hits: e,
                                                eventModifier: f
                                            }
                                        }) : "click" === l ? g.map(function(e, t) {
                                            var i;
                                            return {
                                        ...
                                        }) : "conversion" === l ? g.map(function(e, t) {
                                            var i;
                                            return {
                                        ...
                                        "click" === e.eventType && "internal" === e.eventModifier && f[e.eventType] || (f[e.eventType] = !0, n.sendEventToInsights(e))
                                ...
                                return {
                                    indexId: e.indexId,
                                    indexName: (null == (d = e.results) ? void 0 : d.index) || "",
                                    hits: (null == (m = e.results) ? void 0 : m.hits) || [],
                                    results: e.results || {},
                                    sendEvent: y
                                }
                            });
                        ...
                        getWidgetSearchParameters: function(e, t) {
                            ...
                            return i ? e.setQueryParameters(h(h({}, r), a.FU)) : e.setQueryParameters(r)
                        },
                        dispose: function(e) {
                            var r = e.state;
                            t();
                            var n = r.setQueryParameter("query", void 0);
                            return i ? n.setQueryParameters(Object.keys(a.FU).reduce(function(e, t) {
                                return h(h({}, e), {}, p({}, t, void 0))
                            }, {})) : n
                        }
                    }
                }
        ...
        85056: (e, t, r) => {
            ...
            var b = "2.17.2",
                S = "https://cdn.jsdelivr.net/npm/search-insights@".concat(b, "/dist/search-insights.min.js");
            ...
            function O() {
                ...
                t || null === t || u(function(e) {
                    ...
                    "string" == typeof r && (p = t[r]), p || (t.AlgoliaAnalyticsObject = r, t[r] || (t[r] = function() {
                        t[r].queue || (t[r].queue = []);
                        for (var e = arguments.length, n = Array(e), i = 0; i < e; i++) n[i] = arguments[i];
                        t[r].queue.push(n)
                    }, t[r].version = b, t[r].shouldAddScript = !0), p = t[r])
                });
                var d = p || l.l;
                return function(e) {
                    ...
                    var p = y(f(o.client), 2),
                        ...
                        E = d.queue;
                    if (Array.isArray(E)) {
                        var _ = ["setUserToken", "init"].map(function(e) {
                                var t = h(E.slice().reverse(), function(t) {
                                    return y(t, 1)[0] === e
                                }) || [];
                                return y(t, 2)[1]
                            }),
                    ...
                    return d("getUserToken", null, function(e, t) {
                        x = R(t)
                    }), (r || !j(d)) && d("init", m({
                        appId: b,
                        apiKey: O,
                        ...
                        subscribe: function() {
                            if (d.shouldAddScript) {
                                ...
                                try {
                                    ...
                                    t.async = !0, t.src = S, t.onerror = function() {
                                        o.emit("error", Error(e))
                                    }, document.body.appendChild(t), d.shouldAddScript = !1
                                } catch (t) {
                        ...
                        started: function() {
                            ...
                            var e, u, l, p, g, v, b, S, O, E, _, F, A, I = d.queue;
                            if (Array.isArray(I)) {
                                var T = ["setUserToken", "init"].map(function(e) {
                                        var t = h(I.slice().reverse(), function(t) {
                                            return y(t, 1)[0] === e
                                        }) || [];
                                        return y(t, 2)[1]
                                    }),
                            ...
                            p = (null == (u = (e = o)._initialResults) || null == (l = u[e.indexName]) ? void 0 : l.state) || {}, g = e.mainHelper.state, t = {
                                userToken: p.userToken || g.userToken,
                                clickAnalytics: p.clickAnalytics || g.clickAnalytics
                            }, s || i.overrideStateWithoutTriggeringChangeEvent(m(m({}, i.state), {}, {
                                clickAnalytics: !0
                            })), a || o.scheduleSearch();
                            var k = function(e) {
                                var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                                ...
                                function a() {
                                    i.overrideStateWithoutTriggeringChangeEvent(m(m({}, i.state), {}, {
                                        userToken: r
                            ...
                            function N(e) {
                                k(e, !0), d("setUserToken", e)
                            }
                            var C = void 0,
                                H = function() {
                                    if (("u" < typeof document ? "undefined" : c(document)) === "object" && "string" == typeof document.cookie)
                            ...
                            C = H || "anonymous-".concat("xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, function(e) {
                                var t = 16 * Math.random() | 0;
                                return ("x" === e ? t : 3 & t | 8).toString(16)
                            }));
                            var q = t.userToken;
                            null != r && r.userToken && (E = r.userToken), E ? N(E) : q ? N(q) : x ? N(x) : w ? N(w) : C && (N(C), (null != r && r.useCookie || null != (_ = P) && _.useCookie) && (v = C, b = (null == r ? void 0 : r.cookieDuration) || (null == (F = P) ? void 0 : F.cookieDuration), (S = new Date).setTime(S.getTime() + (b || 15552e6)), O = "expires=".concat(S.toUTCString()), document.cookie = "_ALGOLIA=".concat(v, ";").concat(O, ";path=/"))), d("onUserTokenChange", function(e) {
                                return k(e, !0)
                            }, {
                                immediate: !0
                            });
                            var U = d;
                            j(d) && (U = function(e, t) {
                                var r = y(f(o.client), 2);
                                return d(e, t, {
                                    headers: {
                                        "X-Algolia-Application-Id": r[0],
                                        "X-Algolia-API-Key": r[1]
                                    }
                                })
                            });
                            var Q = new Set;
                            o.mainHelper.derivedHelpers[0].on("result", function(e) {
                                var t = e.results;
                                t && (!t.queryID || t.queryID !== A) && (A = t.queryID, Q.clear())
                                ...
                                if (n) n(e, U);
                                    ...
                                    e.payload.algoliaSource = ["instantsearch"], s && e.payload.algoliaSource.push("instantsearch-automatic"), "internal" === e.eventModifier && e.payload.algoliaSource.push("instantsearch-internal"), U(e.insightsMethod, e.payload)
                                }
                            }
                        },
                        unsubscribe: function() {
                            d("onUserTokenChange", void 0), o.sendEventToInsights = l.l, i && t && (i.overrideStateWithoutTriggeringChangeEvent(m(m({}, i.state), t)), o.scheduleSearch())
                        }
                    }
                }
            }
            ...
            function j(e) {
                var t = y((e.version || "").split(".").map(Number), 2),
                    r = t[0],
                    n = t[1];
            ...
            var A = function(e) {
                ...
                I = function() {
                    ...
                    function t(e) {
                        ...
                        _(this, "$$type", "ais.browser"), _(this, "windowTitle", void 0), _(this, "writeDelay", void 0), _(this, "_createURL", void 0), _(this, "parseURL", void 0), _(this, "getLocation", void 0), _(this, "writeTimer", void 0), _(this, "_onPopState", void 0), _(this, "inPopState", !1), _(this, "isDisposed", !1), _(this, "latestAcknowledgedHistory", 0), _(this, "_start", void 0), _(this, "_dispose", void 0), _(this, "_push", void 0), _(this, "_cleanUrlOnDispose", void 0), this.windowTitle = n, this.writeTimer = void 0, this.writeDelay = void 0 === i ? 400 : i, this._createURL = a, this.parseURL = o, this.getLocation = s, this._start = c, this._dispose = l, this._push = f, this._cleanUrlOnDispose = void 0 === h || h, u(function(e) {
                            var t = e.window;
                            A(r.windowTitle && r.windowTitle(r.read())), r.latestAcknowledgedHistory = t.history.length
                        })
                    }
                    return e = [{
                            key: "read",
                            ...
                            value: function(e) {
                                ...
                                u(function(r) {
                                    ...
                                    t.writeTimer && clearTimeout(t.writeTimer), t.writeTimer = setTimeout(function() {
                                        A(a), t.shouldWrite(i) && (t._push ? t._push(i) : n.history.pushState(e, a || "", i), t.latestAcknowledgedHistory = n.history.length), t.inPopState = !1, t.writeTimer = void 0
                                    }, t.writeDelay)
                                })
                            }
                        }, {
            ...
            function C(e, t, r) {
                ...
                return (n = function(e, t) {
                    ...
                    return ("string" === t ? String : Number)(e)
                }(t, "string"), (t = "symbol" == T(n) ? n : n + "") in e) ? Object.defineProperty(e, t, {
                    value: r,
                    enumerable: !0,
                    configurable: !0,
                    writable: !0
                        ...
                        return {
                            ...
                            onStateChange: function(e) {
                                ...
                                (void 0 === n || ! function e(t, r) {
                                    if (t === r) return !0;
                                    if (q(t) || q(r) || "function" == typeof t || "function" == typeof r) return t === r;
                            ...
                            subscribe: function() {
                                t._initialUiState = W(W({}, a), i.routeToState(r.read())), r.onUpdate(function(e) {
            ...
            function et(e, t, r) {
                ...
                return (n = function(e, t) {
                    ...
                    return ("string" === t ? String : Number)(e)
                }(t, "string"), (t = "symbol" == z(n) ? n : n + "") in e) ? Object.defineProperty(e, t, {
                    value: r,
                    enumerable: !0,
                    configurable: !0,
                    writable: !0
            ...
            function er(e) {
                return function(e) {
                    ...
                    if (e) {
                        if ("string" == typeof e) return en(e, void 0);
                        var t = ({}).toString.call(e).slice(8, -1);
                        return "Object" === t && e.constructor && (t = e.constructor.name), "Map" === t || "Set" === t ? Array.from(e) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? en(e, void 0) : void 0
                    }
                }(e) || function() {
                    throw TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")
                }()
            ...
            function es(e, t) {
                ...
                return e.reduce(function(e, r) {
                    return !B(r) && (r.getWidgetUiState || r.getWidgetState) ? r.getWidgetUiState ? r.getWidgetUiState(e, t) : r.getWidgetState(e, t) : e
                }, r)
            }
            ...
            function ec(e, t) {
                var r = t.initialSearchParameters,
                    n = ei(t, X);
                return e.reduce(function(e, t) {
                    return !t.getWidgetSearchParameters || B(t) ? e : "search" === t.dependsOn && t.getWidgetParameters ? t.getWidgetParameters(e, n) : t.getWidgetSearchParameters(e, n)
                }, r)
            }
            ...
            function eu(e, t) {
                var r = t.initialRecommendParameters,
                    n = ei(t, Z);
                return e.reduce(function(e, t) {
                    return !B(t) && "recommend" === t.dependsOn && t.getWidgetParameters ? t.getWidgetParameters(e, n) : e
                }, r)
            }
            let el = function(e) {
                if (void 0 === e || void 0 === e.indexName && !e.EXPERIMENTAL_isolated) throw Error(ea("The `indexName` option is required."));
                var t = e.indexName,
                    r = void 0 === t ? "" : t,
                    n = e.indexId,
                    i = void 0 === n ? r : n,
                    a = e.EXPERIMENTAL_isolated,
                    o = void 0 !== a && a,
                    c = [],
                    u = {},
                    l = null,
                ...
                return {
                    ...
                    getResults: function() {
                        var e;
                        return null != (e = p) && e.lastResults ? (p.lastResults._state = h.state, p.lastResults) : null
                    },
                    getResultsForWidget: function(e) {
                        var t;
                        return "recommend" !== e.dependsOn || B(e) || void 0 === e.$$id ? this.getResults() : null != (t = h) && t.lastRecommendResults ? h.lastRecommendResults[e.$$id] : null
                    },
                    ...
                    getScopedResults: function() {
                        ...
                        return function e(t) {
                            return t.filter(B).reduce(function(t, r) {
                                return t.concat.apply(t, [{
                                    indexId: r.getIndexId(),
                                    results: r.getResults(),
                                    helper: r.getHelper()
                                }].concat(er(e(r.getWidgets()))))
                            }, [])
                        }(e ? e.getWidgets() : 0 === r.length ? this.getWidgets() : [this])
                    },
                    getParent: function() {
                        return o ? null : f
                    },
                    createURL: function(e) {
                        return "function" == typeof e ? l._createURL(et({}, i, e(u))) : l._createURL(et({}, i, es(c, {
                            searchParameters: e,
                            helper: h
                        })))
                    },
                    scheduleLocalSearch: G(function() {
                        if (o) {
                            var e;
                            null == (e = h) || e.search()
                        }
                    ...
                    addWidgets: function(e) {
                        var t = this;
                        if (!Array.isArray(e)) throw Error(ea("The `addWidgets` method expects an array of widgets."));
                        var r = e.reduce(function(e, t) {
                            return e.concat(Array.isArray(t) ? t : [t])
                        }, []);
                        ...
                        return r.forEach(function(e) {
                            (e.parent = t, !B(e)) && (l && "recommend" === e.dependsOn ? l._hasRecommendWidget = !0 : l ? l._hasSearchWidget = !0 : "recommend" === e.dependsOn ? m = !0 : y = !0, "recommend" === e.dependsOn && (e.$$id = K++))
                        }), c = c.concat(r), l && r.length && (eo(h, {
                            state: ec(c, {
                                uiState: u,
                            ...
                            e.getRenderState && ef({
                                renderState: e.getRenderState(l.renderState[t.getIndexId()] || {}, P(l, t, l._initialUiState)),
                                instantSearchInstance: l,
                                parent: t
                            })
                        }), r.forEach(function(e) {
                            e.init && e.init(P(l, t, l._initialUiState))
                        }), o ? this.scheduleLocalSearch() : l.scheduleSearch()), this
                    },
                    removeWidgets: function(e) {
                        var t = this;
                        if (!Array.isArray(e)) throw Error(ea("The `removeWidgets` method expects an array of widgets."));
                        var r = e.reduce(function(e, t) {
                            return e.concat(Array.isArray(t) ? t : [t])
                        }, []);
                        if (r.some(function(e) {
                        ...
                        if ((c = c.filter(function(e) {
                                ...
                                e.parent = void 0, B(e) || (l && "recommend" === e.dependsOn ? l._hasRecommendWidget = !0 : l ? l._hasSearchWidget = !0 : "recommend" === e.dependsOn ? m = !0 : y = !0)
                            }), l && r.length) {
                            var n = r.reduce(function(e, r) {
                                    ...
                                    return n instanceof s.RecommendParameters ? e.cleanedRecommendState = n : n && (e.cleanedSearchState = n), e
                                }, {
                                    cleanedSearchState: h.state,
                                    cleanedRecommendState: h.recommendState
                                }),
                                i = n.cleanedSearchState,
                                a = n.cleanedRecommendState,
                                f = l.future.preserveSharedStateOnUnmount ? ec(c, {
                                    uiState: u,
                                    ...
                                    initialSearchParameters: i
                                });
                            u = es(c, {
                                searchParameters: f,
                                helper: h
                            }), h.setState(f), h.recommendState = a, c.length && (o ? this.scheduleLocalSearch() : l.scheduleSearch())
                        }
                        return this
                    },
                    init: function(e) {
                        ...
                        if (null === h) {
                            ...
                            var b = a.mainHelper,
                                ...
                                O = eu(c, {
                                    uiState: u,
                                    initialRecommendParameters: new s.RecommendParameters
                                });
                            (h = s(b.getClient(), S.index, S)).recommendState = O, h.search = function() {
                                return o ? (a.status = "loading", n.render({
                                    instantSearchInstance: a
                                }), a.compositionID ? h.searchWithComposition() : h.searchOnlyWithDerivedHelpers()) : a.onStateChange ? (a.onStateChange({
                            ...
                            var j = r ? h : s({}, "__empty_index__", {});
                            p = (o ? j : function(e, t) {
                                for (; e;) {
                                    if (e._isolated) return e.getHelper();
                                    e = e.getParent()
                                }
                                return t
                            }(g, b)).derive(function() {
                                return J.p.apply(void 0, [b.state].concat(er(function(e) {
                                    for (var t = e.getParent(), r = [e.getHelper().state]; null !== t;) r = [t.getHelper().state].concat(r), t = t.getParent();
                                    return r
                                }(n))))
                            }, function() {
                                return n.getHelper().recommendState
                            });
                            var R = null == (t = a._initialResults) ? void 0 : t[this.getIndexId()];
                            if (null != R && R.results) {
                                var w = new s.SearchResults(new s.SearchParameters(R.state), R.results);
                                p.lastResults = w, h.lastResults = w
                            }
                            if (null != R && R.recommendResults) {
                                var x = new s.RecommendResults(new s.RecommendParameters({
                                    params: R.recommendResults.params
                                }), R.recommendResults.results);
                                p.lastRecommendResults = x, h.lastRecommendResults = x
                            }
                            h.on("change", function(e) {
                                ...
                                var t = e.results;
                                a.scheduleRender(), h.lastResults = t, d = null == t ? void 0 : t._state
                            }), p.on("recommend:result", function(e) {
                                var t = e.recommend;
                                a.scheduleRender(), h.lastRecommendResults = t.results
                            }), c.forEach(function(e) {
                                e.getRenderState && ef({
                                    renderState: e.getRenderState(a.renderState[n.getIndexId()] || {}, P(a, n, v)),
                                    instantSearchInstance: a,
                                    parent: n
                                })
                            }), c.forEach(function(e) {
                                e.init && e.init(P(a, n, v))
                            }), h.on("change", function(e) {
                                var t = e.state,
                                    r = e._uiState;
                                u = es(c, {
                                    searchParameters: t,
                                    helper: h
                                }, r || {}), a.onStateChange || a.onInternalStateChange()
                            }), R && a.scheduleRender(), m && (a._hasRecommendWidget = !0), y && (a._hasSearchWidget = !0)
                        }
                    },
                    render: function(e) {
                        var t, n = this,
                            i = e.instantSearchInstance;
                        "error" === i.status && !i.mainHelper.hasPendingRequests() && d && h.setState(d);
                        var a = this.getResults() || null != (t = p) && t.lastRecommendResults || o && !r ? c : c.filter(function(e) {
                        ...
                        (a = a.filter(function(e) {
                            ...
                            e.getRenderState && ef({
                                renderState: e.getRenderState(i.renderState[n.getIndexId()] || {}, w(i, n, e)),
                                instantSearchInstance: i,
                                parent: n
                            })
                        }), a.forEach(function(e) {
                            e.render && e.render(w(i, n, e))
                        })
                    },
                    dispose: function() {
                        var e, t, r = this;
                        c.forEach(function(e) {
                            e.dispose && h && e.dispose({
                                helper: h,
                                state: h.state,
                                recommendState: h.recommendState,
                                parent: r
                            })
                        }), l = null, f = null, null == (e = h) || e.removeAllListeners(), h = null, null == (t = p) || t.detach(), p = null
                    },
                    getWidgetUiState: function(e) {
                        return c.filter(B).filter(function(e) {
                            return !e._isolated
                        }).reduce(function(e, t) {
                            return t.getWidgetUiState(e)
                        }, ee(ee({}, e), {}, et({}, i, ee(ee({}, e[i]), u))))
                    },
            ...
            function ef(e) {
                ...
                r.renderState = ee(ee({}, r.renderState), {}, et({}, i, ee(ee({}, r.renderState[i]), t)))
            }
            var eh = function(e) {
                return function() {
            ...
            function ey(e) {
                var t = ed.sn.highlightPreTag,
                    r = ed.sn.highlightPostTag;
                return e.map(function(e) {
            ...
            function ej(e) {
                return e.some(function(e) {
                    ...
                    var n, i, a, o, s;
                    return eO(eO({}, t), {}, {
                        isHighlighted: (a = e[r], o = (null == (n = e[r + 1]) ? void 0 : n.isHighlighted) || !0, s = (null == (i = e[r - 1]) ? void 0 : i.isHighlighted) || !0, ev.test((0, eg.x)(a.value)) || s !== o ? !a.isHighlighted : !s)
                    })
                }) : e.map(function(e) {
                    return eO(eO({}, e), {}, {
                        isHighlighted: !1
            ...
            function eR(e) {
                var t = ed.sn.highlightPostTag,
                    r = ed.sn.highlightPreTag,
                    n = e.split(r),
                    i = n.shift(),
                    a = i ? [{
                        value: i,
            ...
            var eP = eh("ReverseHighlight"),
                ew = eh("Snippet"),
                ex = eh("ReverseSnippet");
            ...
            function eN(e, t, r) {
                ...
                return (n = function(e, t) {
                    ...
                    return ("string" === t ? String : Number)(e)
                }(t, "string"), (t = "symbol" == eI(n) ? n : n + "") in e) ? Object.defineProperty(e, t, {
                    value: r,
                    enumerable: !0,
                    configurable: !0,
                    writable: !0
            ...
            function eQ(e, t) {
                ...
                t.getHelper().setState(t.getWidgetSearchParameters(t.getHelper().state, {
                    uiState: r
                })), t.getWidgets().filter(B).forEach(function(t) {
                    return eQ(e, t)
                })
            }
            ...
            var eZ = {
                ...
                eY = function(e) {
                    ...
                    var t, r, n = (t = eV(), function() {
                        var e, r = eG(i);
                        return e = t ? Reflect.construct(r, arguments, eG(this).constructor) : r.apply(this, arguments),
                            function(e, t) {
                                if (t && ("object" == eW(t) || "function" == typeof t)) return t;
                    ...
                    function i(e) {
                        ...
                        eJ(eB(t = n.call(this)), "client", void 0), eJ(eB(t), "indexName", void 0), eJ(eB(t), "compositionID", void 0), eJ(eB(t), "insightsClient", void 0), eJ(eB(t), "onStateChange", null), eJ(eB(t), "future", void 0), eJ(eB(t), "helper", void 0), eJ(eB(t), "mainHelper", void 0), eJ(eB(t), "mainIndex", void 0), eJ(eB(t), "started", void 0), eJ(eB(t), "templatesConfig", void 0), eJ(eB(t), "renderState", {}), eJ(eB(t), "_stalledSearchDelay", void 0), eJ(eB(t), "_searchStalledTimer", void 0), eJ(eB(t), "_initialUiState", void 0), eJ(eB(t), "_initialResults", void 0), eJ(eB(t), "_manuallyResetScheduleSearch", !1), eJ(eB(t), "_resetScheduleSearch", void 0), eJ(eB(t), "_createURL", void 0), eJ(eB(t), "_searchFunction", void 0), eJ(eB(t), "_mainHelperSearch", void 0), eJ(eB(t), "_hasSearchWidget", !1), eJ(eB(t), "_hasRecommendWidget", !1), eJ(eB(t), "_insights", void 0), eJ(eB(t), "middleware", []), eJ(eB(t), "sendEventToInsights", void 0), eJ(eB(t), "status", "idle"), eJ(eB(t), "error", void 0), eJ(eB(t), "scheduleSearch", G(function() {
                            t.started && t.mainHelper.search()
                        })), eJ(eB(t), "scheduleRender", G(function() {
                            var e, r = !(arguments.length > 0) || void 0 === arguments[0] || arguments[0];
                            !(null != (e = t.mainHelper) && e.hasPendingRequests()) && (clearTimeout(t._searchStalledTimer), t._searchStalledTimer = null, r && (t.status = "idle", t.error = void 0)), t.mainIndex.render({
                                instantSearchInstance: eB(t)
                            }), t.emit("render")
                        })), eJ(eB(t), "onInternalStateChange", G(function() {
                        ...
                        var t, r = e.indexName,
                            ...
                            S = e.onStateChange,
                            j = e.future,
                            R = void 0 === j ? eM(eM({}, eZ), e.future || {}) : j;
                        if (null === g) throw Error(ez("The `searchClient` option is required."));
                        if ("function" != typeof g.search) throw Error("The `searchClient` must implement a `search` method.\n\nSee: https://www.algolia.com/doc/guides/building-search-ui/going-further/backend-search/in-depth/backend-instantsearch/js/");
                        if ("function" == typeof g.addAlgoliaAgent && g.addAlgoliaAgent("instantsearch.js (".concat("4.86.1", ")")), b && "function" != typeof b) throw Error(ez("The `insightsClient` option should be a function."));
                        if (t.client = g, t.future = R, t.insightsClient = b, t.indexName = void 0 === r ? "" : r, t.compositionID = a, t.helper = null, t.mainHelper = null, t.mainIndex = el({
                                indexName: t.compositionID || t.indexName
                            }), t.onStateChange = void 0 === S ? null : S, t.started = !1, t.templatesConfig = {
                                helpers: {
                                    ...
                                    highlight: function(e, t) {
                                        try {
                                            var r, n, i, a, o, s, c, u, l, f = JSON.parse(e);
                                            return t((n = (r = eA(eA({}, f), {}, {
                                                hit: this
                                            })).attribute, i = r.highlightedTagName, a = void 0 === i ? "mark" : i, o = r.hit, s = r.cssClasses, c = void 0 === s ? {} : s, u = (ep(o._highlightResult, n) || {}).value, l = em({
                                                descendantName: "highlighted"
                                            }) + (c.highlighted ? " ".concat(c.highlighted) : ""), (void 0 === u ? "" : u).replace(RegExp(ed.sn.highlightPreTag, "g"), "<".concat(a, ' class="').concat(l, '">')).replace(RegExp(ed.sn.highlightPostTag, "g"), "</".concat(a, ">"))))
                                        } catch (e) {
                                    ...
                                    reverseHighlight: function(e, t) {
                                        try {
                                            ...
                                            return t((n = (r = eA(eA({}, f), {}, {
                                                hit: this
                                            })).attribute, i = r.highlightedTagName, a = void 0 === i ? "mark" : i, o = r.hit, s = r.cssClasses, c = void 0 === s ? {} : s, u = (ep(o._highlightResult, n) || {}).value, l = eP({
                                                descendantName: "highlighted"
                                            }) + (c.highlighted ? " ".concat(c.highlighted) : ""), ey(ej(eR(void 0 === u ? "" : u))).replace(RegExp(ed.sn.highlightPreTag, "g"), "<".concat(a, ' class="').concat(l, '">')).replace(RegExp(ed.sn.highlightPostTag, "g"), "</".concat(a, ">"))))
                                        } catch (e) {
                                    ...
                                    snippet: function(e, t) {
                                        try {
                                            ...
                                            return t((n = (r = eA(eA({}, f), {}, {
                                                hit: this
                                            })).attribute, i = r.highlightedTagName, a = void 0 === i ? "mark" : i, o = r.hit, s = r.cssClasses, c = void 0 === s ? {} : s, u = (ep(o._snippetResult, n) || {}).value, l = ew({
                                                descendantName: "highlighted"
                                            }) + (c.highlighted ? " ".concat(c.highlighted) : ""), (void 0 === u ? "" : u).replace(RegExp(ed.sn.highlightPreTag, "g"), "<".concat(a, ' class="').concat(l, '">')).replace(RegExp(ed.sn.highlightPostTag, "g"), "</".concat(a, ">"))))
                                        } catch (e) {
                                    ...
                                    reverseSnippet: function(e, t) {
                                        try {
                                            ...
                                            return t((n = (r = eA(eA({}, f), {}, {
                                                hit: this
                                            })).attribute, i = r.highlightedTagName, a = void 0 === i ? "mark" : i, o = r.hit, s = r.cssClasses, c = void 0 === s ? {} : s, u = (ep(o._snippetResult, n) || {}).value, l = ex({
                                                descendantName: "highlighted"
                                            }) + (c.highlighted ? " ".concat(c.highlighted) : ""), ey(ej(eR(void 0 === u ? "" : u))).replace(RegExp(ed.sn.highlightPreTag, "g"), "<".concat(a, ' class="').concat(l, '">')).replace(RegExp(ed.sn.highlightPostTag, "g"), "</".concat(a, ">"))))
                                        } catch (e) {
                                    ...
                                    insights: function(e, t) {
                                        try {
                                            ...
                                            return t((r = eA({
                                                ...
                                                var t, r = e.method,
                                                    n = e.payload;
                                                if ("object" !== eE(n)) throw Error("The insights helper expects the payload to be an object.");
                                                try {
                                ...
                                compileOptions: {}
                            }, t._stalledSearchDelay = void 0 === m ? 200 : m, t._searchStalledTimer = null, t._createURL = eX, t._initialUiState = void 0 === s ? {} : s, t._initialResults = null, t._insights = p, d && (t._searchFunction = d), t.sendEventToInsights = l.l, f) {
                            var w = "boolean" == typeof f ? {} : f;
                            w.$$internal = !0, t.use(M(w))
                        }
                        if (p) {
                            var x = "boolean" == typeof p ? {} : p;
                            x.$$internal = !0, t.use(O(x))
                        }
                        return u(function(e) {
                            var t, r;
                            return (null == (t = e.window.navigator) || null == (r = t.userAgent) ? void 0 : r.indexOf("Algolia Crawler")) > -1
                        }, {
                            fallback: function() {
                                return !1
                            }
                            ...
                            return function(e) {
                                ...
                                return i.name = "instantsearch:widgets", {
                                    ...
                                    subscribe: function() {
                                        setTimeout(function() {
                                            var e;
                                            n.ua = (e = t.client).transporter && e.transporter.userAgent ? e.transporter.userAgent.value : e._ua,
                                                function e(t, r, n) {
                                                    var i = P(r, r.mainIndex, r._initialUiState);
                    ...
                    return r = [{
                            ...
                            key: "addWidgets",
                            value: function(e) {
                                if (!Array.isArray(e)) throw Error(ez("The `addWidgets` method expects an array of widgets. Please use `addWidget`."));
                                if (this.compositionID && e.some(function(e) {
                                        return !Array.isArray(e) && B(e) && !e._isolated
                                    })) throw Error(ez("The `index` widget cannot be used with a composition-based InstantSearch implementation."));
                            ...
                            key: "removeWidgets",
                            value: function(e) {
                                if (!Array.isArray(e)) throw Error(ez("The `removeWidgets` method expects an array of widgets. Please use `removeWidget`."));
                            ...
                            value: function() {
                                var e = this;
                                if (this.started) throw Error(ez("The `start` method has already been called once."));
                                var t = this.mainHelper || s(this.client, this.indexName, void 0, {
                                    persistHierarchicalRootCount: this.future.persistHierarchicalRootCount
                                });
                                if (this.compositionID && (t.searchForFacetValues = t.searchForCompositionFacetValues.bind(t)), t.search = function() {
                                        return e.status = "loading", e.scheduleRender(!1), e._hasSearchWidget && (e.compositionID ? t.searchWithComposition() : t.searchOnlyWithDerivedHelpers()), e._hasRecommendWidget && t.recommend(), t
                                ...
                                if (t.on("error", function(t) {
                                        ...
                                        if (t && ("transporter" in e && !e._cacheHydrated || e._useCache && "function" == typeof e.addAlgoliaAgent)) {
                                            var r = [Object.keys(t).reduce(function(e, r) {
                                                    var n = t[r],
                                                        ...
                                                        a = n.requestParams,
                                                        o = n.results,
                                                        s = o && i ? o.map(function(e, t) {
                                                            return ek({
                                                                indexName: i.index || e.index
                                                            }, null != a && a[t] || e.params ? {
                                                                params: eC((null == a ? void 0 : a[t]) || e.params.split("&").reduce(function(e, t) {
                                                                    var r, n = function(e) {
                                                                            if (Array.isArray(e)) return e
                                                                            ...
                                                                            if (e) {
                                                                                ...
                                                                                var t = ({}).toString.call(e).slice(8, -1);
                                                                                return "Object" === t && e.constructor && (t = e.constructor.name), "Map" === t || "Set" === t ? Array.from(e) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? eT(e, 2) : void 0
                                                                            }
                                                                        }(r) || function() {
                                                                            throw TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")
                                                                        }(),
                                            ...
                                            if ("transporter" in e && !e._cacheHydrated) {
                                                ...
                                                e.search = function(t) {
                                                    ...
                                                    var o = Array.isArray(t) ? t.map(function(e) {
                                                        return ek(ek({}, e), {}, {
                                                            params: eC(e.params)
                                                        })
                                                    }) : eC(t.requestBody.params);
                                            ...
                                            if (!("transporter" in e)) {
                                                ...
                                                e.cache = ek(ek({}, e.cache), {}, eN({}, a, JSON.stringify({
                                    ...
                                    }(this.client, this._initialResults), this.mainHelper._recommendCache = Object.keys(n = this._initialResults).reduce(function(e, t) {
                                        var r = n[t];
                                        return r.recommendResults ? eU(eU({}, e), r.recommendResults.results) : e
                                    }, {});
                                    var n, i = this.scheduleSearch;
                                    this.scheduleSearch = G(l.l), this._manuallyResetScheduleSearch ? this._resetScheduleSearch = function() {
                                        e.scheduleSearch = i
                                    } : G(function() {
                                        e.scheduleSearch = i
                                    })()
                            ...
                            value: function(e) {
                                ...
                                if (!this.mainHelper) throw Error(ez("The `start` method needs to be called before `setUiState`."));
                                this.mainIndex.refreshUiState();
                                var n = "function" == typeof e ? e(this.mainIndex.getWidgetUiState({})) : e;
                                this.onStateChange && r ? this.onStateChange({
                                    uiState: n,
                                    setUiState: function(e) {
                                        eQ("function" == typeof e ? e(n) : e, t.mainIndex), t.scheduleSearch(), t.onInternalStateChange()
                                    }
                            ...
                            value: function() {
                                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                                if (!this.started) throw Error(ez("The `start` method needs to be called before `createURL`."));
                                return this._createURL(e)
                            }
                        }, {
                            key: "refresh",
                            value: function() {
                                if (!this.mainHelper) throw Error(ez("The `start` method needs to be called before `refresh`."));
            ...
            function e7(e) {
                return (e7 = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
                    return typeof e
                } : function(e) {
                    return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e
                })(e)
            ...
            function te(e) {
                for (var t = 1; t < arguments.length; t++) {
                    ...
                    t % 2 ? e5(Object(r), !0).forEach(function(t) {
                        ...
                        n = e, i = t, a = r[t], (i = function(e) {
                            var t = function(e, t) {
                                if ("object" != e7(e) || !e) return e;
                                var r = e[Symbol.toPrimitive];
                                if (void 0 !== r) {
                                    var n = r.call(e, t || "default");
                                    if ("object" != e7(n)) return n;
                                    throw TypeError("@@toPrimitive must return a primitive value.")
                                }
                                return ("string" === t ? String : Number)(e)
                            }(e, "string");
                            return "symbol" == e7(t) ? t : t + ""
                        }(i)) in n ? Object.defineProperty(n, i, {
                            value: a,
                            enumerable: !0,
                            configurable: !0,
            ...
            var tt = ["react (".concat(n.version, ")"), "react-instantsearch (".concat(e1, ")"), "react-instantsearch-core (".concat(e1, ")")],
                tr = "react-instantsearch-server (".concat(e1, ")");
            ...
            function ta(e) {
                    ...
                    r = function(e) {
                        var t = (function(e) {
                                ...
                                if (e) {
                                    ...
                                    var t = ({}).toString.call(e).slice(8, -1);
                                    return "Object" === t && e.constructor && (t = e.constructor.name), "Map" === t || "Set" === t ? Array.from(e) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? e4(e, 2) : void 0
                                }
                            }(f) || function() {
                                throw TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")
                            }())[1],
                            r = (0, e8.r)(),
                            i = (0, e6.m)(),
                            a = (0, e3.t)().waitForResultsRef,
                            o = null == i ? void 0 : i.initialResults,
                            s = (0, n.useRef)(e),
                            c = r || o || a,
                            u = (0, n.useRef)(null);
                        if (null != i && i.ssrSearchRef && (u = i.ssrSearchRef), null === u.current) {
                            var l, f, h, p = new eY(e);
                            p._schedule = function(e) {
                                p._schedule.queue.push(e), clearTimeout(p._schedule.timer), p._schedule.timer = setTimeout(function() {
                                    p._schedule.queue.forEach(function(e) {
                                        e()
                                    }), p._schedule.queue = []
                                }, 0)
                            }, p._schedule.queue = [], c && (p._initialResults = o || {}, p._manuallyResetScheduleSearch = !0), tn(e.searchClient, [].concat(tt, [r && tr, (h = "u" > typeof window && (null == (l = window.next) ? void 0 : l.version) || (void 0 !== e9 ? null == e9.env ? void 0 : "" : void 0)) ? "next.js (".concat(h, ")") : null])), c && p.start(), r && r.notifyServer({
                                search: p
                            }), e.routing, u.current = p
                        }
                        var d, m = u.current,
                            y = s.current;
                        y.indexName !== e.indexName && (m.helper.setIndex(e.indexName || "").search(), s.current = e), y.searchClient !== e.searchClient && (tn(e.searchClient, [].concat(tt, [r && tr])), m.mainHelper.setClient(e.searchClient).search(), s.current = e), y.onStateChange !== e.onStateChange && (m.onStateChange = e.onStateChange, s.current = e), y.searchFunction !== e.searchFunction && (m._searchFunction = e.searchFunction, s.current = e), y.stalledSearchDelay !== e.stalledSearchDelay && (m._stalledSearchDelay = null != (d = e.stalledSearchDelay) ? d : 200, s.current = e), (0, e2.j)(y.future, e.future) || (m.future = te(te({}, eZ), e.future), s.current = e);
                        var g = (0, n.useRef)(null);
                        return (0, e0.useSyncExternalStore)((0, n.useCallback)(function() {
                            var e = u.current;
                            return null === g.current ? e.started || (e.start(), t()) : (clearTimeout(g.current), e._preventWidgetCleanup = !1),
                                function() {
                                    null != i && i.ssrSearchRef || (clearTimeout(e._schedule.timer), g.current = setTimeout(function() {
                                        e.dispose()
                ...
                return r.started ? n.createElement(a.t.Provider, {
                    value: r
                }, n.createElement(i.m.Provider, {
                    value: r.mainIndex
                }, t, n.createElement(to, {
                    search: r
                }))) : null
            }
            ...
            function to(e) {
                ...
                return (0, n.useEffect)(function() {
                    t._resetScheduleSearch && t._resetScheduleSearch()
                }, [t]), null
            }
        },
        85795: (e, t, r) => {
            ...
            var n = r(68473),
                ...
                c = function(e, t) {
                    ...
                    var u = t.parameterLimit === 1 / 0 ? void 0 : t.parameterLimit,
                        l = c.split(t.delimiter, t.throwOnLimitExceeded ? u + 1 : u);
                    if (t.throwOnLimitExceeded && l.length > u) throw RangeError("Parameter limit exceeded. Only " + u + " parameter" + (1 === u ? "" : "s") + " allowed.");
                    var f = -1,
                        h = t.charset;
                    if (t.charsetSentinel)
                        for (p = 0; p < l.length; ++p) 0 === l[p].indexOf("utf8=") && ("utf8=%E2%9C%93" === l[p] ? h = "utf-8" : "utf8=%26%2310003%3B" === l[p] && (h = "iso-8859-1"), f = p, p = l.length);
                    for (p = 0; p < l.length; ++p)
                        if (p !== f) {
                            var p, d, m, y = l[p],
                                g = y.indexOf("]="),
                                v = -1 === g ? y.indexOf("=") : g + 1;
                            if (-1 === v ? (d = t.decoder(y, o.decoder, h, "key"), m = t.strictNullHandling ? null : "") : null !== (d = t.decoder(y.slice(0, v), o.decoder, h, "key")) && (m = n.maybeMap(s(y.slice(v + 1), t, a(r[d]) ? r[d].length : 0), function(e) {
                                    return t.decoder(e, o.decoder, h, "value")
                                })), m && t.interpretNumericEntities && "iso-8859-1" === h && (m = String(m).replace(/&#(\d+);/g, function(e, t) {
                                    return String.fromCharCode(parseInt(t, 10))
                                })), y.indexOf("[]=") > -1 && (m = a(m) ? [m] : m), null !== d) {
                                var b = i.call(r, d);
                                b && "combine" === t.duplicates ? r[d] = n.combine(r[d], m, t.arrayLimit, t.plainObjects) : b && "last" !== t.duplicates || (r[d] = m)
                            }
                        }
                    return r
                },
                u = function(e, t, r, i) {
                    ...
                    for (var c = i ? t : s(t, r, a), u = e.length - 1; u >= 0; --u) {
                        var l, f = e[u];
                        if ("[]" === f && r.parseArrays) l = n.isOverflow(c) ? c : r.allowEmptyArrays && ("" === c || r.strictNullHandling && null === c) ? [] : n.combine([], c, r.arrayLimit, r.plainObjects);
                        else {
                            l = r.plainObjects ? {
                                __proto__: null
                            } : {};
                            var h = "[" === f.charAt(0) && "]" === f.charAt(f.length - 1) ? f.slice(1, -1) : f,
                                ...
                                d = parseInt(p, 10);
                            r.parseArrays || "" !== p ? !isNaN(d) && f !== p && String(d) === p && d >= 0 && r.parseArrays && d <= r.arrayLimit ? (l = [])[d] = c : "__proto__" !== p && (l[p] = c) : l = {
                                0: c
                            }
                        }
                        c = l
                ...
                l = function(e, t) {
                    ...
                    if (t.depth <= 0) {
                        if (!t.plainObjects && i.call(Object.prototype, r) && !t.allowPrototypes) return;
                        return [r]
                    }
                    var n = /(\[[^[\]]*])/g,
                        a = /(\[[^[\]]*])/.exec(r),
                        ...
                        s = [];
                    if (o) {
                        if (!t.plainObjects && i.call(Object.prototype, o) && !t.allowPrototypes) return;
                        s.push(o)
                    }
                    for (var c = 0; null !== (a = n.exec(r)) && c < t.depth;) {
                        c += 1;
                        var u = a[1].slice(1, -1);
                        if (!t.plainObjects && i.call(Object.prototype, u) && !t.allowPrototypes) return;
                        s.push(a[1])
                    }
                    if (a) {
                        if (!0 === t.strictDepth) throw RangeError("Input depth exceeded depth option of " + t.depth + " and strictDepth is true");
                        s.push("[" + r.slice(a.index) + "]")
                    }
                    return s
                },
                f = function(e, t, r, n) {
            ...
            e.exports = function(e, t) {
                ...
                for (var i = "string" == typeof e ? c(e, r) : e, a = r.plainObjects ? {
                        __proto__: null
                    } : {}, o = Object.keys(i), s = 0; s < o.length; ++s) {
                    var u = o[s],
                        l = f(u, i[u], r, "string" == typeof e);
                    a = n.merge(a, l, r)
                }
        ...
        89059: (e, t, r) => {
            ...
            e.exports = c ? function() {
                var e, t, r = {
                    ...
                    set: function(r, n) {
                        c && r && ("object" == typeof r || "function" == typeof r) ? (e || (e = new c), l(e, r, n)) : o && (t || (t = o()), t.set(r, n))
                    }
                };
                return r
            } : o
        ...
        89070: (e, t, r) => {
            ...
            function n() {
                ...
                var n = t.map(function(e) {
                    var t;
                    return "https://www.algolia.com/doc/api-reference/widgets/" + e.name + "/js/" + (void 0 !== (t = e.connector) && t ? "#connector" : "")
                }).join(", ");
                return function(e) {
        ...
        92742: (e, t, r) => {
            ...
            p.PARAMETERS = Object.keys(new p), p._parseNumbers = function(e) {
                ...
                isNumericRefined: function(e, t, r) {
                    ...
                    var n, a = this.numericRefinements[e] && void 0 !== this.numericRefinements[e][t];
                    if (void 0 === r || !a) return a;
                    var o = u(r),
                        s = void 0 !== (n = this.numericRefinements[e][t], i(n, function(e) {
                            return h(e, o)
                        }));
                    return a && s
                },
        ...
        93570: (e, t, r) => {
            ...
            function v(e) {
                var t, r = function(e) {
                        ...
                        if (e) {
                            ...
                            var t = ({}).toString.call(e).slice(8, -1);
                            return "Object" === t && e.constructor && (t = e.constructor.name), "Map" === t || "Set" === t ? Array.from(e) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? g(e, 2) : void 0
                        }
                    }(t) || function() {
                        throw TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")
                    }(),
            ...
            var b = i.use,
                S = "u" > typeof window ? n.useLayoutEffect : n.useEffect,
                O = r(15359);
            ...
            var R = ["skipSuspense"],
                P = ["instantSearchInstance", "widgetParams"],
                w = ["widgetParams"];
            ...
            function A(e) {
                var t, r, i, o, c, u, p, g, j, E, A, I, T, D, k, N, C, H, q, U = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                    ...
                    $ = (0, y.m)(),
                    B = d(),
                    V = (h(null !== (t = (0, n.useContext)(f.m)), "The <Index> component must be used within <InstantSearch>."), t),
                    G = v(U),
                    J = v(L),
                    K = (0, n.useRef)(!0),
                    z = (0, n.useRef)(null),
                    X = (0, n.useRef)(B.status),
                    Z = (0, n.useMemo)(function() {
                        return _(_({}, e(function(e, t) {
                            if (t) {
                                K.current = !0;
                                return
                            }
                            if (K.current) {
                                var r = e.instantSearchInstance,
                                    n = (e.widgetParams, F(e, P));
                                (0, a.j)(n, z.current, function(e, t) {
                                    return (null == e ? void 0 : e.constructor) === Function && (null == t ? void 0 : t.constructor) === Function
                                }) && r.status === X.current || (et(n), z.current = n, X.current = r.status)
                            }
                        }, function() {
                            K.current = !1
                        })(G)), J)
                    ...
                    Y = function(e) {
                        ...
                        if (Z.getWidgetRenderState) {
                            var e, t, r, n, i = V.getHelper(),
                                a = V.getWidgetUiState({})[V.getIndexId()];
                            i.state = (null == (n = Z.getWidgetSearchParameters) ? void 0 : n.call(Z, i.state, {
                                uiState: a
                            })) || i.state;
                            var o = (e = V.getHelper(), t = V.getResults() || s(e.state), r = V.getScopedResults().map(function(e) {
                                    var r = e.indexId === V.getIndexId() ? t : s(e.helper.state);
                                    return l(l({}, e), {}, {
                                        results: e.results || r
                                    })
                                }), {
                                    results: t,
                                    scopedResults: r,
                                    recommendResults: e.lastRecommendResults
                                }),
                                c = o.results,
                                u = o.scopedResults,
                                ...
                                h = Z.getWidgetRenderState({
                                    ...
                                    results: "recommend" === Z.dependsOn && f && $ ? f[$.recommendIdx.current++] : c,
                                    scopedResults: u,
                                    state: i.state,
                                    renderState: B.renderState,
                                    templatesConfig: B.templatesConfig,
                                    createURL: V.createURL,
                                    searchMetadata: {
                ...
                return p = (i = {
                    ...
                    props: G,
                    shouldSsr: !!M,
                    skipSuspense: void 0 !== W && W
                }).widget, g = i.parentIndex, j = i.props, E = i.shouldSsr, A = i.skipSuspense, T = (I = (0, O.t)()).waitForResultsRef, D = I.countRef, I.ignoreMultipleHooksWarning, k = (0, n.useRef)(j), (0, n.useEffect)(function() {
                    k.current = j
                }, [j]), N = (0, n.useRef)(p), (0, n.useEffect)(function() {
                    N.current = p
                }, [p]), C = (0, n.useRef)(null), H = E && !g.getWidgets().includes(p), S(function() {
                    var e = N.current;
                    return C.current ? (clearTimeout(C.current), (0, a.j)(j, k.current) || (g.removeWidgets([e]), g.addWidgets([p]))) : E || g.addWidgets([p]),
                        function() {
                            C.current = setTimeout(function() {
                                q._schedule(function() {
                                    q._preventWidgetCleanup || g.removeWidgets([e])
                                })
                            })
                        }
                }, [g, p, E, q = d(), j]), (H || (null == T || null == (o = T.current) ? void 0 : o.status) === "pending") && g.addWidgets([p]), null != T && T.current && !A && (b(T.current), "ais.dynamicWidgets" !== p.$$type && null != (u = q.helper) && u.lastResults && b(T.current)), (null == T || null == (c = T.current) ? void 0 : c.status) === "fulfilled" && (D.current += 1), ee
            }
        },
        94023: (e, t, r) => {
            "use strict";
