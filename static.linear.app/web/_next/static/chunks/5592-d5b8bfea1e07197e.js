! function() {
    try {
        var t = "u" > typeof window ? window : "u" > typeof global ? global : "u" > typeof globalThis ? globalThis : "u" > typeof self ? self : {},
            e = (new t.Error).stack;
        e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "bc3e0c15-3dcb-48e2-9065-117bbbfd36a5", t._sentryDebugIdIdentifier = "sentry-dbid-bc3e0c15-3dcb-48e2-9065-117bbbfd36a5")
    } catch (t) {}
    ...
    [5592], {
        40084: (t, e, r) => {
            ...
            var u = function(t) {
                    function e(e, r) {
                        var i;
                        return void 0 === r && (r = "Failed to resolve asset ID from source"), (i = t.call(this, r) || this).unresolvable = !0, i.input = e, i
                    }
                    return e.prototype = Object.create(t.prototype), e.prototype.constructor = e, o(e, t), e
                }(s(Error)),
                f = "https://cdn.sanity.io",
                h = /^([a-zA-Z0-9_]{24,40}|[a-f0-9]{40})+\.[a-z0-9]+$/,
                c = /^file-([a-zA-Z0-9_]{24,40}|[a-f0-9]{40})+-[a-z0-9]+$/,
                p = /^([a-zA-Z0-9_]{24,40}|[a-f0-9]{40})-\d+x\d+\.[a-z0-9]+$/,
                l = /^(images|files)\/([a-z0-9]+)\/([a-z0-9][-\w]*)\//,
                d = /^(?:image-(?:[a-zA-Z0-9_]{24,40}|[a-f0-9]{40})+-\d+x\d+-[a-z0-9]+|file-(?:[a-zA-Z0-9_]{24,40}|[a-f0-9]{40})+-[a-z0-9]+)$/;

            function g(t) {
                return b(t) && "string" == typeof t._ref
            }

            function w(t) {
                return b(t) && "string" == typeof t.path
            }

            function y(t) {
                return b(t) && "string" == typeof t.url
            }
            ...
            function m(t, e) {
                var r, i, n, o, a = (null == e ? void 0 : e.projectId) || t.projectId,
                    s = (null == e ? void 0 : e.dataset) || t.dataset;
                if (!a || !s) throw Error("Project details (projectId and dataset) required to resolve path for file");
                var u = "originalFilename" in t ? t.originalFilename : void 0;
                return "files/" + a + "/" + s + "/" + t.assetId + "." + t.extension + (r = u, i = t.vanityFilename, n = e, o = i || r, (null == n ? void 0 : n.useVanityName) !== !1 && o ? "/" + o : "")
            }

            function O(t) {
                if (l.test(t)) return t;
                if (!t.startsWith(f + "/")) throw new u('Failed to resolve path from URL "' + t + '"');
                var e = t.indexOf("?");
                return t.slice(f.length + 1, -1 === e ? void 0 : e)
            }
            var x = function() {
                try {
                    return O.apply(void 0, arguments)
                } catch (t) {
                    if (t.unresolvable && "input" in t) return;
                    throw t
                }
            };
            ...
            function I(t) {
                var e = function(t) {
                        var e = t.split("-"),
                            ...
                            a = o[0],
                            s = o[1];
                        if (!r || !i || !n || !(a > 0) || !(s > 0)) throw Error("Malformed asset ID '" + t + '\'. Expected an id like "image-027401f31c3ac1e6d78c5d539ccd1beff72b9b11-2000x3000-jpg".');
                        return {
                            type: "image",
                            assetId: r,
                            width: a,
            ...
            function _(t, e) {
                var r = i({}, e || function(t) {
                        var e = function t(e) {
                            if (v(e)) return t(e.asset);
                            if (!g(e)) {
                                if ("string" == typeof e) return l.test(x(e) || "") ? O(e) : void 0;
                                if (w(e)) return e.path;
                                if (y(e)) return O(e.url)
                            }
                        }(t);
                        if (!e) throw new u(t, "Failed to resolve project ID and dataset from source");
                        var r = e.match(l) || [],
                            i = r[2],
                            n = r[3];
                        if (!i || !n) throw new u(t, "Failed to resolve project ID and dataset from source");
                        return {
                            projectId: i,
                            dataset: n
                        }
                    ...
                    o = t.asset || t,
                    a = function(t) {
                        if (!c.test(t)) throw Error("Malformed file asset ID '" + t + '\'. Expected an id like "file-027401f31c3ac1e6d78c5d539ccd1beff72b9b11-pdf"');
                        var e = t.split("-");
                        return {
                            type: "file",
                            assetId: e[1],
                    ...
                    s = a.assetId,
                    h = a.extension,
                    p = i({}, b(t) && "sanity.fileAsset" === t._type ? t : {}, {
                        _id: n,
            ...
            function j(t) {
                var e = v(t) ? t.asset : t,
                    r = "";
                if ("string" == typeof e ? r = function(t) {
                        var e, r;
                        if (d.test(t)) return t;
                        if (0 === t.indexOf(f + "/images") || 0 === t.indexOf(f + "/files")) return M(t);
                        if (l.test(t)) return M(f + "/" + t);
                        if (e = t, h.test(e)) return M(f + "/files/a/b/" + t);
                        if (r = t, p.test(r)) return M(f + "/images/a/b/" + t);
                        throw new u(t)
                    }(e) : g(e) ? r = e._ref : b(e) && "string" == typeof e._id ? r = e._id : w(e) ? r = M(f + "/" + e.path) : y(e) && (r = M(e.url)), !(r && d.test(r))) throw new u(t);
                return r
            }
            ...
            function M(t) {
                var e = O(t).split("/"),
                    r = e[0],
                    i = e[3];
                return r.replace(/s$/, "") + "-" + i.replace(/\./g, "-")
            }
        },
        43911: function(t) {
            t.exports = function() {
                ...
                var n = [
                    ...
                    u = function() {
                        ...
                        return f.withOptions = function(r) {
                            ...
                            for (var a in r) r.hasOwnProperty(a) && (o[function(t) {
                                for (var r, i = function(t) {
                                        ...
                                        if (Array.isArray(t) || (r = function(t) {
                                                if (t) {
                                                    ...
                                                    if ("Arguments" === r || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)) return e(t, void 0)
                                                }
                                            }(t))) {
                                            r && (t = r);
                                            var i = 0;
                            ...
                            return function(e) {
                                ...
                                var s = function(e) {
                                    var r, n;
                                    if (!e) return null;
                                    if ("string" == typeof e && (n = e, /^https?:\/\//.test("" + n))) r = {
                                        asset: {
                                            _ref: i(e)
                                        }
                                    };
                                ...
                                if (!s) throw Error("Unable to resolve image URL from source (" + JSON.stringify(a) + ")");
                                var u = function(t) {
                                        var e = t.split("-"),
                                            i = e[1],
                                            n = e[2],
                                        ...
                                        var a = n.split("x"),
                                            ...
                                            f = +s,
                                            h = +u;
                                        if (!(isFinite(f) && isFinite(h))) throw Error("Malformed asset _ref '" + t + "'. Expected an id like \"" + r + '".');
                                        return {
                                            id: i,
                                            width: f,
                                            height: h,
                                    ...
                                    h = Math.round(s.crop.top * u.height),
                                    c = {
                                        left: f,
                                        top: h,
                                        width: Math.round(u.width - s.crop.right * u.width - f),
                                        height: Math.round(u.height - s.crop.bottom * u.height - h)
                                    },
                                    p = s.hotspot.height * u.height / 2,
                                    l = s.hotspot.width * u.width / 2,
                                ...
                                return o.rect || o.focalPoint || o.ignoreImageParams || o.crop || (o = t({}, o, function(t, e) {
                                        ...
                                        if (o.width / o.height > s) {
                                            var u = Math.round(o.height),
                                                ...
                                                c = Math.max(0, Math.round(Math.round((a.right - a.left) / 2 + a.left) - f / 2));
                                            c < o.left ? c = o.left : c + f > o.left + o.width && (c = o.left + o.width - f), r = {
                                                left: c,
                                                top: h,
                                                width: f,
                                                height: u
                                            ...
                                            var p = o.width,
                                                ...
                                                g = Math.max(0, Math.round(Math.round((a.bottom - a.top) / 2 + a.top) - l / 2));
                                            g < o.top ? g = o.top : g + l > o.top + o.height && (g = o.top + o.height - l), r = {
                                                left: d,
                                                top: g,
                                                width: p,
                                                height: l
                                    ...
                                    function(t) {
                                        var e = (t.baseUrl || "https://cdn.sanity.io").replace(/\/+$/, ""),
                                            ...
                                            i = e + "/images/" + t.projectId + "/" + t.dataset + "/" + r,
                                            o = [];
                                        if (t.rect) {
                                            var a = t.rect,
                                                s = a.left,
                                                ...
                                                f = a.width,
                                                h = a.height;
                                            (0 !== s || 0 !== u || h !== t.asset.height || f !== t.asset.width) && o.push("rect=" + s + "," + u + "," + f + "," + h)
                                        }
                                        ...
                                        return (c && o.push("flip=" + c), n.forEach(function(e) {
                                            var r = e[0],
                                                i = e[1];
