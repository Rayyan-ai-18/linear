! function() {
    try {
        var e = "u" > typeof window ? window : "u" > typeof global ? global : "u" > typeof globalThis ? globalThis : "u" > typeof self ? self : {},
            t = (new e.Error).stack;
        t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "26caa2a0-dcfb-493c-8b17-824b9b244d31", e._sentryDebugIdIdentifier = "sentry-dbid-26caa2a0-dcfb-493c-8b17-824b9b244d31")
    } catch (e) {}
    ...
    [56914], {
        ...
        7351: (e, t, n) => {
            ...
            var r = n(49430),
                ...
                E = r.forwardRef(function(e, t) {
                    var n = r.useRef(null),
                        ...
                        w = e.as,
                        C = e.gapMode,
                        N = (0, v.Tt)(e, ["forwardProps", "children", "className", "removeScrollBar", "enabled", "shards", "sideCar", "noIsolation", "inert", "allowPinchZoom", "as", "gapMode"]),
                        x = (0, g.S)([n, t]),
                        R = (0, v.Cl)((0, v.Cl)({}, N), a);
                    return r.createElement(r.Fragment, null, d && r.createElement(p, {
                        sideCar: y,
                        removeScrollBar: l,
                        shards: f,
                        noIsolation: m,
                        ...
                        lockRef: n,
                        gapMode: C
                    }), u ? r.cloneElement(r.Children.only(c), (0, v.Cl)((0, v.Cl)({}, R), {
                        ref: x
                    })) : r.createElement(void 0 === w ? "div" : w, (0, v.Cl)({}, R, {
                        className: s,
                        ref: x
                    }), c))
                });
            ...
            var S = !!x && {
                ...
                O = function(e, t) {
                    var n = t.ownerDocument,
                        r = t;
                    do {
                        if ("u" > typeof ShadowRoot && r instanceof ShadowRoot && (r = r.host), T(e, r)) {
                            var o = j(e, r);
                            if (o[1] > o[2]) return !0
                        }
                        r = r.parentNode
                ...
                M = function(e, t, n, r, o) {
                    ...
                    do {
                        var m = j(e, c),
                            v = m[0],
                            h = m[1] - m[2] - i * v;
                        (v || h) && T(e, c) && (f += h, p += v), c = c instanceof ShadowRoot ? c.host : c.parentNode
                    } while (!s && c !== document.body || s && (t.contains(c) || t === c));
                    return d && (o && 1 > Math.abs(f) || !o && u > f) ? l = !0 : !d && (o && 1 > Math.abs(p) || !o && -u > p) && (l = !0), l
                },
                L = function(e) {
            ...
            let F = (0, w.m)(y, function(e) {
                ...
                r.useEffect(function() {
                    ...
                    if (e.inert) {
                        ...
                        var t = (0, v.fX)([e.lockRef.current], (e.shards || []).map(A), !0).filter(Boolean);
                ...
                var c = r.useCallback(function(e, t) {
                        ...
                        var f = O(d, l);
                        if (!f) return !0;
                        if (f ? r = d : (r = "v" === d ? "h" : "v", f = O(d, l)), !f) return !1;
                        if (!o.current && "changedTouches" in e && (c || s) && (o.current = r), !r) return !0;
                        var p = o.current || r;
                        return M(p, t, e, "h" === p ? c : s, !0)
                    }, []),
                    s = r.useCallback(function(e) {
                        if (k.length && k[k.length - 1] === i) {
                            var n = "deltaY" in e ? P(e) : L(e),
                            ...
                            if (!r) {
                                var o = (u.current.shards || []).map(A).filter(Boolean).filter(function(t) {
                    ...
                    l = r.useCallback(function(e, n, r, o) {
                        var a = {
                            name: e,
                            delta: n,
                            target: r,
                    ...
                    d = r.useCallback(function(e) {
                        n.current = L(e), o.current = void 0
                    }, []),
                    f = r.useCallback(function(t) {
                        l(t.type, P(t), t.target, c(t, e.lockRef.current))
                    }, []),
                    p = r.useCallback(function(t) {
                        l(t.type, L(t), t.target, c(t, e.lockRef.current))
                    }, []);
                r.useEffect(function() {
                    return k.push(i), e.setCallbacks({
                        ...
                        }), document.addEventListener("wheel", s, S), document.addEventListener("touchmove", s, S), document.addEventListener("touchstart", d, S),
                        function() {
                            k = k.filter(function(e) {
                                return e !== i
                            }), document.removeEventListener("wheel", s, S), document.removeEventListener("touchmove", s, S), document.removeEventListener("touchstart", d, S)
                        }
                }, []);
                var m = e.removeScrollBar,
                    h = e.inert;
                return r.createElement(r.Fragment, null, h ? r.createElement(i, {
                    styles: "\n  .block-interactivity-".concat(a, " {pointer-events: none;}\n  .allow-interactivity-").concat(a, " {pointer-events: all;}\n")
                }) : null, m ? r.createElement(C.jp, {
                    gapMode: e.gapMode
                }) : null)
            });
            var W = r.forwardRef(function(e, t) {
                return r.createElement(E, (0, v.Cl)({}, e, {
                    ref: t,
                    sideCar: F
                }))
            });
            W.classNames = E.classNames;
            var _ = n(44679),
                B = n(95106),
                U = n(91702),
                $ = "Dialog",
                ...
                Z = e => {
                    let {
                        ...
                        onOpenChange: i,
                        modal: s = !0
                    } = e, l = r.useRef(null), d = r.useRef(null), [f = !1, p] = (0, c.i)({
                        prop: o,
                        defaultProp: a,
                        onChange: i
                    });
            ...
            var Y = "DialogTrigger",
                V = r.forwardRef((e, t) => {
                    let {
                        __scopeDialog: n,
                        ...r
                    } = e, i = K(Y, n), u = (0, a.s)(t, i.triggerRef);
                    return (0, U.jsx)(p.sG.button, {
                        type: "button",
            ...
            var z = "DialogPortal",
                ...
                Q = e => {
                    ...
                    return (0, U.jsx)(H, {
                        scope: t,
                        forceMount: n,
                        children: r.Children.map(o, e => (0, U.jsx)(f.C, {
                            present: n || i.open,
            ...
            var ee = "DialogOverlay",
                et = r.forwardRef((e, t) => {
                    let n = J(ee, e.__scopeDialog),
                        {
                            forceMount: r = n.forceMount,
                            ...o
                        } = e,
                        a = K(ee, e.__scopeDialog);
                    return a.modal ? (0, U.jsx)(f.C, {
                        present: r || a.open,
            ...
            var en = r.forwardRef((e, t) => {
                ...
                er = "DialogContent",
                eo = r.forwardRef((e, t) => {
                    let n = J(er, e.__scopeDialog),
                        {
                            forceMount: r = n.forceMount,
                            ...o
                        } = e,
                        a = K(er, e.__scopeDialog);
                    return (0, U.jsx)(f.C, {
                        present: r || a.open,
                        children: a.modal ? (0, U.jsx)(ea, { ...o,
                            ref: t
                        }) : (0, U.jsx)(ei, { ...o,
                            ref: t
                        })
            ...
            var ea = r.forwardRef((e, t) => {
                    let n = K(er, e.__scopeDialog),
                        i = r.useRef(null),
                        u = (0, a.s)(t, n.contentRef, i);
                    return r.useEffect(() => {
                        let e = i.current;
                ...
                eu = r.forwardRef((e, t) => {
                    let {
                        ...
                        onCloseAutoFocus: u,
                        ...c
                    } = e, d = K(er, n), f = r.useRef(null), p = (0, a.s)(t, f);
                    return (0, m.Oh)(), (0, U.jsxs)(U.Fragment, {
            ...
            es.displayName = ec;
            var el = "DialogDescription",
                ed = r.forwardRef((e, t) => {
                    let {
                        __scopeDialog: n,
                        ...r
                    } = e, o = K(el, n);
                    return (0, U.jsx)(p.sG.p, {
                        id: o.descriptionId,
                        ...r,
                        ref: t
                    })
...
For more information, see https://radix-ui.com/primitives/docs/components/${t.docsSlug}`;
                ...
                eb = ({
                    ...
                    let n = eg("DialogDescriptionWarning"),
        ...
        8023: (e, t, n) => {
            ...
            var r = n(49430),
                ...
                c = r.forwardRef((e, t) => {
                    ...
                    (0, i.N)(() => l(!0), []);
                    let d = n || s && globalThis ? .document ? .body;
                    return d ? o.createPortal((0, u.jsx)(a.sG.div, { ...c,
                        ref: t
                    }), d) : null
                });
        ...
        34843: (e, t, n) => {
            ...
            var r = n(49430),
                ...
                s = function(e) {
                    if (void 0 === e && (e = "margin"), "u" < typeof window) return i;
                    var t = c(e),
                        ...
                        !e || p.has(e) || Array.prototype.forEach.call(e.children, function(e) {
                            if (f.has(e)) v(e);
                                ...
                                var t = e.getAttribute(c),
                                    ...
                                    i = (r.get(e) || 0) + 1,
                                    u = (l.get(e) || 0) + 1;
                                r.set(e, i), l.set(e, u), d.push(e), 1 === i && a && o.set(e, !0), 1 === u && e.setAttribute(n, "true"), a || e.setAttribute(c, "true")
                            } catch (t) {
                    ...
                    return v(t), f.clear(), i++,
                        function() {
                            d.forEach(function(e) {
                                var t = r.get(e) - 1,
                                    a = l.get(e) - 1;
                                r.set(e, t), l.set(e, a), t || (o.has(e) || e.removeAttribute(c), o.delete(e)), a || e.removeAttribute(n)
            ...
            var r, o = n(49430),
                ...
                p = o.forwardRef((e, t) => {
                    let {
                        ...
                        onDismiss: b,
                        ...E
                    } = e, w = o.useContext(f), [C, N] = o.useState(null), x = C ? .ownerDocument ? ? globalThis ? .document, [, R] = o.useState({}), S = (0, u.s)(t, e => N(e)), D = Array.from(w.layers), [O] = [...w.layersWithOutsidePointerEventsDisabled].slice(-1), T = D.indexOf(O), j = C ? D.indexOf(C) : -1, M = w.layersWithOutsidePointerEventsDisabled.size > 0, L = j >= T, P = function(e, t = globalThis ? .document) {
                        let n = (0, c.c)(e),
                            r = o.useRef(!1),
                            a = o.useRef(() => {});
                        return o.useEffect(() => {
                        ...
                        L && !n && (h ? .(e), y ? .(e), e.defaultPrevented || b ? .())
                    }, x), A = function(e, t = globalThis ? .document) {
                        let n = (0, c.c)(e),
                            r = o.useRef(!1);
                        return o.useEffect(() => {
                            let e = e => {
                    ...
                    return (0, s.U)(e => {
                        j === w.layers.size - 1 && (p ? .(e), !e.defaultPrevented && b && (e.preventDefault(), b()))
                    }, x), o.useEffect(() => {
                        if (C) return n && (0 === w.layersWithOutsidePointerEventsDisabled.size && (r = x.body.style.pointerEvents, x.body.style.pointerEvents = "none"), w.layersWithOutsidePointerEventsDisabled.add(C)), w.layers.add(C), m(), () => {
                            n && 1 === w.layersWithOutsidePointerEventsDisabled.size && (x.body.style.pointerEvents = r)
                        }
                    }, [C, x, n, w]), o.useEffect(() => () => {
                        ...
                        onFocusCapture: (0, a.m)(e.onFocusCapture, A.onFocusCapture),
                        onBlurCapture: (0, a.m)(e.onBlurCapture, A.onBlurCapture),
                ...
                return a.scopeName = e, [function(t, a) {
                    ...
                    let c = t => {
                        let {
                            ...
                            children: a,
                            ...c
                        } = t, s = n ? .[e] ? .[u] || i, l = r.useMemo(() => c, Object.values(c));
            ...
            var r = n(49430),
                ...
                u = ["a", "button", "div", "form", "h2", "h3", "img", "input", "label", "li", "nav", "ol", "p", "span", "svg", "ul"].reduce((e, t) => {
                    let n = r.forwardRef((e, n) => {
                        ...
                        return "u" > typeof window && (window[Symbol.for("radix-ui")] = !0), (0, i.jsx)(u, { ...o,
                            ref: n
                        })
                    });
        ...
        95106: (e, t, n) => {
            ...
            var r = n(49430),
                ...
                i = r.forwardRef((e, t) => {
                    let {
                        children: n,
                        ...o
                    } = e, i = r.Children.toArray(n), c = i.find(s);
                    if (c) {
            ...
            var u = r.forwardRef((e, t) => {
                ...
                if (r.isValidElement(n)) {
                    var i;
                    let e, u, c = (i = n, (u = (e = Object.getOwnPropertyDescriptor(i.props, "ref") ? .get) && "isReactWarning" in e && e.isReactWarning) ? i.ref : (u = (e = Object.getOwnPropertyDescriptor(i, "ref") ? .get) && "isReactWarning" in e && e.isReactWarning) ? i.props.ref : i.props.ref || i.ref),
                        s = function(e, t) {
                            let n = { ...t
                            };
                            for (let r in t) {
                    ...
                    return n.type !== r.Fragment && (s.ref = t ? (0, o.t)(t, c) : c), r.cloneElement(n, s)
                }
        ...
        95951: (e, t, n) => {
            ...
            var a = "u" > typeof window ? r.useLayoutEffect : r.useEffect,
                i = new WeakMap;
        ...
        96108: (e, t, n) => {
            ...
            function a(e) {
                void 0 === e && (e = {});
                var t, n, a, i = (void 0 === t && (t = o), n = [], a = !1, {
                    read: function() {
            ...
            var o = n(49430),
                ...
                f = o.forwardRef((e, t) => {
                    let {
                        ...
                        ...y
                    } = e, [b, E] = o.useState(null), w = (0, u.c)(f), C = (0, u.c)(g), N = o.useRef(null), x = (0, a.s)(t, e => E(e)), R = o.useRef({
                        paused: !1,
                        pause() {
                            this.paused = !0
                        },
                        ...
                        if (b) {
                            ...
                            return () => {
                                b.removeEventListener(s, w), setTimeout(() => {
                                    ...
                                    b.addEventListener(l, C), b.dispatchEvent(t), t.defaultPrevented || v(e ? ? document.body, {
                                        select: !0
                                    }), b.removeEventListener(l, C), h.remove(R)
                                }, 0)
                            }
                        }
                    }, [b, w, C, R]);
                    let S = o.useCallback(e => {
                        ...
                        if (t && o) {
                            ...
                            let t, r = e.currentTarget,
                                [i, u] = [m(t = p(a = r), a), m(t.reverse(), a)];
                            i && u ? e.shiftKey || o !== u ? e.shiftKey && o === i && (e.preventDefault(), n && v(u, {
                                select: !0
                            })) : (e.preventDefault(), n && v(i, {
                                select: !0
            ...
            var r = n(49430),
                ...
                i = e => {
                    ...
                    let n, i, {
                        ...
                        l = function(e) {
                            var t, n;
                            let [o, i] = r.useState(), c = r.useRef({}), s = r.useRef(e), l = r.useRef("none"), [d, f] = (t = e ? "mounted" : "unmounted", n = {
                                mounted: {
                                    UNMOUNT: "unmounted",
                            ...
                            return r.useEffect(() => {
                                ...
                                if (o) {
                                    let e, t = o.ownerDocument.defaultView ? ? window,
                                        n = n => {
                                            let r = u(c.current).includes(n.animationName);
                                            if (n.target === o && r && (f("ANIMATION_END"), !s.current)) {
                                        ...
                                        r = e => {
                                            e.target === o && (l.current = u(c.current))
                                        };
                        ...
                        f = (0, o.s)(l.ref, (t = d, (i = (n = Object.getOwnPropertyDescriptor(t.props, "ref") ? .get) && "isReactWarning" in n && n.isReactWarning) ? t.ref : (i = (n = Object.getOwnPropertyDescriptor(t, "ref") ? .get) && "isReactWarning" in n && n.isReactWarning) ? t.props.ref : t.props.ref || t.ref));
                    return "function" == typeof s || l.isPresent ? r.cloneElement(d, {
                        ref: f
                    }) : null
                };
